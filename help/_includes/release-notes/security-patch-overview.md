...
>[!NOTE]
>
>Uitgebreide beveiligingspatches zijn alleen beschikbaar voor Adobe Commerce-klanten en zijn niet beschikbaar voor de Magento Open Source-codebasis. Zie [&#x200B; Uitgebreide Steun &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-operations/release/planning/lifecycle-policy#extended-support).
