...
De NGinx-versie die wordt gebruikt in ontwikkelings- en testomgevingen in alle momenteel ondersteunde versies van Adobe Commerce, wordt bijgewerkt naar versie 1.28, op één lijn met de nieuwste stabiele NGinx-versie. Het testen op PR-niveau wordt nu uitgevoerd op Nginx 1.28, wat de volledige compatibiliteit en ondersteuning voor alle Adobe Commerce-versies bevestigt.
...
#### Verbeterde ondersteuning voor versie Composer 2.x

Eerder was de ondersteuning voor Composer-versies beperkt tot 2.2.x. Adobe Commerce 2.4.9-beta1 breidt deze ondersteuning uit tot Composer 2.4.x en latere versies, waardoor de compatibiliteit voor ontwikkelings- en implementatieomgevingen wordt verruimd.
...
#### Uitgebreide multisite toegangsbeheer hardend

Deze update levert uitvoerige verharding van multisite toegangsbeheerlijsten (ACLs) in Adobe Commerce Admin, richtend zowel bekende als eerder onbekende toestemmingskwesties in de multisite configuratie van het toegangsbeheer. Admin-gebruikers met toegang tot specifieke websites of winkels kunnen gegevens die bij andere websites of winkels horen, niet meer weergeven of wijzigen tijdens een implementatie op meerdere sites.
