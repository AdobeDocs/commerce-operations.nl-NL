...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          8.0.mysql_aurora.3.09 of de nieuwste beschikbare versies
      </td>
      <td>
          8.0.mysql_aurora.3.09 of de nieuwste beschikbare versies
      </td>
      <td>
          8.0.mysql_aurora.3.08 of de nieuwste beschikbare versies
      </td>
      <td>
          8.0.mysql_aurora.3.08 of de nieuwste beschikbare versies
      </td>
    ...
    <tr>
      ...
      <td>
          ElastiCache versie 7.1 voor Redis OSS (verbeterd). Valkey 8 is beschikbaar.
      </td>
      <td>
          ElastiCache versie 7.1 voor Redis OSS (verbeterd)
      </td>
      <td>
          ElastiCache versie 7.1 voor Redis OSS (verbeterd)
      </td>
