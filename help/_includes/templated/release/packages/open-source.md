...
De volgende referentiedocumentatie wordt gegenereerd op basis van de `composer.lock` en omvat de vereiste pakketten die zijn opgenomen in Magento Open Source 2.4.6-bèta2.

## Afhankelijkheden

`magento/product-community-edition 2.4.6-beta2` heeft de volgende afhankelijkheden:
