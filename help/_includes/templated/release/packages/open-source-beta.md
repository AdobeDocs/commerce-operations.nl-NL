...
De volgende referentiedocumentatie wordt gegenereerd op basis van de `composer.lock` en omvat de vereiste pakketten die zijn opgenomen in Magento Open Source 2.4.7-bèta3.

## Afhankelijkheden

`magento/product-community-edition 2.4.7-beta3` heeft de volgende afhankelijkheden:
