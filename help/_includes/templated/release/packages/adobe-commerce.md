...
De volgende referentiedocumentatie wordt gegenereerd op basis van de `composer.lock` en omvat de vereiste pakketten die in Adobe Commerce 2.4.6-beta2 zijn opgenomen.

## Afhankelijkheden

`magento/product-enterprise-edition 2.4.6-beta2` heeft de volgende afhankelijkheden:
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/twigphp/Twig.git">twig/twig</a>
    </td>
    <td>bibliotheek</td>
    <td>Twig, de flexibele, snelle en veilige sjabloontaal voor PHP</td>
  </tr>
  </tbody>
</table>
