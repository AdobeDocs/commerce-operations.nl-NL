...
Eerder, wanneer het verzenden van een e-mailmalplaatje voor een cadeaukaart nadat een factuur van een verschillende opslag werd gecreeerd, zou de naam van de eigenaar in de montages van de admin configuratie niet in de e-mailkopballen worden weerspiegeld wanneer de klant e-mail ontving. Nadat deze correctie is toegepast, bevatten de e-mailheaders nu de e-mailgegevens van de desbetreffende eigenaar van de winkel.
