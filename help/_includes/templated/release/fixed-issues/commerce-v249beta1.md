...
---
# Opgeloste problemen in Adobe Commerce (v2.4.9-bèta1)

## Opgeloste problemen in v2.4.9-bèta1

We hebben 560 problemen opgelost in de Adobe Commerce 2.4.9-bèta1-kerncode. Hieronder wordt een subset van de opgeloste problemen in deze release beschreven.
...
#### [ Ervaring van de Ontwikkelaar van 0} kwestie: De codestijl van AbstractItem van het citaat (SOP-348 van SwiftOtter)]
...
Afhandeling is mislukt voor namen van steden met speciale tekens zoals . , &amp; of ronde haakjes. Dit probleem is nu opgelost.
...
In Adobe Commerce kunnen verkopers nu het veld Punten achteruit bij uiteinde leeg laten terwijl ze nog steeds een waarde instellen voor Drempel voor terugbetalingsbalans punten. Eerder, toen het vormen van beloningspunten onder Opslag > Configuratie > Klanten > Punten van de Terugkeer, die een positief aantal voor de Drempel van de TerugbetalingsPunten van de Punten van de Beloning ingaan en het verlaten van de Punten van de Punten van de Punten van de Punten van de Punten van de Punten van de Paragraaf leeg teweegbrachten teweegbrachten de bevestigingsfout: &quot;De Punten van de Balans \&quot;is ongeldig. De balans moet een positief getal zijn of leeg blijven. Verifieer en probeer het opnieuw.&quot;, verhindert handelaars de configuratie zonder een GLB te bewaren. ACP2E-3977
...
Als u eerder op &quot;Afdrukken&quot; klikt, treedt de fout op: &quot;Er is een fout opgetreden tijdens het uitvoeren van de toepassing. Zie uitzonderingslogboek voor details.&quot;
AC-14711
...
Magento werkt nu correct de totalen van de kartbelasting bij wanneer de cadeauverpakking wordt verwijderd via de setGiftOptionsOnCart GraphQL-mutatie. Eerder, toen een geschenkompoptie was geselecteerd en toen unset door &quot;giftWrappingId&quot;door te geven: ongeldig in de mutatie input, werd het belastingbedrag in het citaat niet bijgewerkt en Magento bleef geschenkomslagbelasting in de kaardtotalen omvatten, alhoewel geen geschenkomslag werd toegepast.
