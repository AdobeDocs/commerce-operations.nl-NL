...
#### In het gebruikersrapport Handelingenlogboek van Admin wordt niet aangegeven welk filter is gebruikt bij het toepassen van filters
...
Voorafgaand aan de correctie konden de vectorcodes niet correct worden gebruikt in het opvoeren van voorproefwijze. Nadat de correctie is uitgevoerd, worden de vouchercodes nu op de juiste wijze toegepast op de pagina voor uitchecken.
