...
#### Aanvaller kan POST-aanvraag gebruiken met REST API en kan RCE-payload verzenden

REST API&#39;s V1/gast-carts/&lt;cartId>/items/ en V1/carts/mine/items/ valideren nu &quot;product_options.extension_attributes.custom_options.*.option_id&quot; moet geldige option_id zijn in het winkelwagentje SKU. Eerder werd een dergelijke optie verwerkt en opgeslagen in de database zonder validatie.
