...
We hebben 667 problemen opgelost in de Adobe Commerce 2.4.9-kerncode. Hieronder wordt een subset van de opgeloste problemen in deze release beschreven.

### API&#39;s

#### Kenmerksetgegevens worden in de cache opgeslagen (EAV-cache), maar worden niet schoongemaakt nadat de kenmerkset in het beheergebied is bijgewerkt

Opgeloste waarden van ontbrekende productkenmerken nadat nieuwe kenmerken zijn toegevoegd aan een kenmerkset wanneer de EAV-cache is ingeschakeld (ongeldig maken cache/importeren van API).

_AC-12321 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/38827) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/38864)_
...
#### &rbrack; Verduidelijkte Optie van Attributen van 0&rbrace; Uitgave bestaat reeds reactie&lbrack;

Het systeem heeft nu de lastige zin &quot;Nieuwe bestandsnaam ophalen als hetzelfde al bestaat&quot; vervangen door een duidelijkere en grammaticale versie: &quot;Haal een nieuwe bestandsnaam op als die al bestaat.&quot; Hierdoor wordt de leesbaarheid en het begrip van de gebruiker verbeterd.
...
#### GraphicsQl Media-galerie retourneert uitgeschakelde items.

Probleem verholpen waarbij alleen die galeriegafbeeldingen werden opgehaald die niet zijn uitgeschakeld voor een product in de antwoordmodus voor een grafisch verzoek.

_AC-1608 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/34342) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/34897)_
...
Eerder, verzendend misvormde verzoekinstanties of parameters naar diverse REST API eindpunten (zoals /V1/karts/search, /V1/orders, /V1/products, enz.) resulteerde in een algemene &quot;Interne Fout van de Server&quot; (500), die het moeilijk maakt om inputkwesties te diagnostiseren.
...
REST API&#39;s V1/gast-carts/&lt;cartId>/items/ en V1/carts/mine/items/ valideren nu &quot;product_options.extension_attributes.custom_options.*.option_id&quot; om ervoor te zorgen dat deze verwijzen naar een geldige option_id voor het winkelwagentje SKU. Eerder werd deze parameter verwerkt en opgeslagen in de database zonder validatie.
...
#### [ CLOUD ] De Rij ontruimt niet

Verbeterde consumentenveerkracht van AMQP door ongeldige ack/weigeringspogingen op opnieuw aangesloten kanalen te blokkeren.

_ACP2E-4621 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
De voorwaarde voor het klantensegment &#39;Product bekeken&#39; is nu vervangen.
Eerder, kon het gebruiken van deze voorwaarde plaatsstroomonderbrekingen veroorzaken toe te schrijven aan zware vragen MySQL. De voorwaarde is nu gemarkeerd als afgekeurd en wordt niet ondersteund.
...
#### Winefront Customer account register: e-mailadresnotatie wordt geconverteerd naar een andere domeinnotatie
...
#### Telefonische validatie van het adres van de klant werkt niet wanneer er geen toegestane tekens zijn

Het Systeem keert een foutenmelding terug verklarend dat de telefoon ongeldig is.

_AC-16227 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40361) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40416)_

#### Website- en winkelobjecten retourneren id&#39;s als tekenreeksen

Probleem opgelost waarbij website- en opslag-id&#39;s werden geretourneerd als tekenreeksen in plaats van als gehele getallen. Dit verhelpt typefouten in de strikte modus, waardoor EmailNotification::newAccount() en vergelijkbare methoden correct werken.

_AC-16486 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40469)_

#### Validatie van plaats voor klant werkt niet voor niet-toegestane tekens

Probleem verholpen waarbij adressen van klanten konden worden opgeslagen met ongeldige tekens (zoals /, @, #, !) in het veld Plaats. Na deze correctie valideert en verwerpt het systeem adressen die niet-toegestane tekens bevatten.

_AC-16504 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40521) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/57bad413)_

#### [ Uitgave ] Repareren: IP van de verhoging kolomlengte voor IPv6 steun in admin_user_session

Momenteel, is de ip kolom in admin_user_session beperkt tot 15 karakters, die voor IPv6 adressen (tot 45 karakters) ontoereikend is. Deze PR verlengt de lengte tot 45 om volledige IPv6 verenigbaarheid te verzekeren en gegevensbeknotting of fouten te verhinderen wanneer IPv6 wordt gebruikt.

_AC-16659 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40570) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40563)_
...
#### Waarschuwingsbericht tijdens verzenden van uitnodigingsfunctionaliteit

Probleem verholpen waarbij het waarschuwingsbericht &quot;Maximum X e-mailadressen toegestaan&quot; niet werd weergegeven bij het toevoegen van e-mailvelden op de pagina Uitnodigingen verzenden als de instelling &quot;Klanten toestaan aangepast bericht toe te voegen aan e-mailuitnodiging&quot; was uitgeschakeld.
Eerder werd de waarschuwing alleen weergegeven wanneer aangepaste berichten waren ingeschakeld, waardoor een inconsistente gebruikerservaring ontstond. De maximale waarschuwing voor de e-maillimiet wordt nu consistent weergegeven, ongeacht de instelling voor de aangepaste berichtconfiguratie.

_ACP2E-4374_

#### Validatie van stadsnaam accepteert niet-toegestane tekens (!&quot;#?)

Wanneer het ingaan van een stad in een klantenadres, staat de bevestiging nu een voorwaartse schuine streep toe en verwerpt correct ongeldige karakters zoals !, &quot;, #, en ?.

_ACP2E-4527 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_

#### Adres Validators die Bestaande Klant breken na verbetering aan 2.4.8-p3

Eerder, vóór deze correctie, moderne telefoonaantallen met de karakters. of \ zijn niet correct gevalideerd. Nadat deze correctie is toegepast, worden moderne telefoonnummers met de tekens gebruikt. of \ zijn nu gevalideerd.

_ACP2E-4554 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### &rbrack; PHPSESSID van de Wolk 10&rbrace; veranderde na wachtwoordterugstellend verzoek en huidige ontruimde karretje&lbrack;

Vóór de moeilijke situatie, veroorzaakte het voorleggen van de vergat-wachtwoordvorm dat de zitting werd vernietigd/opnieuw geproduceerd (veranderde PHPSESSID) en de gastkar werd ontruimd. Na de correctie blijft de sessie ongewijzigd bij het verzenden van het formulier Wachtwoord vergeten en blijft de gastwinkelwagen behouden.

_ACP2E-4524 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Adobe Commerce verzendt nu registratiee-mails wanneer een aangepast return-path-adres voor SMTP is geconfigureerd. In vanilla Adobe Commerce 2.4.8 met system/smtp/set_return_path ingesteld op 2 en system/smtp/return_path_email ingesteld op een aangepast adres, is de klantenregistratie voltooid maar is de registratie-e-mail niet verzonden en heeft Adobe Commerce deze fout geregistreerd: Symfony\Component\Mime\Exception\LogicException: De header &quot;Sender&quot; moet een instantie zijn van &quot;Symfony\Component\Mime\Header\MailboxHeader&quot; (met &quot;Symfony\Component\Mime\Header\MailboxListHeader&quot;).
...
Probleem verholpen waarbij bij het vernieuwen van de orderpagina de meest recente gegevens van de klantspecifieke kenmerken niet werden weergegeven. na de correctie worden bijgewerkte kenmerkwaarden nu weerspiegeld zonder dat u de volgorde hoeft te annuleren en opnieuw hoeft te maken.
...
#### [ Uitgave ] PageCache/AccessList: CIDR-ondersteuning toevoegen
...
#### &rbrack; Repareren (admin) van 0&rbrace; kwestie &lbrace;: correcte datepickerpositie binnen modal-slide&lbrack;

Deze pull-aanvraag verhelpt een probleem waarbij de Magento-datepicker niet correct wordt weergegeven in modale dialoogvensters voor beheerders.
Dit had bijvoorbeeld invloed op de sectie Geavanceerde prijzen wanneer u een product bewerkt of maakt via het deelvenster Beheer.

_AC-16378 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40468) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40225)_

#### FPT-waarde in winkelwagentje en productpagina zijn verschillend voor dezelfde configuraties

Probleem verholpen waarbij FPT-waarden (Fixed Product Tax) vanwege inconsistenties op de pagina&#39;s van producten en winkelwagentjes anders werden weergegeven. Na deze correctie zijn de FPT-prijzen nu consistent op alle pagina&#39;s met catalogi, producten en winkelwagentjes, zodat er geen problemen meer zijn.

_AC-16550 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/8391dbcc)_
...
De kleuren van de omslag worden nu toegepast zoals verwacht op de rijen van statische netten Admin.[&#x200B; GitHub-35358 &#x200B;](https://github.com/magento/magento2/issues/35358)
...
#### De prijsregel voor winkelwagentjes met voorwaarde-SKU houdt geen rekening met de &#39;voorloopnullen&#39; in de SKU (sku: 01234 is gelijk aan 1234)
...
#### &rbrack; Admin het Beleid van het Wachtwoord van KANTOREN &lbrack; komt niet naleving PCI DSS 4.0 (minimum 12 Karakters) na
...
#### Wijzigingen in productafbeelding niet geregistreerd in actielogboek

Probleem verholpen waarbij uploads en verwijderingen van productafbeeldingen niet werden bijgehouden in Beheerdershandelingenlogboeken. Eerder, toen de beheerders nieuwe beelden aan een product toevoegden of bestaande beelden van de media van het product schrapte, werden deze veranderingen niet geregistreerd in het registrerensysteem. Alleen wijzigingen in afbeeldingsrollen (zoals het toewijzen van een afbeelding als hoofdafbeelding, miniatuur of kleine afbeelding) werden vastgelegd. Nu worden alle wijzigingen in de mediagalerie, inclusief toevoegingen en verwijderingen van afbeeldingen, correct aangemeld bij de beheerlogboeken voor handelingen. Hierdoor is het audittrail volledig zichtbaar voor activiteiten in verband met het beheer van productafbeeldingen.

_ACP2E-4302_

#### JS-waarschuwing in het dashboard voor beheer: &quot;Loader wordt verwacht, maar er is geen object in het bewegingsgebied gevonden&quot;
...
_ACP2E-4337 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/31258bf6)_
...
#### Vanwege JS-fout (TypeError: Kan eigenschappen van undefined niet lezen)
...
#### Kan de opslagconfiguratie niet bijwerken in het deelvenster Beheer

Eerder konden het lokale cachegeheugen, het oude cachegeheugen en Redis niet gesynchroniseerd worden wanneer Redis niet beschikbaar was. Wijzigingen in de configuratie die tijdens een storing met Redis zijn aangebracht, werden niet goed weergegeven nadat Redis was hersteld, waardoor de waarden van de schaal aanhielden. Deze correctie zorgt voor een correcte synchronisatie in alle cache, zodat de laatst opgeslagen waarden behouden blijven en zichtbaar blijven, zelfs als Redis is uitgeschakeld.

_ACP2E-4447 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

#### Het raster archiveren wordt niet gesynchroniseerd met de meest recente volgordegegevens als asynchrone rasterindexering is ingeschakeld

Archiefraster voor verkooporders geeft nu de juiste orderstatus weer met asynchrone indexering

_ACP2E-4493 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_

#### Productkenmerk Massa update wijzigt producttype Virtueel->Eenvoudig

Voorkomt de &quot;Heeft dit een gewicht?&quot; besturingselementen die worden geactiveerd voordat de deelvensters voor kenmerk massa-update worden ingevoegd, om ongewenste gewichtswijzigingen voor virtuele producten te voorkomen.

_ACP2E-4500 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

#### Overlappende tekst in Factuur-PDF&#39;s met meerdere pagina&#39;s als de productnaam en aangepaste opties lang zijn

Voordat de correctie wordt uitgevoerd, kunnen lange productnamen met aangepaste opties in PDF&#39;s met meerdere pagina&#39;s voor Factuur, Verzending, Creditmemo en Retourneert, overlappen met aangrenzende kolommen/items na pagina-einden, waardoor secties van regelitems onleesbaar worden.
Na de correctie lopen de regelitems nu correct over de pagina&#39;s en worden de lange namen/opties weergegeven zonder overlapping in de PDF&#39;s Factuur, Verzending, Creditmemo en Retour.

_ACP2E-4630 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/d8a248cd)_

#### [ de redacteur van de Wolk ] HugeRTE blokkeert emojis na verbetering

Vóór de correctie geblokkeerde WYSIWYG/PageBuilder-validatie de hedendaagse 4-byte emoji-inhoud onvoorwaardelijk vanwege de UI-regel die te breed werd toegepast, zelfs bij installaties waar het werkelijke opslagpad utf8mb4-veilig was. Na de moeilijke situatie, wordt de bevestiging beslist gebaseerd op de echte persistentiepad door de actieve de verbindingscharset/collatie van DB samen met de de kolomcollatie van de doelinhoud te controleren, zodat utf8mb4-veilige inhoud wordt toegestaan terwijl utf8/utf8mb3 wegen beschermd blijven.

_ACP2E-4675 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_

#### &rbrack; de wegen van het Beeld van de Wolk &lbrack; zijn absoluut op tweede geef uit in Pagebuilder

Oplossing voor een probleem waarbij inline bewerking van paginakopieertekst absolute URL&#39;s van mediafbeeldingen kon opslaan nadat een afbeelding opnieuw was bewerkt, in plaats van de draagbare instructie {{media url=...}} te behouden.

_ACP2E-4698 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
### Admin UI, Catalog, Prestaties

#### Slechte prestaties van gettree-aanroep in Media Gallery

De verbeterde prestaties van de Galerij van Media door het laden van de folderboom aan de uitbreiding van de op bestelling knoop te veranderen in plaats van de volledige boom te bouwen vooraan, beduidend verminderend de aanvankelijke tijd van de gettree reactie op grote media folderstructuren

_ACP2E-4605 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
### Gebruikersinterface van beheerder, klant/klant

#### Knop voor het opnieuw instellen van gebruikersinterface-formulieren werkt niet zoals u had verwacht voor het veld &quot;Koppelen aan bedrijf&quot; in de pagina voor toevoegen en bewerken van klant

Probleem verholpen waarbij het veld &quot;Koppelen aan bedrijf&quot; in het formulier voor toevoegen/bewerken van klanten niet correct werd hersteld met de knop Herstellen. Het formulier herstelt nu alle velden naar behoren zonder dat de pagina opnieuw wordt geladen en het verwachte gedrag wordt hersteld.

_AC-16364_

### Admin-gebruikersinterface, importeren/exporteren

#### CSV-bestand exporteren is beschikbaar voor downloaden terwijl het exporteren niet is voltooid

Voordat de oplossing werd gevonden, werden exportbestanden in de wachtrij rechtstreeks naar hun uiteindelijke locatie geschreven in var/export, zodat deze bestanden in het exportraster voor Admin konden worden weergegeven en gedownload was toegestaan voordat de generatie klaar was. Hierdoor kunnen gebruikers lege of gedeeltelijk gegenereerde CSV-bestanden downloaden en kunnen niet-verwante bestanden in var/export ook in de exportlijst worden weergegeven en kunnen deze worden gedownload.
Na de correctie worden exporten in de wachtrij alleen naar een tijdelijk bestand geschreven en naar de uiteindelijke exportlocatie gepubliceerd nadat de generatie met succes is voltooid. Met het exportraster en de downloadactie Admin worden nu alleen voltooide exportbestanden weergegeven waarvan de indeling overeenkomt met de geconfigureerde opties voor de bestandsindeling Exporteren, zodat gedeeltelijke downloads worden voorkomen en niet-verwante bestanden worden uitgesloten van de interface.

_ACP2E-4724 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_

### Admin UI, Order

#### Maken van beheervolgorde: Overloop bij sessiegrootte bij het toevoegen van 20+ producten (sessiegrootte groter dan 256 kB limiet)
...
### Gebruikersinterface, bestelling, betalingen

#### Onbekwaam om Gedeeltelijke Terugbetaling te verwerken - de berekeningsmismatch van de restitutie

Terugbetaling van online bestellingen werkt nu correct. Eerder werd deze fout gegenereerd: &quot;De PayPal-gateway wijst het verzoek af. Interne fout&quot;.

_ACP2E-4615 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_

### Beheerdersinterface, prestaties

#### Ernstige vertraging in het beheerpaneel van de staging terwijl het bewaren van product

Het opslaan/bewerken van beheerdersformulieren is sneller voor grote kenmerksets doordat de duur van validatieprocedures aan de clientzijde wordt verminderd en het bestaande validatiegedrag behouden blijft. Hierdoor is de kans op &#39;pagina reageert niet&#39;-stallen in de interface van de beheerder kleiner.

_ACP2E-4488 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_

### Admin-gebruikersinterface, product

#### [ Cloud ] RequireJS mixins.js veroorzaakt dubbel manuscript ladend voor alle diepte modules.

Voordat de correctie werd uitgevoerd, konden sommige JavaScript-bestanden van storefront twee keer worden aangevraagd en uitgevoerd, waardoor er periodiek dubbele ladingen en onstabiel gedrag ontstonden. Na de correctie worden JavaScript-afhankelijkheden slechts eenmaal geladen, zodat dubbele aanvragen worden verwijderd en de bestaande mixfunctie intact blijft.

_ACP2E-4626 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Invoer- en afhandelingsprobleem voor verloopdatum van betaalkaartaccount

Wanneer u een Cadeaukaartaccount maakt of bewerkt in Admin, wordt het veld Vervaldatum nu correct gevalideerd. Eerder konden handmatig ingevoerde waarden die niet overeenkomen met een geldige datumnotatie onjuist worden verwerkt op het moment dat het account werd opgeslagen.
...
#### &rbrack; Bevel van Prestaties van de kwestie &lbrack; &lbrace;voor analytics_collect_data de baanlange looppas van de kroon

Optimaliseerde de analytics_collect_data baanprestaties voor grote gegevensbestanden door de vragen van de rapportbevestiging bij te werken om LIMIT 1 in plaats van LIMIT 0 te gebruiken. Dit voorkomt het onnodig volledig laden van tabelgegevens tijdens de validatie en verkort de uitvoeringstijd aanzienlijk. Geen functioneel effect, volledig achterwaarts compatibele verbetering.

_AC-16639 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40590) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40463)_

#### In het gebruikersrapport Logbestand met beheeracties worden geen details weergegeven van het filter dat is gebruikt bij het toepassen van filters

Voorafgaand aan de moeilijke situatie, het filtreren parameters werden niet het programma geopend in het admin activiteitenrapport. Nu, na de moeilijke situatie, worden alle verzoekgegevens geregistreerd.
...
#### Maximale I/O-spike op servicenotiden als gevolg van aggregaat_sales_report_order_data Cron Job

Hiermee wordt het probleem opgelost waarbij het dagelijks geaggregeerde orderrapport te veel tijd kost om voor een groot aantal bestellingen te genereren, wat leidt tot I/O-pieken op de schijf en verslechtering van de prestaties. Na de moeilijke situatie, wordt het rapport geproduceerd op geschikte wijze.

_ACP2E-4363 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

#### [ CLOUD ] Verslechtering van prestaties toe te schrijven aan analytics_collect_data cron uitvoering

De prestaties verbeteren voor de afdruktaak.

_ACP2E-4496 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_
...
Eerder, toen het bedrijfattribuut werd vereist, ontbrak de gast controle met de fout: &quot;Bedrijf is een vereiste waarde&quot;, zelfs wanneer het veld is ingevuld.
AC-14987
...
Probleem verholpen waarbij gebruikers met beperkte beheerdersrechten een uitzondering tegenkwamen bij het toewijzen van een bedrijf aan een gedeelde catalogus; de update zorgt ervoor dat de toewijzing correct werkt zonder fouten.
...
Oplossing voor een TypeError die optrad bij het toevoegen van gegroepeerde producten aan een aanvraaglijst met categoriemachtigingen ingeschakeld door ervoor te zorgen dat productopties veilig als arrays worden verwerkt, zodat alle producttypen zonder uitzonderingen kunnen worden toegevoegd.

_AC-15862_

#### Ga aan Afhandeling te werk en Verzoek om een Citaat niet zichtbaar op kar na het toewijzen van klant aan bedrijf terwijl het programma geopend

Probleem verholpen waarbij de knoppen &quot;Doorgaan naar afhandeling&quot; en &quot;Aanbieding aanvragen&quot; niet zichtbaar waren op de winkelpagina wanneer een klant aan een bedrijf werd toegewezen terwijl deze zich bij de winkel had aangemeld. Na deze correctie worden beide knoppen direct weergegeven zonder dat de klant zich hoeft af te melden en zich weer hoeft aan te melden.
...
#### [ B2B ] Mijn citaten pagina toont geen citaten wanneer sommige citaten geschrapte producten bevatten

Mijn citaat toont nu correct de citaten wanneer sommige citaten geschrapte producten bevatten.

_ACP2E-4608 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Meerdere coupons werken niet zoals verwacht voor Google Pay

Meerdere couponcodes werkten niet zoals verwacht op de Google Pay Express Pay Sheet. Dit probleem is nu opgelost. Eerder zou het toepassen van een tweede couponcode ten onrechte de korting van de eerste coupon verwijderen en onnauwkeurige totalen weergeven. Het verwijderen van coupons heeft het betaalblad ook niet correct bijgewerkt.
Klanten kunnen nu meerdere couponcodes toepassen op de Google Pay Express Pay Sheet en alle kortingen worden correct weergegeven.

_BUNDLE-3507_

#### Braintree SDK wordt op elke pagina gebeld om een clienttoken te krijgen, zelfs als het bericht Later betalen is uitgeschakeld

De Braintree SDK deed een oproep om het clienttoken op te halen bij elke pagina die wordt geladen, zelfs wanneer het bericht Later betalen was uitgeschakeld. Dit resulteerde in onnodige verzoeken en potentiële prestatieproblemen.
Het systeem vraagt nu alleen om de Braintree client token als zowel de PayPal-betalingsmethode als het Later bericht voor betalen voor de winkelwagen is ingeschakeld. Zo voorkomt u overbodige tokenverzoeken en verbetert u de laadprestaties van de pagina.

_BUNDLE-3508_

#### Het renderen van variabele sjablonen en JS-bestanden van betalingsmethoden voor Braintree stoppen in de sectie &#39;Opgeslagen betalingsmethoden&#39; in het gebied voor klantenaccounts

JavaScript- en sjabloonbestanden voor Braintree-betalingsmethoden zijn weergegeven in het gedeelte &#39;Opgeslagen betalingsmethoden&#39; van het gedeelte voor de klantenaccount, zelfs als betalingsmethoden en betaalconfiguraties van Braintree zijn uitgeschakeld. Dit veroorzaakte onnodige fouten in de browser console.
Het systeem controleert nu of de betalingsmethode van Braintree en de bijbehorende configuratie zijn ingeschakeld voordat verwante bestanden en formulieren worden weergegeven. Alleen als beide zijn ingeschakeld, worden de vaulting-sjablonen en -scripts weergegeven in de sectie &#39;Opgeslagen betalingsmethoden&#39;.

_BUNDLE-3509_

#### Compatibiliteitsproblemen met Apple Pay en Google Pay Third Party

Klanten stuitten op fouten tijdens hun poging om betalingen te verrichten via Apple Pay of Google Pay met behulp van uitcheckextensies van derden (zoals Hyvä Checkout) of aanpassingen. Apple Pay zou met name een TypeError genereren omdat een handelsnaam ontbreekt en Google Pay kan ook mislukken, afhankelijk van aangepaste code-interacties.
De compatibiliteitsproblemen met Apple Pay en Google Pay zijn opgelost. Het systeem behandelt nu behoorlijk derde controleuitbreidingen en aanpassingen, die ervoor zorgen dat de vereiste configuratiewaarden aanwezig zijn en correct teruggekeerd zijn.

_BUNDLE-3510_

#### Google Betalen via Braintree leidt tot oneindig laden tijdens afhandeling

Wanneer Google Pay via Braintree is ingeschakeld, wordt een oneindige laadstatus ingevoerd nadat Google Pay als betalingsmethode is geselecteerd. Hierdoor konden klanten hun bestellingen niet voltooien, zonder foutbericht of feedback.
De Google Pay-integratie via Braintree is zo vastgesteld dat de betalingsstroom naar verwachting verloopt. Klanten kunnen nu Google Pay selecteren tijdens het afrekenen, het betalingsproces voltooien en bestellingen correct plaatsen.
...
#### &rbrack; Ervaring van de Ontwikkelaar van 0&rbrace; kwestie: Code-stijl AbstractItem van citaat (SOP-348 van SwiftOtter)&lbrack;
...
#### Subtotal toont 0 na het uitchecken met veelvoudige adressen en het toevoegen van een verschillende optie van configureerbaar product

Probleem verholpen waarbij het subtotaal van de winkelwagentje ten onrechte als 0 werd weergegeven nadat een andere optie van een configureerbaar product was toegevoegd na uitchecken van meerdere adressen. Subtotaal geeft nu de werkelijke waarde van het winkelwagentje correct weer.

_AC-14460 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/57bad413)_
...
#### [ Uitgave ] Vraag RemoveItem op kar in plaats van ItemRepository

Vervangt de deleteById vraag op CartItemRepository met removeItem op de kartelinstantie.
Hierdoor wordt ervoor gezorgd dat verwachte waarnemers worden geactiveerd en dat het item ook daadwerkelijk wordt bijgewerkt op het winkelwagentje in plaats van alleen in de database.

_AC-15963 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40255) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40248)_
...
#### De korting op regel voor winkelwagentje werkt niet met de voorwaarde dat je een object met de regel hebt uitgesloten

Probleem verholpen waarbij de regels voor de kartprijs onjuist werden toegepast, zelfs wanneer uitgesloten SKU&#39;s aanwezig waren in de subtotale berekening. De kortingslogica negeert nu correct uitgesloten items bij het evalueren van regelvoorwaarden.

_AC-16417 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40503) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/8391dbcc)_
...
Voorafgaand aan de correctie bij het annuleren van de optie voor meerdere verzendingen, was het adres niet vooraf geselecteerd bij het terugkeren naar multiShipping. Het standaardadres wordt nu vervangen door een van de selecties die in het scherm met meerdere verzendingen zijn gemaakt.

_ACP2E-3646 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/6ea61121)_

#### &rbrack; Recente Orden van de Wolk 1&rbrace; verschijnen niet in andere opslagmening als de orden op één archiefmening worden gecreeerd&lbrack;
...
#### Aantal dat als 0 in de sectie van het winkelwagentje van de admin klant toont terwijl het toevoegen van producten BUNDLE  
...
_ACP2E-4245 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/cbca0396)_
...
#### [ CLOUD ] kwestie in het toepassen van een Kaart van de Gift met Recaptcha v2 (&quot;ik ben geen robot&quot;)

Cadeaukaarten worden nu correct toegepast wanneer reCAPTCHA v2 (&quot;Ik ben geen robot&quot;) is ingeschakeld, na geslaagde reCAPTCHA-validatie.

_ACP2E-4410_

#### Er wordt een null-aanhalingsteken gemaakt bij het gebruik van Aanmelden als klant bij Admin

Oplossing voor een probleem dat ertoe leidde dat een null-aanhalingsteken werd gemaakt tijdens de &quot;Aanmelden als klant&quot;-stroom.

_ACP2E-4472 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

#### Inconsistentie in het gedrag Bundelproducten met vaste verzendkosten en gratis verzending

Voorafgaand aan de correctie werd gratis verzending niet correct berekend voor bundelproducten wanneer deze via de regels voor de korting op winkelwagentjes werden geleverd. Na de correctie wordt gratis verzending correct berekend voor bundelproducten.

_ACP2E-4536 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_

#### De orde kan niet voor producten met numerieke SKUs worden geplaatst

Het systeem genereert niet langer een fout bij het plaatsen van een bestelling voor een product met een numerieke SKU.

_ACP2E-4669 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/inventory/commit/83d11138)_

#### De de bevestigingsregels van het Attribuut van het Adres van de klant (EAV) strijden hard - gecodeerde bevestigingsregels.

Verbeterde telefonische validatie van het adres van de klant ter ondersteuning van waarden tot 255 tekens, waarbij controles aan de serverzijde worden uitgelijnd op databaselimieten. De behandeling van de fout werd ook verfijnd zodat de telefoonaantallen van de overlength een duidelijk lengte-specifiek bericht terugkeren.

_ACP2E-4735 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### &rbrack; ACSD-68499_2.4.8-p2 van de Wolk &lbrack; leidt tot een andere kwestie
...
#### [ Coupon ] de Periodieke Fout van de Ingang van de Coupon in quote_coupons Lijst

Oplossing voor een periodiek duplicaatfout in de quote_coupons-tabel wanneer meerdere verzoeken om het samenvoegen van winkelwagentjes of opslaan van aanhalingstekens tegelijk werden uitgevoerd.
...
_ACP2E-4266 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/inventory/commit/ae1f272f)_
...
### Winkelwagentje en kassa, prestaties

#### [ TOYOTA ] De kwestie van Prestaties met de klasse Magento\Store\Model\System\Store

Prestatieverbetering in meerdere winkels en websites.

_ACP2E-4491 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

### Winkelwagentje en afhandeling, Prijs, Belasting

#### In een systeem met meerdere valuta&#39;s laten bundelproductprijzen onjuiste belasting- en valutawaarden tussen PDP en Cart zien.

De prijzen van de bundelproducten worden nu correct weergegeven tussen de pagina&#39;s PDP en Afhandeling.

_ACP2E-4673 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [ Bug ] REST API: Speciale prijzen bijwerken stelt geen waarden in voor alle winkelweergaven
...
#### [ \Magento\ConfigurableProduct\Model\Product\Type\Configurable] PHP fout onopgemerkt
...
Het systeem sorteert nu De nieuwste producten in de database (de met de hoogste entiteit_id) worden eerst weergegeven
...
#### Genegeerde stijlen zonder .less met min-breedte: (@screen_l)
...
#### De Magento Catalog Product List widget retourneert een onjuist aantal

De Adobe Commerce Catalog Product List-widget retourneert nu het juiste totale aantal en de juiste paginering (bijvoorbeeld 9 items op pagina&#39;s zoals geconfigureerd).

_AC-14541 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/39863) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40421)_
...
#### Meta-tags automatisch genereren: variabelen kunnen niet meerdere keren worden gebruikt

Het meta-sleutelwoord van het product automatisch-generatie vervangt nu alle placeholders in het gevormde masker (b.v. `{{name}}, order {{name}}`), niet alleen de eerste keer.

_AC-14626 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/35670) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40412)_
...
#### Klantgroep-id van bedrijf wordt niet toegewezen aan de Customer Group-id van bedrijfsbeheerder wanneer bedrijfsbeheer wordt gewijzigd

Toen het veranderen van admin van een bedrijf in B2B, werd de nieuwe identiteitskaart van de Groep van de Klant van bedrijfbeheerder niet bijgewerkt om de toegewezen Gedeelde Catalogus van het bedrijf aan te passen. Hierdoor werden laagprijzen en categorietoestemmingen voor de nieuwe beheerder gebaseerd op de klantengroep van het vorige bedrijf, wat tot onjuiste tarifering en toestemmingen leidde.
Het systeem werkt nu correct de de Groep van de Klant van het bedrijf admin identiteitskaart bij wanneer admin wordt veranderd. Dit zorgt ervoor dat nieuwe admin de correcte rijprijzen en categorietoestemmingen verbonden aan de Gedeelde Catalogus van hun bedrijf ontvangt.

_AC-14897 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/39964)_
...
#### De website en het probleem met voorraadproblemen voor meerdere websites van de waarschuwingsberichten voor productvoorraad

Deze moeilijke situatie omvat website_id en store_id van product_alert_stock en product_alert_price lijsten in de inzameling SELECT clausule, die ervoor zorgt dat het admin net de correcte website toont waar elke alarm werd ingetekend.

_AC-15044 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40027) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40431)_
...
Er worden geen wijzigingen in functioneel gedrag geïntroduceerd; de update verbetert de ervaring van de ontwikkelaar en de correctheid van de code.
...
bevestigde dat de onjuiste &quot;zo laag als&quot;-prijs voor configureerbare producten wanneer het FPT werd ingeschakeld, werd veroorzaakt door dubbele belastingheffing; met deze correctie wordt gewaarborgd dat de uiteindelijke prijsberekening de belastingconfiguratie respecteert en nu de juiste prijs weergeeft .
...
#### [ Uitgave ] de fout die van het Repareren pagina zonder punten bezoekt

Hiermee wordt een fout verholpen waarbij bij het bezoeken van de pagina voor de vergelijking van het catalogusproduct zonder vergelijkingsitems een fatale fout is opgetreden. De vergelijkingsactie zorgt ervoor dat lege itemverzamelingen veilig worden afgehandeld in plaats van uitzonderingen te genereren.

_AC-15746 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40205) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40203)_
...
#### E-mail met ophaalservice in de winkel gebruikt nog steeds oude methoden

Geen beschrijving beschikbaar.

_AC-16380 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/inventory/issues/3384) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/inventory/pull/3385) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/inventory/commit/b4aeda50)_

#### Verwijderen van vervolgoptie werkt niet wanneer u een kenmerk maakt op de productpagina
...
Probleem verholpen waarbij verwijderde vervolgkeuzemogelijkheden nog steeds werden behouden bij het maken van productkenmerken. Het systeem verwijdert nu correct geselecteerde opties en weerspiegelt het juiste aantal na het opslaan.

_AC-16437 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/57bad413)_
...
#### &rbrack; Bug van de Wolk &lbrack; toen het toevoegen van producten aan categorie
...
#### [ CLOUD ] Product URL herschrijft niet die voor Nieuwe Opslag wordt gecreeerd: Live blokkering
...
#### &rbrack; Fouten van de Wolk &lbrack; met dubbele ingangen (temp_category_descendants_%)

Tijdens het maken van geplande updates voor omgevingen met een groot aantal geneste categorieën was er een probleem met dubbele invoer. Dit probleem is nu opgelost.

_ACP2E-4159 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/a1c57b2e)_

#### [ CLOUD ] vergelijk de Verschillende Uitgave van de Telling van Producten voor verschillende opslag
...
#### De knop Nieuw kenmerk toevoegen is zichtbaar voor gebruikers met beperkte beheerfuncties tijdens het maken van configureerbare producten

De knop &quot;Nieuw kenmerk toevoegen&quot; is nu alleen zichtbaar voor gebruikers met algemene beheerfuncties tijdens het maken van configureerbare producten.
De knop Nieuw kenmerk toevoegen werd eerder weergegeven voor gebruikers met beperkte beheerfuncties
...
#### Verwante producten worden automatisch verwijderd

Verwante producten waarvoor doelregels gelden, blijven nu op de juiste wijze in verband gebracht met het hele reïndexeringsproces

_ACP2E-4430_

#### [ CLOUD ] Cirkelafhankelijkheden voor categorieën

Voorafgaand aan de correctie kon u categorieën met kringsafhankelijkheid bewaren. Na de correctie wordt dit gedrag voorkomen via een validatieregel.

_ACP2E-4505 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_

#### De hiërarchische URL wordt niet bijgewerkt in CMS-hiërarchie wanneer de URL-sleutel voor onderliggende pagina wordt gewijzigd (2.4.8-p3)

Probleem verholpen waarbij het wijzigen van de URL-sleutel van een CMS-pagina de hiërarchische URL van de pagina niet bijwerkte (bijvoorbeeld /help/my-account is hetzelfde gebleven nadat de naam is gewijzigd in my-account-2). De logica voor hiërarchieupdate bevat nu correct het eigen knooppunt van de pagina, zodat request_url wordt bijgewerkt en het nieuwe pad (bijvoorbeeld /help/my-account-2) werkt zoals verwacht.

_ACP2E-4531_

#### Tijdelijke aanduiding voor afbeelding wordt niet naar behoren weergegeven voor verschillende winkels

Voordat de plaatsaanduidingsafbeeldingen voor reparaties werden geladen, werden deze niet in de opslagcode geladen toen deze in de URL werd ingevoegd. Na de correctie zijn voorlopige afbeeldingen bereikgevoelig met of zonder opslagcode die in de URL is opgenomen.

_ACP2E-4533 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/aa2e16d1)_

#### [ CLOUD ] Deadlock op table magento_catalogpermissions_index_product. voortzetting

Vóór de moeilijke situatie, kon de lopende het productherdex van de Toestemmingen van de Catalogus de bestaande rijen van de toestemmingsindex ongewijzigd laten, zodat werden de bijgewerkte subsidies van de categorietoestemming niet betrouwbaar weerspiegeld op producten.
Na de moeilijke situatie, werkt het opnieuw indexeren correct bestaande rijen van de toestemmingsindex bij, zodat worden de toestemmingsveranderingen consequent toegepast in storefront toegang, prijszicht, en checkout beschikbaarheid.

_ACP2E-4603_

#### De indexeeruitsnede van de Regel van het doel selecteert geen producten die slechts bij het werkingsgebied van de archiefmening worden toegelaten

De pixel aan de moeilijke situatie, de producten die niet in het werkingsgebied Admin werden toegelaten, werden niet opgenomen door de indexeerder van de doelregel. Nu, na de moeilijke situatie, worden de producten opgepikt als in minstens één werkingsgebied wordt toegelaten.
...
#### [ Wolk ] - de Fout toont wanneer de waarde catalog_product_entity_int voor attribute_type 0 of Null in de grafische producten selecteert

Probleem verholpen waarbij de GraphQL-productquery met aggregaties een fout retourneert met ongeldige kenmerkwaarden of -opties. De vraag behandelt nu correct ongeldige gegevens en keert correcte resultaten terug.

_ACP2E-4529 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_
...
### Catalogus, retourneert

#### [ de terugkeer van de Wolk ] orde pagina voor de rij van het bundelproduct krijgt auto unselected

Eerder hadden we voor het bundelproduct Samen verzenden in de rasterweergave van het deelvenster Beheer de optie Items selecteren, die verwarring creëerde voor de optie Samen verzenden van het bundelproduct. Nadat deze correctie is toegepast, zijn er voor bundelproductverzendingen geen opties meer voor &quot;Items selecteren&quot;.
...
#### &rbrack; Filter van 1&rbrace; Kleine insect van het Comité Admin `listing component` kan niet raken wanneer de gebiedswaarde `\` bevat&lbrack;

Het systeem werkt prima als wij paginatitel filtreren die schuine streep in het heeft (bijvoorbeeld: Magento\Store)
...
#### Fout: Scriptfout voor &quot;Magento_Catalog/js/validate-product&quot; voor de pagebuilder voor beheerinhoud met productladen
...
Het systeem wordt nu gerepareerd wanneer we toegang krijgen tot een bestaande sitemap die reageert op een productafbeelding met Response: 404 NIET GEVONDEN
...
Probleem verholpen bij afhandeling voor meerdere verzendingen waarbij op de pagina met revisievolgorde onjuiste verzendkosten werden weergegeven (5 INR in plaats van 10 INR). de update zorgt ervoor dat het juiste verzendbedrag voor elk adres wordt weergegeven.

_AC-15664 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/3cf1a106)_

#### De mappenstructuur van de medialalerie verdwijnt wanneer de naam van de categoriegbeelding begint met &quot;-&quot; (streepje)

Geen beschrijving beschikbaar.

_AC-16544 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40536)_

#### Fout &quot;CMS-blok bevat ongeldige inhoud&quot; wordt weergegeven wanneer CMS-blok &quot;Catalog Events Lister&quot; wordt opgeslagen

Probleem verholpen waarbij bij het opslaan van het standaard CMS-blok Catalog Events Lister de fout &#39;&#39;CMS block contains invalid content&#39;&#39; werd weergegeven. Na deze correctie kan het blok zonder fouten worden opgeslagen in het deelvenster Beheer.

_AC-16686 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### &rbrack; de omslagverwezenlijking van de Galerij van de Media van de Wolk 1&rbrace; vereist schrapping_folder toestemming in Nieuwe Galerij van Media - de rollen met slechts create_folder kunnen geen omslagen tot stand brengen&lbrack;
...
#### Beheerder met bevoegdheden op websiteniveau kan dynamisch blok niet bewerken

Beheerders met bevoegdheden voor het bereik van websites kunnen nu de inhoud van banners in toegankelijke opgeslagen weergaven bewerken.

_ACP2E-4468_

#### [ de Kritieke logboeken van ADOBE STOCK ] &quot;Slaagden er niet in om de resultaten van de het onderzoeksdossiers van Adobe Stock&quot;terug te winnen zelfs wanneer de integratie gehandicapt is.

Het systeem registreert niet langer de fout &quot;Kan de resultaten van Adobe Stock-zoekbestanden niet ophalen&quot; wanneer Adobe Stock Integration is uitgeschakeld.

_ACP2E-4634_

#### Fouten bij het maken van nieuwe pagina&#39;s en het gebruik van Page Builder die een fout genereren

Probleem verholpen waarbij CMS-pagina&#39;s niet konden worden opgeslagen bij gebruik van Page Builder.
...
#### [ Admin ][Customer] Wachtwoord dat op Klantbeheerder wordt teruggesteld ontbreekt

Probleem verholpen waarbij het opnieuw instellen van het wachtwoord van een klant vanuit het beheerpaneel een systeemfout tot gevolg had en de pagina vastliep. Het opnieuw instellen van wachtwoorden werkt nu correct en verzendt de koppeling reset zonder fouten, zelfs in randgevallen met wijzigingen in de opslagruimte.

_AC-14940 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/3e41a43b)_
...
#### Code van uitgeschakelde module compileren
...
&quot;Waarschuwing: Poging tot arrayverschuiving op waarde van type null in vendor/magento/framework/Mview/View/Subscription.php op regel 357&quot;
AC-11487
...
Met deze PR kunnen formulierelementen met meerdere waarden gegevens verzenden naar een website/groep/opslagformulier.
...
#### &rbrack; Bevestig-e-mailregel voor ui-component van de kwestie &lbrack;
...
Codekwaliteit: Verwijderd overtollige methodes in AsynchronousOperations en de componenten van de Verkoop die slechts oudermethodes zonder functionaliteit riepen toe te voegen, verbeterend codeonderhoudbaarheid.
...
Deze pull-aanvraag verhelpt een probleem wanneer een CMS-pagina die is gemaakt met de null-kop, zoals in PHP 8.x die null doorgeeft aan trim(), een uitzondering genereert: Verouderde functionaliteit: trim(): Null doorgeven aan parameter #1 ($string) van type string
...
#### [ Uitgave ] Opschonen: gebruik geen waarde van de void terugkeer van methodevraag.
...
#### &rbrack; [ PHPDOC ] Correctie slechte phpdoc voor Magento\Framework\Message\ManagerInterface&lbrack;
...
De verzendlabelbedragen komen nu overeen met de verzendkosten.
Eerder, na het downloaden van een verzendlabel, kwam het weergegeven bedrag niet overeen met de verzendprijs.
AC-14560
...
#### [ Uitgave ] vermijd veel onnodige uitzonderingen tijdens het samenvoegen van lay-outXML laden
...
#### &rbrack; Verwijderde de codeovertolligheid van de 0&rbrace; Uitgave voor module frontend lay-outs.&lbrack;
...
Eerder leidde het verzenden van e-mails via SMTP met TLS tot de fout: fout :1408F10B: SSL routines :ssl3_get_record: verkeerd versieaantal.
AC-14883

_AC-14883 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/39947) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/3717e6cb) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/d3ea191d)_
...
#### Rest-API: Aanroep van een lidfunctie getVideoProvider() op null
...
#### &rbrack; Logboek niet-gedeclareerde plug-in van 0&rbrace; Issue &lbrace;alleen als deze niet is uitgeschakeld&lbrack;
...
#### &rbrack; Kleine schoonmaakbeurt van 0&rbrace; kwestie, verwijderde dubbele sleutels van serie&lbrack;
...
#### Magento 2.4.8-p2, magento/framework versie 103.0.8-p2: De klasse EmailMessage die een niet-bestaande methode aanroept
...
_AC-15446 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40170) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/e9412b24)_
...
#### &rbrack; [ PHPDOC ] Correctie slechte phpdoc Magento\Framework\DB\Adapter\AdapterInterface::quoteColumnAs ()&lbrack;
...
Bevestigd dat het ontbreken van subcategorieverbindingen op de storefront homepage toen het gebruiken van Vierkant 7.3 door ESI verzoek behandeling en serverconfiguratie eerder dan een het codegebrek van Magento werd veroorzaakt; het probleem wordt opgelost door aanbevolen Varnish-configuratieaanpassingen, zonder vereiste wijzigingen in de kerncode.
...
#### NewRelic Module - Verwijder onnodige gebiedsdelen

Verwijdert de onnodige afhankelijkheid van magento/magento-composer-installer van de magento/module-new-relic-rapporteringsmodule om ongebruikte/strakke koppeling in gebiedsdelen op te schonen

_AC-15945 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40243)_
...
#### Fake Modules vereisen dev/Directory in opslagplaatsen voor extensies

Geen beschrijving beschikbaar.

_AC-16487_

#### Toevoegen aan tekengebeurtenis: lege prijzen
...
#### &rbrack; Repareer veranderlijke naam van 0&rbrace; Uitgave &lbrace;in catalogusonderzoek&lbrack;
...
Het wijzigen van het gegevenstype van de kolom werkt niet correct. Eerder wordt een fout gegenereerd: Het kenmerk &#39;identity&#39; is niet toegestaan.
...
#### PHP8.4 Deprecation Error: E_USER_ERROR na Upgrade naar Adobe Commerce 2.4.8

*ER ZIJN GEEN RELEASNOTITIES VEREIST*
...
#### Waarschuwing bij afzetting: gebruik moment.updateLocale(localeName, config) om een bestaande landinstelling te wijzigen. moment.defineLocale(localeName, config)
...
#### [ CLOUD ] fout DateTimeZone wanneer het bewaren van productveranderingen via REST API

Voorafgaand aan de correctie zou een product update REST API verzoek een fout veroorzaken als er geen opslag met code &quot;gebrek&quot;was. Nu, na de moeilijke situatie loopt het productupdateverzoek prima ongeacht als een &quot;standaard&quot;opslag bestaat of niet.
...
#### Captcha_delete_expired_images bijsnijden die niet werken na Magento 2.4.8-update

Voorafgaand aan de correctie werden verlopen Captcha-afbeeldingen niet automatisch meer verwijderd. Na de correctie worden verlopen Captcha-afbeeldingen verwijderd door de corresponderende uitsnijdtaak.

_ACP2E-4512 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

### Kader, prestaties

#### [ CLOUD ] Slow MySQL verzoeningsvraag in de async van het verkoopnet - volledig lijstaftasten, 20+ s, ~14M onderzochte rijen

Verbeterde afstemmingsprestaties van het verkoopnet door missing-ID ontdekking te schakelen aan begrensde entiteit_id vensters met curseur-gebaseerde progressie, die herhaalde groot-lijstscans op hoog-volumeopslag vermindert.

_ACP2E-4585 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Probleem verholpen waarbij een GraphQL-query een uitzondering veroorzaakte vanwege een ongeldige sorteerparameter. na de correctie wordt de query met succes uitgevoerd zonder dat er fouten of uitzonderingslogbestanden worden gegenereerd.
...
Vorige wijziging die fouten in een andere indeling retourneert, is hersteld. Mogelijke fouten worden nu op een consistente manier geretourneerd, niet door het GraphQL-schema te verbreken.
...
#### GraphQL voor bestelling van klant: Productcategorieën ophalen voor het bijbehorende product is &quot;niet afzonderlijk zichtbaar
...
Vóór de correctie bood de positie van het foutknooppunt geen naadloze compatibiliteit met 2.4.7- en 2.4.9-versies. Na de correctie is het foutknooppunt nu op de juiste wijze geplaatst voor beide versies.
...
#### AC-2.4.9 - Kan geen orders doorzoeken op EDS-bouwsteen

Het GraphQL-queryinvoertype voor gastOrder is bijgewerkt naar GuestOrderInformationInput in plaats van OrderInformationInput.

_LYNX-872_

#### [ wisselstroom-2.4.9 ] de vraagwinst van de Kar onjuiste beschikbaarheidsstatus voor producten met Meerdere-Source Inventory (MSI) en de standaardvoorraad is 0

Correctie van een probleem waarbij de onjuist geretourneerde art-API is_available: false voor producten die over meerdere bronnen van de Source Inventory (MSI) voldoende voorraad hadden.

_LYNX-918_

#### [ AC-2.4.9 ] kan geen het verschepen/het factureren adres van een klant met setNegotiableQuoteShippingAddress/setNegotiableQuoteBillingAddress GQLs plaatsen

Het veld uid is beschikbaar in de GraphQL-query voor klantadres om het instellen van verzend- en factureringsadressen in verhandelbare aanhalingstekens mogelijk te maken.

_LYNX-924_

#### [ AC-2.4.9 ] Lijst van de Orde | Interne serverfout

Gegarandeerde stabiliteit in orderstromen door null te retourneren voor ontbrekende aangeschafte producten, waarbij uitzonderingen in de ordergeschiedenis en recente bestellingen worden vermeden.

_LYNX-937_

#### [ AC-2.4.9 ] richt NegotiableQuoteBillingAddressInput met BillingAddressInput

&#39;
Uitgelijnd NegotiableQuoteBillingAddressInput, BillingAddressInput, ShippingAddressInput en GiftRegistryShippingAddressInput om het adres van de klant te ondersteunen en tegelijkertijd de id van het klantenadres te vervangen.
Introduceerde deleteCustomerAddressV2- en updateCustomerAddressV2-mutaties om het adres van de klant te ondersteunen en verouderde de bestaande deleteCustomerAddress- en updateCustomerAddress-mutaties.
...
Probleem verholpen waarbij het veld only_x_left_in_stock GraphQL null retourneerde wegens onjuiste dubbele aftrek van MinQty. de berekening werd gecorrigeerd , zodat nu de nauwkeurige op drempels gebaseerde voorraadwaarde wordt geretourneerd .
...
#### [ Cloud ] de klantenbestellingen SalesGraphQl- vraag keert onjuiste waarden voor de gebieden van het ordepunt terug

Hiermee wordt het probleem verholpen waarbij de query SalesGraphQl customerOrders de opgeblazen original_price_include_tax en original_row_total_include_tax waarden retourneert terwijl catalogusprijzen werden ingesteld op &#39;Including Tax&#39; omdat de belasting een tweede keer werd toegepast op prijzen die al belasting bevatten.

_ACP2E-4762 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [ Uitgave ] Copyright: &quot;kopiëren&quot; wijzigen in &quot;kopiëren&quot;
...
#### Invoer CSV-product: Kan het instellen van een staalafbeelding niet ongedaan maken
...
#### CSV met geavanceerde prijzen; CSV met producten wordt niet geëxporteerd. OOM, zelfs met een geheugenlimiet van 4 G

Vóór de correctie konden de volledige uitvoer van het Product en de Geavanceerde Prijsuitvoer met hoog geheugengebruik/OOM op grote catalogi ontbreken, en de de uitvoerpaginering van het product kon dubbele rijen veroorzaken wanneer de dynamische paginagrootte tijdens verwerking veranderde. Na de correctie wordt de uitvoer voltooid met een stabiel geheugengedrag door middel van gepagineerde batchverwerking, dubbele rijen van pagineringsoverlapping worden verwijderd en de geëxporteerde rijinhoud blijft uitgelijnd met de basislijnuitvoer.

_ACP2E-4587 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
#### ACS2E-4118 na patch: Bij wijziging van de voorraaddrempel in Admin worden negatieve verkoophoeveelheden en komen de voorraadstatus niet overeen
...
Voordat de oplossing werd gevonden voor klanten die in-Store ophaalservice zonder verzendadres kiezen, werd hun factuuradres automatisch ingevuld met het adres van de winkel. Dit adres kon niet worden gewijzigd, wat tot onjuiste factuurgegevens leidde. Nadat het adres van het fixfacturerings nu editable in dit scenario is, toestaand gasten om hun eigen details in te gaan. Geregistreerde gebruikers zien hun opgeslagen factureringsadres in plaats van dat van de winkel.
...
Voorafgaand aan de vaststelling werden de prijzen van de bundels niet correct geïndexeerd wanneer de voorraden van kinderproducten onder aangepaste bronnen lagen. Nu, na de correctie, worden de bundelprijzen behoorlijk geïndexeerd ongeacht de toewijzing van de voorraad van het kindproduct.
...
#### De status van de voorraad wordt verkeerd teruggezet aan in voorraad met de hoeveelheid nadat SKU tijdens het opvoeren van update verandert

SKU-wijzigingen zijn nu verboden voor producten met een actieve geplande update; Opslaan zal mislukken met een duidelijke fout, en het admin SKU gebied wordt onbruikbaar gemaakt tijdens actieve updates. Dit verhindert MSI inventarisinconsistenties die door veranderingen van SKU tijdens het opvoeren van terugdraaiversies worden veroorzaakt.

_ACP2E-4389_

#### Verkoopbaarheidsstatus van bundel wordt niet bijgewerkt wanneer bestelling wordt geannuleerd

De verkoopbaarheid van het bundel product wordt nu correct berekend na het annuleren van de bestelling.

_ACP2E-4481 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/inventory/commit/96b77663)_

#### Magento staat oververkopen toe wanneer meerdere klanten tegelijkertijd orders plaatsen

Met MSI kunnen meerdere klanten tegelijkertijd orders voor hetzelfde product plaatsen en de beschikbare voorraad overschrijden, waardoor oververkopen wordt veroorzaakt. Na de correctie kan slechts één bestelling per product worden uitgevoerd wanneer de kassa&#39;s tegelijkertijd worden uitgevoerd, zodat er geen sprake meer is van oververkopen.

_ACP2E-4509 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/inventory/commit/a33c60f2)_

#### [ CLOUD ] Onderbreking als de cliënten meer dan 140 artikel in mandje hebben

De de gegevensbestandvragen van de inventaris zijn geoptimaliseerd om inventarisgegevens tijdens het afrekenen te laden. Dit elimineert de behoefte aan individuele vragen voor elke SKU, die tot een significante prestatiesverhoging voor controle met grote winkelwagentjes leidt.

_ACP2E-4519 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/inventory/commit/40858072)_

### Loyalty

#### [ CLOUD ] getCustomerRewardPoints werpt een uitzondering wanneer de klant geen punten heeft

De bonuspunten van de klant worden met succes in werking gesteld wanneer gecreeerd via admin.

_ACP2E-4403 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Invoice addComment kan een fout genereren wanneer Invoice getComments voor het eerst wordt aangeroepen

Deze PR verhelpt een kritieke bug waarbij het aanroepen van $factuur->getComments() vóór $factuur->addComment() een fatale fout veroorzaakte &quot;Oproep aan een lidfunctie addItem() on array&quot;. De moeilijke situatie voert behoorlijk type controle en omzetting tussen serie en inzamelingstypes in de commentaarmethodes van het model van de Rekening uit, die ervoor zorgen beide methodes in om het even welke orde zonder fouten kunnen worden geroepen terwijl het handhaven van achterwaartse verenigbaarheid.

_AC-14848 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/39884) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40428)_
...
#### Magento2: Promotieregel kan niet worden gemaakt
...
Probleem verholpen waarbij geen aanvraaglijsten konden worden gemaakt voor producten die aan een nieuwe website en bron waren toegewezen toen &#39;Winkelcode aan URL&#39;s toevoegen&#39; was ingeschakeld. Het probleem is opgetreden omdat de opslagcode is verwijderd uit de API-aanvraag, waardoor een onbevoegde fout is opgetreden. Na de correctie blijft de juiste archiefcontext behouden en worden aanvraaglijsten gemaakt.

_AC-16226_

#### Verkoop->Verzendadres van orderingenraster kolom ontbreekt land

Probleem verholpen waarbij het land voor internationale bestellingen niet werd weergegeven in de kolom Verzendadres in het netwerk voor bestellingen voor beheerders. Het adres omvat nu landinformatie, die ordezicht en bruikbaarheid verbetert.

_AC-16256 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40403) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/3e41a43b)_

#### De consument van de asynchrone bestelling verwerpt bestellingen met uitgestelde voorraadupdate: NodergelijkeEntiteitException in CartManagementPlugin::getActive() (inactief aanhalingsteken)

Probleem verholpen waarbij asynchrone uitchecken met uitgestelde voorraadupdate voor gastorders mislukte. Eerder heeft de consument een NodergelijkeEntiteitException veroorzaakt door inactieve citaten, die ervoor zorgen dat de orden worden gemerkt Geweigerd in plaats van Hangende. Na deze correctie verwerkt de consument correct inactieve aanhalingstekens, verplaatst de bestellingen van Ontvangen naar In behandeling en past de verkoopbare hoeveelheden aan zoals verwacht. De MFTF-test AsyncOrderWithAsyncStockReservationTest slaagt nu.

_AC-16680 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
#### &rbrack; Magento OOTB-code van 1&rbrace; Cloud - E-mail de kwestie van de Opstelling van het Malplaatje&lbrack;

Voordat de oplossing werd gevonden, waren de e-mails bij het gebruik van asynchrone e-mailverzending inconsistent met de winkelbestelling. Na deze correctie wordt nu de juiste e-mailbestelling voor verzending via e-mail naar de winkel verzonden.
...
#### Winkelspecifieke afzender wordt niet gebruikt voor e-mails met een creditcard

Eerder, wanneer het verzenden van een e-mailmalplaatje voor een geschenkkaart nadat een factuur van een verschillende opslag werd gecreeerd, zou de naam van de eigenaar in de montages van de admin configuratie niet in de e-mailkopballen worden weerspiegeld wanneer de klant e-mail ontving. Nadat deze correctie is toegepast, bevatten de e-mailheaders nu de e-mailgegevens van de desbetreffende eigenaar van de winkel.
...
#### GraphQL cancelOrder annuleert geen bestellingen die volledig zijn betaald met een creditcard

Vóór de correctie ging een bestelling die volledig is betaald via een cadeaukaart niet automatisch naar de status &quot;gesloten&quot; wanneer ze via een GraphQL-mutatie werd aangeroepen. Na de correctie gaat de bestelling naar de status &quot;closed&quot; wanneer deze via GraphQL wordt geannuleerd.

_ACP2E-4455 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/e2b23caa)_

#### Coupongebruik wordt niet hersteld bij annulering/afwijzing van bestelling

Wanneer u een bestelling annuleert, wordt het gebruikte gebruik van de coupon nu correct opnieuw ingesteld, zelfs als de configuratie van de orderstatus is gewijzigd. Dit kan ertoe leiden dat coupons gemarkeerd blijven als gebruikt nadat een bestelling is geannuleerd toen er aangepaste instellingen voor de orderstatus waren.
...
#### Kan waarde niet leeg laten voor &quot;Punten van de Terugkeer van het Uiteinde bij&quot;- Opgeslagen

In Adobe Commerce kunnen verkopers nu het veld Punten achteruit bij uiteinde leeg laten terwijl ze nog steeds een waarde instellen voor Drempel voor terugbetalingsbalans punten. Eerder, toen het vormen van beloningspunten onder Opslag > Configuratie > Klanten > Punten van de Terugbetaling, die een positief aantal voor de Drempel van de TerugbetalingsPunten van de Punten van het Saldo ingaan en het verlaten van de Punten van de Punten van de Punten van de Punten van het Kapitaal bij leeg inging teweegbrachten de bevestigingsfout: &quot;The \&quot;Cap Reward Points Balance\&quot; is invalid. De balans moet een positief getal zijn of leeg blijven. Verifieer en probeer het opnieuw.&quot;, verhindert handelaars de configuratie zonder een GLB te bewaren. ACP2E-3977

_ACP2E-3977_

#### De prijsregels van de auto die op klantensegmenten worden gebaseerd vertragen voor geregistreerde gebruikers

Probleem verholpen waarbij de regels voor de kartprijs op basis van klantsegmenten niet onmiddellijk werden toegepast voor geregistreerde gebruikers. De korting is nu correct van toepassing op het toevoegen van een in aanmerking komend product aan de wagen zonder dat een token moet worden vernieuwd.

_LYNX-814_

#### GQL - kwantiteitsveld in ProductInterface retourneert geen verkoopbare hoeveelheid

Oplossing voor een GraphQL-probleem waarbij het kwantiteitsveld in ProductInterface de te verkopen hoeveelheid niet retourneert.

_LYNX-816_

#### Kan null niet retourneren voor niet-nullable veld &quot;SelectedShippingMethod.carrier_code&quot;

Probleem verholpen waarbij het selecteren van de tweede verzendmethode tijdens het afrekenen met een Amerikaans adres ertoe leidde dat een fout van het veld SelectedShippingMethod.carrier_code in het niet-nullable veld niet null wordt geretourneerd. Deze correctie zorgt voor vloeiende navigatie bij het uitchecken zonder interne serverfouten te veroorzaken.

_LYNX-817_

#### [ AC-2.4.9 ] addProductsToCartMutation keert 200 op fout terug

Introduceerde een nieuwe foutencode, REQUIRED_PARAMETER_MISSING, om gebruikersfouten te behandelen wanneer de configureerbare productopties niet tijdens toe:voegen-aan-kart worden geselecteerd.

_LYNX-884_

#### [ wisselstroom-2.4.9 ] Fout wanneer het verzoeken van CartItem.not_available_message of is_available gebied wanneer de controle van de kartvoorraad wordt onbruikbaar gemaakt

Correctie van fout bij toegang tot niet_available_message of is_available op CartItem wanneer controle van winkelwagenvoorraad uitgeschakeld is.
...
#### [ Uitgave ] Toegankelijkheid: WAI-ARIA rollen nesten fout in menu
...
#### Cron job geplakt door OOM - verzoek om innodb_buffer_pool_size en PHP memory_limit voor cron te bekijken

De verwerking van betalingstransacties is verbeterd

_ACP2E-4601 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c12a7510)_
...
#### &rbrack; Geheime voorgeheugen van de kwestie &lbrack; de resultaten van vraag isCacheable om prestaties te verbeteren
...
#### &rbrack; php-fpm van 0&rbrace; wolk &lbrace;&lbrace;respecteert max_executing_time&lbrack;

De configuratie van de plaatsing wordt nu geladen eens in één enkel verzoek.
...
Vóór de correctie waren de cachetoetsen die voor externe opslagmetagegevens werden gebruikt, niet verlopen. Nu, na de moeilijke situatie, kunt u TTL voor dergelijke geheim voorgeheugensleutels door gebiedsdeelinjectie plaatsen.

_ACP2E-4345 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/0a3b7032)_

#### [ CLOUD ][ CLOUD ] [ Belangrijkste ] sales_clean_quotes getSize () knelpunt

Verbeter de prestaties van de uitsnijdtaak van sales_clean_quotes.

_ACP2E-4610 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_

#### Subcategorieën op laatste niveau tonen het aantal producten nul in de boomstructuur van de admincategorie

Voorafgaand aan de moeilijke situatie, namen de bladcategorieën niet producttelling op wanneer getoond in de de categorieboom van het beheerdergebied. Na de correctie wordt het aantal producten correct weergegeven voor elk categorieblad.

_ACP2E-4689 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/d8a248cd)_

#### Trage vraagprestaties op de magento_promise_history- lijst toe te schrijven aan zijn grote gegevens

Probleem verholpen waarbij de beloningspunten het aflopen van de cron-taak traag uitvoerden op grote magento_promise_history-tabellen. Eerder, de vraag die door de geplande die puntvervaldatum wordt gebruikt ontsloeg samengestelde gegevensbestandindexen, veroorzakend volledige lijstscans op lijsten met miljoenen verslagen.
...
Probleem verholpen waarbij nieuwe prijskenmerken onjuist werden toegewezen aan het bereik van de winkelweergave, ongeacht de configuratie. na de correctie wordt het kenmerkbereik nu standaard uitgelijnd op de instelling voor prijsbereik van catalogus (Algemeen of Website).
...
Er wordt nu een foutbericht weergegeven: &quot;Zorg ervoor dat de datum Tot later is dan of gelijk is aan de datum bij Van.&quot;
...
#### Volgorde of filter op prijs die niet werkt voor bundelproducten buiten de voorraad

Wanneer de optie &quot;Producten uit voorraad weergeven&quot; is ingeschakeld, wordt de productpagina nu op de juiste wijze gefilterd en worden producten uit de voorraadbundel op prijs gesorteerd.

_ACP2E-4475 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/f2fd9628) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/inventory/commit/a33c60f2)_
...
Adobe Commerce voorkomt nu op de juiste wijze dat onjuiste catalog_product_alert-snijtaken worden gepland nadat de naam van de productwaarschuwing is gewijzigd in product_alert. Eerder, in Adobe Commerce 2.4.8, leidde het vormen van Opslag > Configuratie > Catalogus > Catalogus > de Montages van de Looppas van het Alarm van het Product ertoe dat een catalog_product_alert cron ingang in core_config_data wordt gecreeerd, en wanneer het bouwenlooppas het programma opende de fout Magento_Cron.CRITICAL: Uitzondering: Er zijn geen callbacks gevonden voor cron job catalog_product_alert, ook al werden de geldige product_alert-taken correct uitgevoerd.
...
Als u eerder op Afdrukken klikt, is de fout opgetreden: &quot;Er is een fout opgetreden tijdens het uitvoeren van de toepassing. Zie uitzonderingslogboek voor details.&quot;
AC-14711
...
Probleem verholpen waarbij de vergelijkingslijst onbruikbaar werd toen hetzelfde product vanuit verschillende winkelweergaven werd toegevoegd. na de correctie wordt de vergelijkingslijst correct geladen en worden items weergegeven op basis van de specifieke opslag.
...
#### Onnodig beschermde karakters in ProductInterface

Het systeem retourneert nu unescaped `>` in de naam in GraphQL response.

_AC-15494 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40178) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40423)_
...
#### Restitutie met negatieve hoeveelheid altijd korting op restitutie
...
#### &rbrack; de generatieprestaties van de Sitemap van 0&rbrace; wolk &lbrace;zijn beduidend degraded&lbrack;
...
#### De inconsistentie van de sorteervolgorde van klantsegmenten zorgt ervoor dat X-Magento-Vary cookie de hele tijd opnieuw wordt gegenereerd op sommige pagina&#39;s

Met X-Magento-Vary cookie wordt nu één keer ingesteld op de productpagina, en met sommige configuraties van klantsegmenten wordt het cookie een aantal keren ingesteld tijdens het laden van de PDP
...
#### Na de moeilijke situatie voor ACS2E-2926, worden de klantensegmenten aangepast op elk controleverzoek, veroorzakend onnodige verwerking

De functionaliteit voor klantensegmenten omvat nu een caching-mechanisme om de prestaties te verbeteren.

_ACP2E-4299_

#### `[Cloud][experienceleague]` Catalog Price Rule niet toegepast
...
#### Incrementele indexering van doelregel kiest geen uitgeschakelde producten

De incrementele indexering van de doelregel reageert nu wanneer een product wordt in- of uitgeschakeld, zodat de aanbevelingen voor verwante/upsell/cross-sell worden bijgewerkt zonder een volledige herindex.

_ACP2E-4402_

#### De segmentatie van de klant werkt niet correct met Rest API

Klantsegmenten op basis van het aantal bestellingen worden nu correct bijgewerkt wanneer bestellingen via de REST-API worden geplaatst. Eerder werd het segmentlidmaatschap niet bijgewerkt voor API-orders omdat de waarnemer afhankelijk was van de klantsessie, die niet beschikbaar is in API-aanvragen.

_ACP2E-4590_

#### Kan regel voor winkelwagenprijs niet maken met de voorwaarde voor actie &#39;Categorie (alleen kinderen)&#39; via de REST API

Hiermee wordt het probleem verholpen waarbij het bereik van een voorwaardeligheidskenmerk van een winkelwagentje, zoals Categorie (alleen bovenliggende) en Categorie (alleen kinderen), niet werd weergegeven wanneer regels werden opgehaald of bijgewerkt via de REST API.

_ACP2E-4653 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/d8a248cd)_

#### De prijsregels voor winkelwagentjes voor gratis verzending werken niet zoals verwacht voor bundelproducten

Verbeterde verwerking van gratis verzending

_ACP2E-4720 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/c58a8ad0)_

### Retourneert

#### Probleem met eenvoudige keuzemogelijkheid bij het retourneren van bundelproducten

Eerder, voordat deze correctie werd geïmplementeerd, werd voor bundelproducten met de optie om items afzonderlijk te verzenden voor retourneringen, met de functie Items selecteren alleen het pop-upblok voor het eerst geopend. Nadat het pop-upblok was geselecteerd of gesloten, werd het niet telkens geopend wanneer de functie Items selecteren werd aangeroepen. Nadat u deze correctie hebt toegepast, is het probleem echter opgelost en werkt de functie nu naar behoren.
...
Probleem verholpen waarbij DynamicStorage niet filterde op entiteit_type, waardoor CMS-pagina&#39;s onjuist werden behandeld als producten in categorie-URL&#39;s. onjuist gevormde URL&#39;s retourneren nu correct een 404 in plaats van CMS-inhoud te bedienen.
...
Probleem verholpen waarbij het inschakelen van categoriepaden in product-URL&#39;s ertoe leidde dat de winkelswitch mislukte. Winkelomschakeling lost product-URL&#39;s nu correct op in de verschillende winkelweergaven zonder de homepage te hoeven doorsturen of fouten te retourneren.
...
#### Foutbericht wordt niet weergegeven voor GET-verzoek

Probleem verholpen waarbij foutberichten niet meteen werden weergegeven voor ongeldige GET-aanvragen. Foutberichten worden nu correct weergegeven zonder dat extra handelingen van de gebruiker nodig zijn. Hierdoor wordt feedback van de gebruiker verbeterd en de consistentie verbeterd.

_AC-16296 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40411) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/8391dbcc)_

#### Vertaling ontbreekt, tekens

Het systeem verwerkt vertalingen van ontbrekende tekens nu correct

_AC-16626 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40580) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40581)_
...
#### &rbrack; de Schakelaar van de opslag van 0&rbrace; wolk &lbrace;het Werken van de Schakelaar van de Opslag niet van EN aan FR voor FAQ Pagina&lbrack;
...
De staatstoewijzing voor bestellingen werkt nu zoals u had verwacht.
Eerder, wanneer het toewijzen van de status van de douaneorde, de &quot;Verwerkingsstaat&quot;van dropdown kon verdwijnen na het unsigning van een status, die het onmogelijk maakt om opnieuw toe te wijzen.
AC-15010
...
Probleem verholpen waarbij de velden voor het verzenden van een cadeaubericht en de geadresseerde automatisch werden gevuld met namen van klanten, zelfs als er geen cadeaubericht was ingevoerd. de velden blijven nu leeg tenzij de gebruiker de gegevens opgeeft.
...
Voorafgaand aan de moeilijke situatie produceerde de bundel of de samengevoegde dossiers werden niet toegevoegd aan de lijst van haasjes SRI. De bestanden worden nu correct toegevoegd aan de SRI-hashes.
...
#### &rbrack; Commerciële bestemming van de kwestie &lbrack; &lbrace;zou niet als woon moeten worden behandeld
...
#### AC-15210 lijkt niet volledig. USPS REST-API vereist in minder dan een maand.

De integratie van de USPS REST API in Adobe Commerce (AC-15210) was onvolledig. De belangrijkste problemen omvatten het ontbreken van het volgen van informatie, het verlies van Toegestane montages van Methoden wanneer het schakelen API types, bovenmatige verzoeken riskeren quotalimieten, en gebrek aan bescherming tegen &quot;429&quot;quotalimetfouten. Als de quota werd overschreden, konden geen verzendkosten aan klanten worden weergegeven.
De integratie met de USPS REST API is verbeterd op:
- Geef de juiste trackinggegevens op voor de verzonden pakketten.
- De instellingen voor toegestane methoden behouden bij het schakelen tussen WEBtools van USPS en REST API&#39;s.
- Voorkomen van onnodige verzoeken aan de USPS API, waardoor het risico van het bereiken van quotalimieten wordt beperkt.
- Verwerk &#39;429&#39;-quota&#39;s netjes om fouten te beperken, zodat de verzendkosten beschikbaar blijven voor klanten.

_AC-16577 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40394) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/15a9362d)_

#### Uitzondering tijdens maken van UPS-verzendlabel

Vaste waarschuwing: Conversie van array naar tekenreeks tijdens het maken van UPS-verzendlabel
...
#### Verzendmethode van de USPS Rest API wordt niet weergegeven bij de kassa voor bepaalde producten

Verzendmethoden van de USPS REST API zijn nu beschikbaar voor producten die worden afgehandeld.

_ACP2E-4556 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Probleem verholpen waarbij wijzigingen in de prijsregels voor catalogi via gefaseerde updates niet altijd in het winkelwagentje werden doorgevoerd. Na deze correctie worden de productprijzen in alle winkelsecties (centraal blok en samenvattingsblok) op de juiste wijze bijgewerkt wanneer een geplande prijsregelupdate wordt toegepast.

_AC-16530 - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/commit/57bad413)_
...
#### Probleem met de modus Voorvertoning van aanbieding waarbij gebruikte coupons kort na toepassing verdwijnen.

Voorafgaand aan de correctie konden vouchercodes niet correct worden gebruikt in de modus Voorvertoning afvlakken. Nadat de correctie is uitgevoerd, worden de vouchercodes nu op de juiste wijze toegepast op de pagina voor uitchecken.
...
#### Probleem met speciale prijsplanning

Voorafgaand aan de correctie werd de speciale prijs vanaf de datum niet correct opgeslagen wanneer een testupdate werd opgeslagen. Na deze correctie wordt de bijbehorende speciale prijs van en tot de datum gecorreleerd met de begin- en einddatum van de gefaseerde update.

_ACP2E-4433 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### [ Uitgave ] Repareren: De waarde base_weee_tax_applied_row_amnt is onjuist in de creditmemo-items
...
Magento werkt nu correct de totalen van de kartbelasting bij wanneer de cadeauverpakking wordt verwijderd via de setGiftOptionsOnCart GraphQL-mutatie. Eerder was een optie voor het verpakken van cadeautjes geselecteerd en werd deze vervolgens ongedaan gemaakt door &quot;giftWrappingId&quot; door te geven: null in de mutatie-input, werd het belastingbedrag in het citaat niet bijgewerkt en Magento bleef de cadeauverpakkingstaks in de karttotalen opnemen, ook al werd er geen cadeauverpakking toegepast.
...
De omzetting van de dynamische prijs van het bundelproduct zonder de belastingberekening voor citaatitem werkt correct.

_ACP2E-4411 - [&#x200B; de codebijdrage van GitHub &#x200B;](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [ Uitgave ] MFTF: E-mail verzenden naar vriendenformulier met ingeschakelde captcha
...
#### &rbrack; SwiftOtter-SOP-348 van de kwestie laat Gecompileerde het Geheime voorgeheugen van de Configuratie voor de uitvoering van de Test toe&lbrack;

Verbetert de prestaties van de integratietest door het compiled_config geheime voorgeheugen tijdens testuitvoering toe te laten, die het gebruik en de uitvoeringstijd van CPU verminderen.

_AC-16018 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/40253) - [&#x200B; GitHub codebijdrage &#x200B;](https://github.com/magento/magento2/pull/40239)_

#### &rbrack; CZS van de Bouwstijl van 0&rbrace; Cloud de Inheemse Dienst &lbrack; - 2.4.9-bèta1 - Integratie
...
#### PHPUnit Config-bestand komt niet overeen tussen PR en Composer Builds

Geen beschrijving beschikbaar.

_AC-16501_

#### &rbrack; magento/magento2# &lbrack; Uitgave: GraphQl-mutatie. Extra testdekking voor de montages storeConfig van de klant.
...
#### [ Test van de Eenheid ] Magento\GiftCardImportExport\Test\Unit\Model\Import\Product\Type\GiftCardTest::testIsRowValid

Correctie is verstrekt voor een test met willekeurige defecte eenheden
...
#### Verouderde functionaliteit: Creation of dynamic property Magento\Framework\Acl:$_roleRegistry
...
&quot;Verouderde functionaliteit: Creation of dynamic property Magento\Framework\Acl:$_roleRegistry is afgekeurd in vendor/magento/framework/Session/SessionManager.php op regel 186&quot;
Hierdoor konden beheerders zich niet aanmelden.
AC-12343

_AC-12343 - [&#x200B; GitHub kwestie &#x200B;](https://github.com/magento/magento2/issues/37469)_

#### GUID wordt niet opgeslagen als beveiligde indeling

Geen beschrijving beschikbaar.

_AC-15809_

#### Upgrade van compatibiliteitsprogramma met verkeerd kritiek probleem
