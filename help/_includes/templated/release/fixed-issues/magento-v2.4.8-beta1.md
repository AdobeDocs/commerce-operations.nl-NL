...
In de kerncode van Magento Open Source 2.4.8 zijn 221 problemen opgelost. Hieronder wordt een subset van de opgeloste problemen in deze release beschreven.
...
* _AC-9922_: De Fout van Googles Analytics CSP https://region1.analytics.google.com
   * _nota van de Reparatie_: Het systeem staat nu correct verbindingen aan &quot;https://region1.analytics.google.com&#39; toe wanneer de Googles Analytics worden toegelaten, verhinderend de fouten van het Beleid van de Veiligheid van de Inhoud (CSP). Voorheen zou het inschakelen van Googles Analytics en het bekijken van de website vanuit de EU leiden tot fouten in de CSP-console als gevolg van een weigering om verbinding te maken met &#39;https://region1.analytics.google.com&#39;.
...
* _AC-9712_: Verschil in minder compilatie tussen php &amp; nodejs bibliotheek (grot) met gecompliceerde `calc` uitdrukkingen
   * _nota van de Reparatie_: Recht het verschil in minder compilatie tussen php &amp; nodejs bibliotheek (grot)
...
* _AC-8358_: [ Uitgave ] verwijdert verboden `@author` markering
   * _nota van de Reparatie_: Het systeem volgt nu aan coderingsnormen door de verboden `@author` markering van bepaalde modules te verwijderen, verbeterend codekwaliteit en consistentie. Eerder was de aanwezigheid van dit label in bepaalde modules in strijd met de vastgestelde coderingsnormen.
   * _GitHub kwestie_: <https://github.com/magento/magento2/issues/37264>
   * _GitHub codebijdrage_: <https://github.com/magento/magento2/pull/37014>
* _AC-8360_: [ Uitgave ] verwijdert verboden `@author` markering
   * _nota van de Reparatie_: Het systeem volgt nu aan coderingsnormen door de verboden `@author` markering van bepaalde modules te verwijderen, die de algemene codekwaliteit verbeteren. Eerder was de aanwezigheid van dit label in bepaalde modules in strijd met de vastgestelde coderingsnormen.
   * _GitHub kwestie_: <https://github.com/magento/magento2/issues/37261>
   * _GitHub codebijdrage_: <https://github.com/magento/magento2/pull/37011>
* _AC-8361_: [ Uitgave ] verwijdert verboden `@author` markering
   * _nota van de Reparatie_: Het systeem houdt nu aan de coderingsnormen door de verboden `@author` markering van bepaalde modules te verwijderen, die schonere en meer gestandaardiseerde code verzekeren. Eerder was de aanwezigheid van dit label in bepaalde modules in strijd met de vastgestelde coderingsnormen.
   * _GitHub kwestie_: <https://github.com/magento/magento2/issues/37260>
   * _GitHub codebijdrage_: <https://github.com/magento/magento2/pull/37010>
* _AC-8400_: [ Uitgave ] verwijdert verboden `@author` markering
   * _nota van de Reparatie_: Het systeem houdt nu aan de coderingsnormen door de verboden `@author` markering van bepaalde modules te verwijderen, die de algemene codekwaliteit verbeteren. Eerder was de aanwezigheid van dit label in bepaalde modules in strijd met de vastgestelde coderingsnormen.
   * _GitHub kwestie_: <https://github.com/magento/magento2/issues/37254>
   * _GitHub codebijdrage_: <https://github.com/magento/magento2/pull/37004>
...
* _ACP2E-3002_: [ CLOUD ] kan verzenden geen E-mail van Admin UI onbruikbaar maken aangezien Dev Docs toont
   ...
   * _GitHub codebijdrage_: <https://github.com/magento/magento2/commit/c8931218>
* _AC-12462_: Kan middendouanestatus in admin veranderen gebruikend toevoegen commentaarvorm
   * _nota van de Reparatie_: Het systeem werkt nu correct de ordestatus aan &quot;Klaar voor Bestelwagen&quot;bij wanneer veranderd van &quot;voeg Commentaar&quot;vorm in het admin paneel toe, die nauwkeurige het volgen van ordevooruitgang verzekeren. Eerder bleef de status van de bestelling als &quot;Verzonden&quot;, zelfs na een poging om deze via het formulier &quot;Opmerking toevoegen&quot; te wijzigen in &quot;Gereed voor afhalen&quot;.
   * _GitHub kwestie_: <https://github.com/magento/magento2/issues/38917>
   * _GitHub codebijdrage_: <https://github.com/magento/magento2/pull/38923>
