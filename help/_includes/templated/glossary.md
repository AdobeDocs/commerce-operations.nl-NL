...
Wanneer het ontwerpen van uw lay-out, gebruik flexibele formaten om de producten met de hoogste prioriteit, eigenschappen, verkoop, berichten, opties, etc., op dit gebied het best te tonen.
...
Meer informatie: [Gebruikers toevoegen](https://experienceleague.adobe.com/docs/commerce-admin/systems/user-accounts/permissions-users-all.html)

_Term-kenmerken:_

* _Veld: handelssoftware_
* _Synoniemen: beheerder, supergebruiker_
* _Verwante termen: handelsbeheerder_
...
Meer informatie: [Adobe Commerce-gebruikershandleiding](https://experienceleague.adobe.com/docs/commerce-admin/user-guides/home.html)

_Term-kenmerken:_

* _Veld: handelssoftware_
* _Synoniemen: Beheer, deelvenster Beheer, back-end, beheerinterface, beheerinterface_
* _Verwante termen: beheerder_
...
Meer informatie: [ADMIN-variabelen](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/env/stage/variables-admin.html)

_Term-kenmerken:_

* _Veld: beheerder, cloud_
...
* _Veld: handelssoftware_
* _Verwante termen: gebied, handelsbeheerder_

### gebied

_zelfstandig_

Het gebied is een abstracte termijn voor een toepassingswerkingsgebied van Magento.
...
Adobe Commerce- of Magento Open Source-gebruikers kunnen aangepaste kenmerken maken om deze toe te voegen aan de standaardkenmerkset of aan een aangepaste kenmerkset.
...
* _Synoniemen: product, kenmerk, aangepast kenmerk_
* _Verwante termen: extension, kenmerk_
...
Meer informatie: [Valuta](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/site-store/currency/currency.html)

_Term-kenmerken:_

* _Veld: prijsstelling_
...
[Blokken](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/blocks/blocks.html) worden geïmplementeerd en door modules worden verstrekt.
...
[Dynamische blokken](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/dynamic-blocks/dynamic-blocks.html) inhoud bieden op basis van logica, zoals prijsregels.

Page Builder breidt de interactiviteit en het maken van [blokken](https://experienceleague.adobe.com/docs/commerce-admin/page-builder/add-content/block.html) en [dynamische blokken](https://experienceleague.adobe.com/docs/commerce-admin/page-builder/add-content/dynamic-block.html).

_Term-kenmerken:_

* _Veld: handelssoftware_
* _Synoniemen: Dynamische blokken_
* _Verwante termen: cms-blok, statisch blok, container, layout_

### merk

_zelfstandig naamwoord_

Een unieke identiteit die een bepaald product of een bepaalde groep producten door de fabrikant of Designer definieert.
...
Voor [Inventory management](https://experienceleague.adobe.com/docs/commerce-admin/inventory/sources/sources-manage.html) en [Orderbeheer](https://omsdocs.magento.com/getting-started/terminology/)Deze winkel is een bron voor het bijhouden van producthoeveelheden, verzendopdrachten en het ondersteunen van het ophalen in de winkel.

_Term-kenmerken:_

* _Veld: bedrijf, voorraad_
...
Meer informatie: [DevDocs Bulk-bewerkingen](https://developer.adobe.com/commerce/php/development/components/message-queues/bulk-operations/)
...
Meer informatie: [Configureerbare producten](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/types/product-create-configurable.html)

_Term-kenmerken:_

* _Veld: handelssoftware, product_
* _Verwante termen: eenvoudig product, virtueel product, producttypen_
...
* _Veld: gebundelde extensie, extensie_
* _Synoniemen: extension_
* _Verwante termen: extensie, gebundelde extensie van leverancier_
...
* _Veld: handelssoftware, prijzen, product_
* _Verwante termen: catalogusregels, winkelwagentje_
...
* _Veld: handelssoftware, prijzen, product_
* _Verwante termen: gedeelde catalogus, catalogusregel_
...
* _Veld: handelssoftware, prijzen, product_
* _Verwante termen: regels voor winkelwagentjes, catalogus_
...
Meer informatie: [Zelfstudie over uitchecken](https://developer.adobe.com/commerce/php/tutorials/frontend/custom-checkout/)

_Term-kenmerken:_

* _Veld: zaken, ontwerp, orde, product, programmering_

### wolkenvariabelen

_zelfstandig_

Wolkenvariabelen zijn omgevingsvariabelen die specifiek zijn voor Adobe Commerce op cloudinfrastructuur en gebruikmaken van de **`MAGENTO_CLOUD`** voorvoegsel.

Meer informatie: [Cloud-variabelen](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/env/stage/variables-cloud.html)
...
Een speciale variant van [blok](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/blocks/blocks.html) die alleen in de beheerfunctie kunnen worden gemaakt en waarnaar niet kan worden verwezen door lay-outbestanden.

_Term-kenmerken:_

* _Veld: handelssoftware_
* _Verwante termen: blok, statisch blok_
...
* _Verwante termen: ui-component_
...
_zelfstandig naamwoord, adjectief, werkwoord_
...
* _Veld: bedrijf, product_
* _Verwante termen: uploaden_

### CVM

_zelfstandig_

Een afkorting voor &quot;Kaarthouderverificatiemethode&quot;.
...
Meer informatie: [Beveiligde verbindingen](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/develop/secure-connections.html)
...
De achtergrondcode wordt op een server uitgevoerd.
...
Opmerking: In het verleden werd de storefront aangeduid als &quot;frontend&quot; en werd de Admin aangeduid als &quot;backend&quot;. Dit gebruik wordt niet meer ondersteund.

_Term-kenmerken:_

* _Veld: ontwerp, programmeren_
* _Synoniemen: clientzijde_
* _Verwante termen: back-end, winkel, cachefront_
...
Een producttype met verschillende soortgelijke, op zichzelf staande producten die op één pagina zijn gegroepeerd.
...
* _Veld: ontwerp, software voor handel_
* _Verwante termen: indelingsinstructies, blok_
...
* _Veld: ontwerp, programmeren_
* _Verwante termen: layout, blok, container, ui-component_
...
Meer informatie: [Uw verificatietoetsen ophalen](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/prerequisites/authentication-keys.html)
...
[De markering configureren](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/settings/settings-advanced-custom-options.html)of een afkorting van een product via aanpasbare opties.
...
* _Veld: bedrijf, programmeren_
* _Synoniemen: Markering_

### master omgeving

_zelfstandig_

In Adobe Commerce op cloudinfrastructuur gebruiken Pro-projecten een actief Platform als een Service-omgeving (PaaS) die master wordt genoemd en die een kopie bevat van de database van de productieomgeving en de webserver.
...
MFTF is een [Functioneel testkader](https://developer.adobe.com/commerce/testing/functional-testing-framework/).
...
* _Veld: handelssoftware, programmeren_
* _Verwante termen: cms-blok, statisch blok, container, layout_
...
Eén uitzondering: Wanneer de module van andere modules afhangt, die het onbruikbaar maken of het verwijderen van de afhankelijke modules vereist.

_Term-kenmerken:_

* _Veld: handelssoftware_
* _Verwante termen: php, xml, block_
...
[OMS](https://omsdocs.magento.com) is Adobe Management.
...
Meer informatie: [Aan de slag met OMS](https://omsdocs.magento.com/en/getting-started/), [OMS Docs-site](https://omsdocs.magento.com/en/)

_Term-kenmerken:_

* _Veld: functie, software voor handel, orderbeheer_
* _Synoniemen: orderbeheer, MOM, orderbeheersysteem, Magento Order Management_
* _Verwante termen: orderbeheer_
...
Meer informatie: [Camoufleren met een snelle oorsprong](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/faq/fastly-origin-cloaking-enablement-faq.html)
...
Meer informatie: [Gebruikershandleiding voor Page Builder](https://experienceleague.adobe.com/docs/commerce-admin/page-builder/introduction.html), [Page Builder DevDocs](https://developer.adobe.com/commerce/frontend-core/page-builder/)

_Term-kenmerken:_

* _Veld: handelssoftware, ontwerp_
* _Synoniemen: Beheer, deelvenster Beheer, back-end, beheerinterface, beheerinterface_
* _Verwante termen: beheerder_
...
* _Veld: handelssoftware, product_
* _Verwante termen: regels voor winkelwagentjes, catalogusregels_
...
Met de functie voor gedeelde catalogus heeft de handelaar:
...
* _Veld: handelssoftware, product_
* _Verwante termen: catalogus, b2b_
...
* _Veld: zaken, ontwerp, product, programmering_
* _Synoniemen: winkelwagentje_
* _Verwante termen: kartelregels_
...
* _Veld: zaken, prijzen, product, programmering_
* _Verwante termen: gedeelde catalogus_

### welkomstpagina

_zelfstandig_

een promotiepagina met een product of advertentie; worden normaal weergegeven vóór de startpagina.
...
* _Veld: handelssoftware_
* _Verwante termen: cms-blok, blok_
...
* _Veld: ontwerp_
* _Verwante termen: dynamische inhoud_
...
Het handelbereik van &quot;store&quot; is het tweede niveau in de hiërarchie van uw website, dat als volgt luidt: website > Opslag > Opslagweergave.
...
* _Veld: handelssoftware, product_
* _Verwante termen: winkelweergave, website_
...
Meer informatie: [UI Components Guide](https://developer.adobe.com/commerce/frontend-core/ui-components/), [Page Builder](https://experienceleague.adobe.com/docs/commerce-admin/page-builder/introduction.html)
...
[PWA Studio](https://github.com/magento/pwa-studio) gebruik [UPWARD](https://developer.adobe.com/commerce/pwa-studio/guides/packages/upward/) in ontwikkeling.
...
* _Veld: ontwerp, software voor handel, programmeren_
...
Meer informatie in het dialoogvenster [Onderwerp van gebundelde extensie van leverancier](https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/modules/upgrade.html).

_Term-kenmerken:_

* _Veld: commerciële uitbreiding, leverancier gebundelde uitbreiding, uitbreiding, VBE_
* _Synoniemen: extensie, VBE_
* _Verwante termen: extensie, gebundelde extensie_
...
Virtuele producten kunnen afzonderlijk worden verkocht of worden opgenomen als onderdeel van de volgende producttypen: gegroepeerd product en gebundeld product.
...
Er kan alleen naar virtuele typen worden verwezen door argumentoverschrijvingen in een `<type>` element in di.xml- dossiers, nooit in broncode.
...
A [widget](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/widgets/widgets.html) is een voorbereid codefragment dat kan worden gebruikt om blokken, verbindingen, en dynamische inhoud op specifieke plaatsen op opslagpagina&#39;s te plaatsen.
...
* _Veld: handel, software voor handel, ontwerp_
* _Verwante termen: blok_
