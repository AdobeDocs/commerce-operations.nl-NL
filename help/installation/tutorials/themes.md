...
description: Leer hoe u Adobe Commerce-thema's van de opdrachtregel kunt verwijderen, inclusief Composer-pakketten, codeverwijdering en back-ups voordat u wijzigingen aanbrengt.
...
Dit bevel maakt *slechts* thema&#39;s ongedaan die in `composer.json` worden gespecificeerd; met andere woorden, thema&#39;s die als Composer-pakketten worden aangeboden. Als uw thema geen Composer-pakket is, moet u de toepassing handmatig verwijderen door:
