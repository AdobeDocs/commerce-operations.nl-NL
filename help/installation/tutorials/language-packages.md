...
Dit bevel maakt *slechts* taalpakketten ongedaan die in `composer.json` worden gespecificeerd; met andere woorden taalpakketten die als Composer-pakketten worden aangeboden. Als uw taalpakket geen Composer-pakket is, moet u het handmatig verwijderen door de code van het taalpakket uit het bestandssysteem te verwijderen.
