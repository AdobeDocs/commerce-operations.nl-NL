...
>[!NOTE]
>
>Vanaf augustus 2022 moet de rekeninghouder een Adobe ID hebben en ervoor zorgen dat deze aan hun Commerce-rekening is gekoppeld. Als de rekeningseigenaar geen Adobe ID heeft, moeten zij één creëren en het verbinden met hun rekening van Commerce alvorens authentificatietoetsen te produceren: [ creeer en heb toegang tot uw rekening van Commerce ](https://experienceleague.adobe.com/en/docs/commerce-admin/start/commerce-account/commerce-account-create#create-a-commerce-account)
