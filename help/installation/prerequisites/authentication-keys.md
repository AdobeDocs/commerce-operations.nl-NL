...
>[!NOTE]
>
>Vanaf augustus 2022 moet de rekeninghouder een Adobe ID hebben en ervoor zorgen dat deze aan hun Commerce-rekening is gekoppeld. Als de accounteigenaar geen Adobe ID heeft, moet hij een maken en deze koppelen aan zijn Commerce-account voordat hij verificatietoetsen genereert: [ creeer en heb tot uw rekening van Commerce toegang ](https://experienceleague.adobe.com/en/docs/commerce-admin/start/commerce-account/commerce-account-create#create-a-commerce-account)
...
* U schakelt toetsen als volgt uit: Klik **onbruikbaar maken**. U kunt dit doen als u het gebruik van uw sleutels wilt onderbreken.
* Een eerder uitgeschakelde toets inschakelen: Klik **toelaten**.
* Toetsen verwijderen: Klik **Schrapping**.
