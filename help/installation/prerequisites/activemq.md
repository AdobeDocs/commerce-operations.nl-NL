...
>[!NOTE]
>
>ActiveMQ Artemis is geïntroduceerd in Adobe Commerce 2.4.5 en latere versies. Voor details bij het installeren van Artemis ActiveMQ in Adobe Commerce op de projecten van de wolkeninfrastructuur, zie &lbrace;de dienst ActiveMQ van de Opstelling [&#128279;](https://experienceleague.adobe.com/nl/docs/commerce-on-cloud/user-guide/configure/service/activemq) in *Commerce op de Gids van de Wolk*.
