...
|--- |--- |--- |--- |
| `remote-storage-driver` | chauffeur | De naam van de adapter <br> Mogelijke waarden:<br>**dossier**: Maakt verre opslag onbruikbaar en gebruikt het lokale filesystem <br>**ws-s3**: Gebruik de [&#x200B; Eenvoudige Dienst van de Opslag van Amazon (Amazon S3) &#x200B;](remote-storage-aws-s3.md) | none |
