---
title: Statische inhouds-ondertekening en validatie van browsercache
description: Leer hoe het ondertekenen van statische inhoud in Adobe Commerce werkt om browser geheim voorgeheugen voor statische middelen ongeldig te maken. Ontdek hoe u deze functie kunt inschakelen en configureren.
...
# Statische ondertekening van inhoud en invalidatie van browsercache
...
- **slechts op-gebouw**: Deze configuratie is beschikbaar als uw plaats **niet** op [&#x200B; wijze van de Productie &#x200B;](../bootstrap/application-modes.md#production-mode) is.
