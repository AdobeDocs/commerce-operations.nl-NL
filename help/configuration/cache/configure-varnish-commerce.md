...
# Varnish configureren voor Commerce
...
1. Vouw **[!UICONTROL Varnish Configuration]** uit en voer de volgende informatie in:
   ...
   | Backend-host | Ga volledig in - gekwalificeerde hostname of IP adres en luister haven van de Varnish _achterkant_ of _oorsprongserver_; Dat wil zeggen dat de server die de inhoud levert, Varnish versnelt. Dit is doorgaans uw webserver. Zie ](https://www.varnish-cache.org/docs/trunk/users-guide/vcl-backends.html) servers van de het geheime voorgeheugensteun van 0} Varnish.[ |
