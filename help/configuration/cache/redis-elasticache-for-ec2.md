...
- **verifieer de verbinding aan uw instantie van EC2 Commerce**
   ...
   - Voeg een binnenkomende regel aan de EC2 veiligheidsgroep toe: Tekst `- Custom TCP, port - 6379, Source - 0.0.0.0/0`
   - Voeg een binnenkomende regel aan de ElastiCache de veiligheidsgroep van de Cluster toe: Tekst `- Custom TCP, port - 6379, Source - 0.0.0.0/0`
