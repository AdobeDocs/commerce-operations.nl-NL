...
>[!NOTE]
> Handelaren van Adobe Commerce die Live Search, Catalog Service of Product Recommendations gebruiken, hebben de mogelijkheid om [Prijsindexering op basis van SaaS](https://experienceleague.adobe.com/docs/commerce-merchant-services/price-index/index.html).
