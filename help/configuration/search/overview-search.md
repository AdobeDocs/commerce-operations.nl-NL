...
description: Leer meer over zoeken naar catalogi, voorwaarden, webserverinstellingen en onderhoudstaken die u na de installatie kunt uitvoeren in Elasticsearch en OpenSearch for Adobe Commerce.
...
Vanaf versie 2.4.4, vereist Adobe Commerce of [ Elasticsearch ](https://www.elastic.co) of [ OpenSearch ](https://opensearch.org/docs/latest/opensearch/install/index/) om de motor van het catalogusonderzoek te zijn. Voor eerdere versies van 2.4.x was Elasticsearch vereist. Raadpleeg de volgende onderwerpen voor meer informatie over het installeren van een zoekmachine en de initiële configuratie:
