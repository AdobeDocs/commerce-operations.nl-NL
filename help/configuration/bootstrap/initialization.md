...
Om de toepassing van Commerce in werking te stellen, worden de volgende acties uitgevoerd in [ pub/index.php ](https://github.com/magento/magento2/tree/2.4.8/pub/index.php):

- Omvat het [ app/bootstrap.php ](https://github.com/magento/magento2/blob/2.4.8/app/bootstrap.php) dossier voor de versie van Commerce die aan uw milieu wordt opgesteld. Dit bestand voert essentiële initialisatieroutines uit, zoals foutafhandeling, het initialiseren van de autoloader, het instellen van opties voor het instellen van profielen en het instellen van de standaardtijdzone.
- Creeer een geval van [ \Magento\Framework\App\Bootstrap.php ](https://github.com/magento/magento2/tree/2.4.8/lib/internal/Magento/Framework/App/Bootstrap.php) <!-- It requires initialization parameters to be specified in constructor. Normally, the $_SERVER super-global variable is supposed to be passed there. -->
- Creeer een de toepassingsinstantie van Commerce: [ \Magento\Framework\AppInterface](https://github.com/magento/magento2/tree/2.4.8/lib/internal/Magento/Framework/AppInterface.php)
- Commerce uitvoeren

## Bootstrap-logica

[ het bootstrap voorwerp ](https://github.com/magento/magento2/tree/2.4.8/app/bootstrap.php) gebruikt het volgende algoritme om de toepassing van Commerce in werking te stellen:

1. Initialiseert de fouthandler.
1. Creeert de [ objecten manager ](https://github.com/magento/magento2/tree/2.4.8/lib/internal/Magento/Framework/ObjectManager) en de basis gedeelde diensten die overal worden gebruikt en door het milieu worden beïnvloed. De omgevingsparameters worden op de juiste wijze in deze objecten geïnjecteerd.
...
[ \Magento\Framework\App\Http ](https://github.com/magento/magento2/tree/2.4.8/lib/internal/Magento/Framework/App/Http) werkt als volgt:
...
[ \Magento\Framework\App\StaticResource ](https://github.com/magento/magento2/tree/2.4.8/lib/internal/Magento/Framework/App/StaticResource.php) is een toepassing voor het terugwinnen van statische middelen (bijvoorbeeld, CSS, JavaScript, en beelden). Het stelt om het even welke acties met een statische middel uit tot het middel wordt gevraagd.
...
[ Magento\MediaStorage\App\Media ](https://github.com/magento/magento2/tree/2.4.8/app/code/Magento/MediaStorage/App/Media.php) wint media middelen (namelijk om het even welke dossiers terug die aan media opslag) van het gegevensbestand worden geupload. Het wordt gebruikt wanneer het gegevensbestand als media opslag wordt gevormd.
