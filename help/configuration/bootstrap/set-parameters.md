...
De volgende procedures tonen hoe u de toepassingsmodus instelt in een virtuele Apache-host. Dit is niet de enige manier om `mod_env` instructies te gebruiken; Raadpleeg de documentatie bij Apache voor meer informatie.
