...
* 70% Slack-kennisgeving aan het DevOps-kanaal
* 80% Melden het Slack room DevOps kanaal en een lijst van de e-maildistributie van DevOps teamgenoten
* 90% Slack DevOps kanaal- en productieondersteuning Slack-kanaal, distributiegroep voor e-mail DevOps en de engineeringmanager op de hoogte stellen
* 95% Slack DevOps en Slack kanalen voor productieondersteuning op de hoogte stellen, lijst met e-maildistributies van alle technici en Director van engineering
* 98% waarschuwt om het even welke kanalen van P1 Slack en DevOps en de kanalen van de productiesteun Slack, de lijst van de e-maildistributie van ingenieurs en Director van techniek en VP van technologie
...
Er zijn vaak goede sjablonen die u kunt volgen voor de meeste gereedschappen, zoals New Relic, DataDog en Dynatrace. Neem de tijd om goede ideeën te vinden die het meest zinvol zijn voor uw toepassing. Met Adobe Commerce op cloudinfrastructuur zijn er waarschuwingen en triggers beschikbaar wanneer het project wordt ingericht. Dit machtigt het de productiesupport van Adobe om hun hulpmiddelen voor uptime en hoge beschikbaarheidscontrole toe te passen.
...
Een ander belangrijk onderdeel voor logbestanden is ervoor te zorgen dat rotatie plaatsvindt. Dit heeft historisch gezien betrekking op `run-away logs` die uw vaste schijf per ongeluk kunnen vullen en de site naar beneden kunnen laten gaan. Een versie van logboekomwenteling kan voorkomen wanneer een logboekdossier een bepaalde grootte, zoals 1 GB bereikt. Er zijn gereedschappen op serverniveau, zoals `logrotate` die ze automatisch kunnen verwijderen. Bijvoorbeeld, kan het bovenmatig grote logboekdossiers verwijderen zodra zij groter dan 1 GB worden of logboekdossiers ouder dan 90 dagen verwijderen. U bepaalt een logboekbeleid, zodat is het belangrijk om uw middelbeperkingen te begrijpen.
