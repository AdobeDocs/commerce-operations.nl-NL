...
Adobe beschouwt de volgende aanbevelingen als van de hoogste prioriteit voor alle klanten. Voer deze belangrijkste veiligheids beste praktijken in alle plaatsingen van de Handel uit:
...
- [Veiligheid voor Admin van de Handel](https://experienceleague.adobe.com/docs/commerce-admin/systems/security/2fa/security-two-factor-authentication.html)
...
Uw code laten bijwerken door [upgrade uitvoeren van je Commerce-project naar de nieuwste versie](#upgrade-to-the-latest-release) van Adobe Commerce, Commerce Services en extensies, waaronder beveiligingspatches, hotfixes en andere patches die door Adobe worden geleverd.
...
![Checklist](/help/assets/icons/Smock_CheckmarkCircleOutline_18_N.svg) **Beveiligde extensies gebruiken**—Identificeer de meest aangewezen en veilige uitbreidingen voor de plaatsingen van de Handel door met uw oplossingsintegrator of ontwikkelaar en het volgende te raadplegen [Aanbevolen werkwijzen voor extensies voor Adoben](../planning/extensions.md).
...
- Controleer indien mogelijk de uitbreidingscode voor de beveiliging voordat u deze integreert met de toepassing Commerce.
...
De handel geeft typisch veiligheidsupdates op een driemaandelijkse basis vrij maar behoudt het recht om hotfixes voor belangrijke veiligheidsbedreigingen vrij te geven die op prioriteit en andere factoren worden gebaseerd.
...
Als uw plaats van de Handel wordt gecompromitteerd, controleer schade en herstel normale bedrijfsverrichtingen snel door een uitvoerig rampenherstelplan te ontwikkelen en uit te voeren.

Als een klant een instantie van de Handel als gevolg van een ramp moet herstellen, kan de Adobe de klant van reservedossiers voorzien. De klant en de oplossingenintegrator, indien van toepassing, kunnen herstellen.
...
![Checklist](/help/assets/icons/Smock_CheckmarkCircleOutline_18_N.svg) **Onbevoegde toegang blokkeren**—Werk met uw het ontvangen partner aan opstelling een tunnel van VPN om onbevoegde toegang tot de plaats van de Handel en klantengegevens te blokkeren. Opstelling een tunnel SSH om onbevoegde toegang tot de toepassing van de Handel te blokkeren.
...
Hieronder volgt een lijst van gemeenschappelijke categorieën van aanvallen die de Adobe alle klanten van de Handel adviseert om zich van bewust te zijn en maatregelen te nemen tegen:
...
- **Botnets**—De server van de Handel van de klant wordt deel van een botnet die spam e-mail verzendt. Hoewel gebruikersgegevens typisch niet gecompromitteerd zijn, zou de het domeinnaam van de klant door spamfilters kunnen worden gevoegd op lijst van gewenste personen, verhinderend levering van om het even welke e-mail van het domein. Alternatief, wordt de plaats van de klant deel van een botnet die een verdeelde ontkenning van de dienst (DDoS) aanval op een andere plaats/s veroorzaakt. Botnet kan binnenkomend IP verkeer aan de server van de Handel blokkeren, verhinderend klanten om te kunnen winkelen.
...
- Identificeer en bescherm alle punten waar de installatie van de Handel van de buitenwereld kan worden betreden.

  U kunt toegang tot Admin, die over het algemeen de meeste bescherming vereist, beveiligen door de Adobe te volgen [prioritaire aanbevelingen](#priority-recommendations) wanneer het vormen van uw project van de Handel.

- De toegang van de controle tot de plaats van de Handel door vestiging een toegangsbeheerlijst die slechts toegang tot gebruikers toestaat die uit een gespecificeerd IP adres of netwerk komen.
  ...
  >[!TIP]
  >
  >Als u een ver aantal arbeidskrachten in dienst neemt, zorg ervoor dat de IP adressen van verre werknemers in de lijst van adressen met toestemming om tot de plaats van de Handel toegang te hebben inbegrepen zijn.
