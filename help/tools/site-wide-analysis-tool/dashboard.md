...
* **[!UICONTROL Extensions]**: geeft de extensies weer die momenteel op uw Adobe Commerce-instantie zijn geïnstalleerd. [ de informatie van de Marketplace van 0} Adobe Commerce {wordt verstrekt, waar beschikbaar, voor uitbreidingen die daar worden vermeld.](https://commercemarketplace.adobe.com//extensions.html)
