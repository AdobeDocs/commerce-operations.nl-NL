...
description: Met de MDVA-42341-patch wordt het probleem opgelost waarbij de GraphQL-query 'categoryList' niet wordt gefilterd als een aanvraag de Winkelheader heeft. Deze patch is beschikbaar wanneer [Quality Patches Tool (QPT)] (https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.8 is geïnstalleerd. De patch-id is MDVA-42341. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.4.
