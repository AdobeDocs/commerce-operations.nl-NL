---
title: 'ACSD-6631: Het raster van bedrijven laadt langzaam voor beperkte admin gebruikers'
...
# ACSD-6631: Het raster van bedrijven laadt langzaam voor beperkte admin gebruikers
...
1. Maak de gebruikersrol **[!UICONTROL Admins in Scope]** :
   * Toepassingsgebied: slechts twee opslagplaatsen: *Belangrijkste Website* + *Website 3/Opslag 3*.
   * Bronnen: slechts *dashboard* + *Bedrijven*.
