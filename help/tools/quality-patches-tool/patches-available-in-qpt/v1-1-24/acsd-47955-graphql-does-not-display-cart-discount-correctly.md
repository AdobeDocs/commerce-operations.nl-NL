...
De ACSD-47955-patch verhelpt het probleem dat GraphQL de kaartkorting niet correct weergeeft. Deze patch is beschikbaar wanneer [[!DNL Quality Patches Tool (QPT)] ](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.24 wordt geïnstalleerd. De patch-id is ACSD-47955. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.6.
