...
description: De ACSD-46404-patch lost het probleem op waarbij een beheerder zich niet kan aanmelden na een upgrade naar 2.4.4. Deze patch is beschikbaar wanneer [Quality Patches Tool (QPT)] (https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.19 is geïnstalleerd. De patch-id is ACSD-46404. De kwestie is opgelost in Adobe Commerce 2.4.5.
