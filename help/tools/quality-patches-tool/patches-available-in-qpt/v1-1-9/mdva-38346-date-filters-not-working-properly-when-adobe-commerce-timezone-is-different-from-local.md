...
description: Met de MDVA-38346-patch wordt het probleem opgelost waarbij datumfilters niet goed werken wanneer de tijdzone van Adobe Commerce afwijkt van de tijdzone van de lokale omgeving. Deze patch is beschikbaar wanneer [Quality Patches Tool (QPT)] (https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.9 is geïnstalleerd. De patch-id is MDVA-38346. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.4.
