---
title: 'ACSD-67424: De waarde ''updated_at'' in de REST API-reactie ''GET /carts/search&grave; komt niet overeen met de waarde in [!UICONTROL Admin Panel] voor [!UICONTROL Negotiable Quotes]'
...
# ACSD-67424: `updated_at` -waarde in `GET /carts/search` REST API-reactie komt niet overeen met de waarde in [!UICONTROL Admin Panel] for [!UICONTROL Negotiable Quotes]
