...
De ACSD-49513-patch verhelpt het probleem waarbij de synchronisatie van de externe opslag mislukt als gevolg van bestanden van 0 byte. Deze patch is beschikbaar wanneer [[!DNL Quality Patches Tool (QPT)] ](https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.30 wordt geïnstalleerd. De patch-id is ACSD-49513. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.7.
