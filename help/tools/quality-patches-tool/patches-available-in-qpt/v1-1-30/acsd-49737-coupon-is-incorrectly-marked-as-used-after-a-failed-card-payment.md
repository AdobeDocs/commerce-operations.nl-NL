...
1. Zorg ervoor de {[** consument 0} sales.rule.update.coupon.usage opstelling en lopend is.](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/message-queues/consumers.html)
