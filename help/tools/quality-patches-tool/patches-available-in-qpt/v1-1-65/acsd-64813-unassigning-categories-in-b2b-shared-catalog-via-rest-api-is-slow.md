---
title: 'ACSD-64813: Het ontkoppelen van categorieën in  [!DNL B2B]  gedeelde catalogus via REST API is langzaam'
...
# ACSD-64813: De toewijzing van categorieën in [!DNL B2B] gedeelde catalogus via REST API verloopt traag
