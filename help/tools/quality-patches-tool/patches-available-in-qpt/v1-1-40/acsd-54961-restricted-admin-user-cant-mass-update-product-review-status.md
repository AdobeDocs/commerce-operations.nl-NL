---
title: 'ACSD-54961: Gebruikers met beperkte beheerdersrechten kunnen geen massale update uitvoeren [!UICONTROL Product Review status]'
...
# ACSD-54961: Gebruikers met beperkte beheerdersrechten kunnen geen massale update uitvoeren [!UICONTROL Product Review status]
...
De instructie `var/log/exception.log` bevat een vergelijkbare fout:
