...
description: De patch MDVA-39546 verhelpt het probleem waarbij de begindatum voor de Staging Update kan worden ingesteld op een eerdere datum dan de huidige datum. Deze patch is beschikbaar wanneer [Quality Patches Tool (QPT)] (https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.12 is geïnstalleerd. De patch-id is MDVA-39546. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
feature: Staging
role: Admin
