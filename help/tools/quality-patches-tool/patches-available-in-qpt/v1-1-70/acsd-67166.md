---
title: 'ACSD-6716: Dubbele uitvoering van de query ''catalogvoorraad_stock_status'' bij het laden van een aanhalingsteken in de winkel'
...
# ACSD-6716: Uitvoering van de query `cataloginventory_stock_status` dupliceren bij het laden van een aanhalingsteken in de winkel
...
1. Ga naar de pagina met winkelwagentjes: `/checkout/cart/`
