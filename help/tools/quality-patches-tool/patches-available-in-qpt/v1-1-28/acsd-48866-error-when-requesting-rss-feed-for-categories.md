...
De ACSD-48866-patch verhelpt het probleem waarbij een fout optreedt bij het aanvragen van een RSS-feed voor categorieën. Deze patch is beschikbaar wanneer [[!DNL Quality Patches Tool (QPT)] ](https://experienceleague.adobe.com/nl/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.28 wordt geïnstalleerd. De patch-id is ACSD-48866. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.7.
