...
description: Met de MDVA-40816-patch wordt het probleem opgelost waarbij geen inventarisinformatie wordt weergegeven op het productraster als een product-SKU speciale tekens bevat. Deze patch is beschikbaar wanneer [Quality Patches Tool (QPT)] (https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.10 is geïnstalleerd. De patch-id is MDVA-40816. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
