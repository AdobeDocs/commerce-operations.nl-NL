...
1. **ACSD-67171**: Oplossing de kwestie waar [!DNL B2B] de gebruikers een Toegang ontkende pagina zien wanneer hun zitting verliep of tijdens controle werd verwijderd.
...
1. **ACSD-68391**: Op categorie betrekking hebbende toestemmingen niet toegepast in **[!UICONTROL Quick Order]** en **[!UICONTROL Requisition Lists]**.
1. **ACSD-68400**: De virtuele grootheid van de giftekaart weerspiegelt niet nauwkeurig in **[!UICONTROL Inventory reservation table]**.
