...
De ACSD-58054-patch verhelpt het probleem waarbij het mogelijk is om klanttokens voor inactieve klanten te genereren via de API. Deze patch is beschikbaar wanneer [[!DNL Quality Patches Tool (QPT)] ](https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.49 wordt geïnstalleerd. De patch-id is ACSD-58054. De kwestie zal volgens de planning in B2B 1.5.1 worden opgelost.
