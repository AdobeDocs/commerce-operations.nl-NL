...
description: De MDVA-42237-patch verhelpt het probleem waarbij de speciale prijs van het configureerbare product niet wordt bijgewerkt na wijzigingen in de prijs van het subproduct. Deze patch is beschikbaar wanneer [Quality Patches Tool (QPT)] (https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.11 is geïnstalleerd. De patch-id is MDVA-42237. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
...
De MDVA-42237-patch verhelpt het probleem waarbij de speciale prijs van het configureerbare product niet wordt bijgewerkt na wijzigingen in de prijs van het subproduct. Dit flard is beschikbaar wanneer het [ Hulpmiddel van de Patches van de Kwaliteit (QPT) ](https://experienceleague.adobe.com/nl/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.11 geïnstalleerd is. De patch-id is MDVA-42237. Het probleem wordt volgens de planning opgelost in Adobe Commerce 2.4.5.
