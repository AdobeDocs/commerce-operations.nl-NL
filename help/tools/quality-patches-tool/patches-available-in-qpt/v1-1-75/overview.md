---
title: 'Overzicht: [!DNL Quality Patches Tool]  (QPT) v1.1.75'
description: Deze subsectie verstrekt een gedetailleerde beschrijving van de kwesties die door de flarden beschikbaar in  [!DNL Quality Patches Tool]  (QPT) v1.1.75 worden opgelost.
...
# Overzicht: [!DNL Quality Patches Tool] (QPT) v1.1.75

Deze subsectie bevat een gedetailleerde beschrijving van de problemen die zijn opgelost door de patches die beschikbaar zijn in [!DNL Quality Patches Tool] (QPT) v1.1.75.
...
1. **ACSD-68490**: Verhelpt de kwestie waar de **[!UICONTROL Add New Attribute]** knoop voor een beperkte admin gebruiker tijdens configureerbare productverwezenlijking zichtbaar is.
