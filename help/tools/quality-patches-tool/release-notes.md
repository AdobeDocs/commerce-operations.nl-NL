...
* **ACSD-56023** (voor Adobe Commerce en Magento Open Source >=2.4.2 &lt;2.4.7) - lost de kwestie op waar de widgetinhoud niet op de CMS pagina bijwerkt wanneer het geheime voorgeheugen wordt toegelaten.
...
* **ACSD-53925** (voor Adobe Commerce en Magento Open Source >=2.4.2 &lt;2.4.7) - lost de kwestie op waar admin het blok CMS met productcarrousel niet kan bewaren wanneer `catalog_product_price` afmetingen-wijze aan *website* wordt geplaatst.
...
* **ACSD-51120** (voor Adobe Commerce >=2.3.7 &lt;2.4.3) - lost de kwestie op waar de de verzoekgeheime voorgeheugen van de GET van GraphQL niet voor CMS pagina&#39;s wordt ontruimd die CMS blokken bevatten die via een het opvoeren update worden bijgewerkt.
...
* **MDVA-40619** (*voor Adobe Commerce en Magento Open Source >=2.3.0 &lt;2.4.4*) - lost de kwestie op waar de veranderingen in CMS paginahiërarchie een fout 500 veroorzaken wanneer het proberen om gealigneerde het uitgeven op een CMS pagina te doen.
...
* **mDVA-33606** (*voor Adobe Commerce en Magento Open Source >=2.4.1 &lt;=2.4.2-p2*) - lost de kwestie op waar de gebruikers a *Unieke fout van de beperkingsschending* wanneer het opslaan van een CMS pagina die aan een hiërarchie wordt toegewezen krijgen.
...
* **MDVA-39043** (*voor Adobe Commerce en Magento Open Source >=2.3.4 &lt;=2.4.3*) - lost de kwestie op waar de admin gebruiker met beperkte toegang een fout krijgt wanneer het proberen om *Producten* widget aan de CMS pagina toe te voegen.
...
* **mDVA-38468** (*voor Adobe Commerce >=2.3.2 &lt;=2.3.5-p2*) - lost de fout op wanneer het bewaren van CMS pagina&#39;s: *Punt met zelfde identiteitskaart PAGE_ID bestaat reeds*.
