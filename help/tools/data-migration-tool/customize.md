...
Soms is het gegevensformaat en de structuur die door [&#x200B; wordt gecreeerd uitbreidingen &#x200B;](https://commercemarketplace.adobe.com//extensions.html) of douanecode verschillend tussen Magento 1 en Magento 2. Gebruik extensiepunten in de [!DNL Data Migration Tool] om deze gegevens te migreren. Als de gegevensindeling en -structuur hetzelfde zijn, kunnen de gegevens automatisch worden gemigreerd zonder tussenkomst van de gebruiker.
