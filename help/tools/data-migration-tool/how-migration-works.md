...
1. **Wijze van Gegevens**: migreert database-elementen bulksgewijs.
...
1. **Controle van de Integriteit**: Vergelijkt de namen, typen en andere informatie van de lijstgebieden om verenigbaarheid tussen Magento 1 en 2 gegevensstructuren te verifiëren.
1. **Overdracht van Gegevens**: Brengt de gegevenstabel door lijst van Magento 1 en 2 over.
...
Magento 2-migratie bestaat uit vier onderdelen: gegevens, extensies en aangepaste code, thema&#39;s en aanpassingen.
...
Nochtans, verbeteren wij constant [!DNL Data Migration Tool] (zie [&#x200B; Changelog &#x200B;](https://github.com/magento/data-migration-tool/blob/2.3/CHANGELOG.md) voor meer details); de inspanningen op het gebied van migratie nemen dus voortdurend af .
