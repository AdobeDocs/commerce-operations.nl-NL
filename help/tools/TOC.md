...
- Gereedschap Kwaliteitspatches {#quality-patches-tool}
   ...
   - Patches beschikbaar in het gereedschap Kwaliteitspatches {#patches-available-in-qpt}
      ...
      - v1.1.73 {#v1-1-73}
         ...
         - [ACSD-68190: kortingen zijn niet van toepassing, toegepaste kortingen worden niet correct weergegeven in de GraphQL-respons in de cartweergave en kortingen zonder coupon worden verwijderd wanneer een couponkorting wordt verwijderd](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68190.md)
         ...
         - [ACSD-68400: het aantal virtuele cadeaukaarten is niet correct weergegeven in de boekingstabel voor de inventaris](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68400.md)
