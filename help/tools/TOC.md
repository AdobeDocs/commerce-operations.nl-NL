...
user-guide-description: Leer meer over de verschillende tools die je met Adobe Commerce kunt gebruiken, hun gebruik, het installatieproces en hoe je toegang krijgt.
...
- Site-brede analyse {#site-wide-analysis-tool}
   ...
   - [Toegang krijgen tot](site-wide-analysis-tool/access.md)
...
- Gereedschap Kwaliteitspatches {#quality-patches-tool}
   ...
   - Patches beschikbaar in het gereedschap Kwaliteitspatches {#patches-available-in-qpt}
      ...
      - v1.1.0 {#v1-1-0}
         ...
         - [MDVA-38827: Klanten ontvangen per e-mail een bestelfout](quality-patches-tool/patches-available-in-qpt/v1-1-0/mdva-38827-customers-receive-an-order-shipment-email-containing-an-error-message.md)
      - v1.1.1 {#v1-1-1}
      ...
      - v1.1.4 {#v1-1-4}
         ...
         - [MC-42528: GrafiekQL-query van categorieLijst toont alle categorieën](quality-patches-tool/patches-available-in-qpt/v1-1-4/mc-42528-graphql-query-of-categorylist-shows-all-categories.md)
         ...
         - [MDVA-26005: Kan geen categorie in boomstructuur selecteren voor de voorwaarden voor de regel voor winkelprijzen](quality-patches-tool/patches-available-in-qpt/v1-1-4/mdva-26005-unable-to-select-category-in-tree-for-cart-price-rule-conditions.md)
         ...
         - [MDVA-39482: Het product is niet meer in voorraad als het wordt geïmporteerd met een hoeveelheid &#39;0&#39; en een backorder is ingeschakeld](quality-patches-tool/patches-available-in-qpt/v1-1-4/mdva-39482-product-goes-out-of-stock-when-imported-with-0-quantity.md)
         - [MDVA-40101: Items blijven mini-cart na bestelling plaatsen PayPal Express Checkout](quality-patches-tool/patches-available-in-qpt/v1-1-4/mdva-40101-items-remain-in-mini-cart-after-order-placement-using-paypal-express-checkout.md)
         ...
         - [MDVA-40401: de waarde van het coupongebruik verandert na mislukte bestelling](quality-patches-tool/patches-available-in-qpt/v1-1-4/mdva-40401-coupon-usage-value-changes-even-after-failed-order.md)
         - [MDVA-40435: korting op bundelproduct wordt niet correct toegepast via GraphQL](quality-patches-tool/patches-available-in-qpt/v1-1-4/mdva-40435-discount-on-bundle-product-is-not-applied-correctly-via-graphql.md)
      ...
      - v1.1.5 {#v1-1-5}
         - [Overzicht: Quality Patches Tool (QPT) v1.1.5](quality-patches-tool/patches-available-in-qpt/v1-1-5/overview.md)
         - [MDVA-31763: De regels van de catalogusprijs worden teruggezet totdat ze handmatig opnieuw worden geïndexeerd](quality-patches-tool/patches-available-in-qpt/v1-1-5/mdva-31763-catalog-price-rules-are-reverted-until-manual-reindex.md)
      ...
      - v1.1.6 {#v1-1-6}
         ...
         - [MDVA-27456: Gebruikers krijgen een fout tijdens het laden van Swagger](quality-patches-tool/patches-available-in-qpt/v1-1-6/mdva-27456-users-get-error-when-loading-swagger.md)
         ...
         - [MDVA-32776: Stock status niet bijgewerkt met order placement](quality-patches-tool/patches-available-in-qpt/v1-1-6/mdva-32776-stock-status-not-updated-when-order-placed.md)
         - [MDVA-39031: Niet-toegewezen producten toevoegen aan winkelwagentje mogelijk via GraphQL](quality-patches-tool/patches-available-in-qpt/v1-1-6/mdva-39031-adding-unassigned-products-to-cart-possible-via-graphql.md)
      ...
      - v1.1.8 {#v1-1-8}
         ...
         - [MDVA-38393: Catalogusregels werken niet meer voor configureerbare producten als het eenvoudige product een nieuwe naam krijgt](quality-patches-tool/patches-available-in-qpt/v1-1-8/mdva-38393-catalog-rules-stop-working-for-configurable-product-if-its-simple-product-is-renamed.md)
      ...
      - v1.1.10 {#v1-1-10}
         ...
         - [MDVA-38728: als u de zichtbaarheid van het product wijzigt, wordt de URL herschreven voor de hoofdwebsite](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-38728-changing-product-visibility-creates-url-rewrite-for-the-main-website.md)
         - [MDVA-39181: Verwante productregels tonen producten van categorie niet gedefinieerd in regel](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-39181-related-product-rules-show-products-from-category-not-defined-in-rule.md)
         - [MDVA-40175: Keuzerondjes worden niet weergegeven bij opnieuw ordenen](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-40175-radio-buttons-not-displayed-when-reorder-by-admin.md)
         - [MDVA-40816: Voorraadgegevens niet weergegeven op het productraster](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-40816-inventory-info-doesnt-show-on-product-grid.md)
         - [MDVA-41305: Fout bij GraphQL Query addProductsToWishlist voor Configurable Products](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-41305-error-on-graphql-query-addproductstowishlist.md)
         - [MDVA-42584: Stock status of configureerbare product not updated automatically](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-42584-stock-status-of-configurable-product-not-updated-automatically.md)
         - [MDVA-42768: GraphQL toont verkeerde prijs wanneer onderliggende producten niet op voorraad zijn](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-42768-graphql-shows-wrong-price-when-child-products-are-out-of-stock.md)
         - [MDVA-43091: kan geen gebundeld product bestellen bij de beheerder](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-43091-unable-to-order-bundled-product-from-admin.md)
         - [MDVA-43201: Fout bij het gebruik van een DOB-veld met landinstelling PT](quality-patches-tool/patches-available-in-qpt/v1-1-10/mdva-43201-error-when-using-dob-field-with-locale-pt.md)
      - Versie 1.1.11 {#v1-1-11}
         - [Overzicht: Het gereedschap Kwaliteitspatches (QPT) v1.1.11](quality-patches-tool/patches-available-in-qpt/v1-1-11/overview.md)
         ...
         - [MDVA-41350: uitzondering wanneer de beheerder producten toevoegt buiten hun toegang](quality-patches-tool/patches-available-in-qpt/v1-1-11/mdva-41350-exception-when-admin-adds-products-outside-scope.md)
         - [MDVA-42237: Configureerbare product speciale prijs niet bijgewerkt](quality-patches-tool/patches-available-in-qpt/v1-1-11/mdva-42237-configurable-product-special-price-not-updated.md)
      ...
      - v1.1.13 {#v1-1-13}
         ...
         - [MDVA-42969: Verwante productregel werkt alleen wanneer het klantsegment op alle](quality-patches-tool/patches-available-in-qpt/v1-1-13/mdva-42969-related-product-rule-only-works-when-customer-segment-set-to-all.md)
      ...
      - v1.1.15 {#v1-1-15}
         ...
         - [MDVA-38559: /V1/customers/search-API retourneert fout](quality-patches-tool/patches-available-in-qpt/v1-1-15/mdva-38559-v1-customers-search-api-error.md)
         ...
         - [MDVA-40961: Er kan geen extra item aan winkelwagentje worden toegevoegd als er al een minimumhoeveelheid item in het winkelwagentje staat](quality-patches-tool/patches-available-in-qpt/v1-1-15/mdva-40961-additional-item-cant-be-added-to-cart-when-minimum-qty-of-the-item-already-in-cart.md)
         - [MDVA-43718: &#39;Consumenten zijn niet gemachtigd om toegang te krijgen tot bronnen&#39;-fout verschijnt bij het openen van een gedeelde catalogus](quality-patches-tool/patches-available-in-qpt/v1-1-15/mdva-43718-not-authorized-to-access-resources-error-appears-when-accessing-shared-catalog.md)
         - [MDVA-44533: Korting wordt onjuist toegepast op gebundeld onderliggende product](quality-patches-tool/patches-available-in-qpt/v1-1-15/mdva-44533-discount-incorrectly-applied-to-bundle-child-product.md)
         - [MDVA-44660: Grave accentteken kan niet worden gebruikt voor de naam van de klant](quality-patches-tool/patches-available-in-qpt/v1-1-15/mdva-44660-grave-accent-character-cannot-be-used-for-customer-name.md)
         - [MDVA-44887: Fout &#39;Uncaught SyntaxError: Unexpected token const&#39; in Het deelvenster Beheer](quality-patches-tool/patches-available-in-qpt/v1-1-15/mdva-44887-uncaught-syntaxerror-unexpected-token-const-error-in-admin-panel.md)
      - Versie 1.1.16 {#v1-1-16}
         - [Overzicht: Het gereedschap Kwaliteitspatches (QPT) v1.1.16](quality-patches-tool/patches-available-in-qpt/v1-1-16/overview.md)
         - [MDVA-42509: CSV kan niet worden geüpload voor snelle bestelling, wat resulteert in de fout &#39;Kan cookie niet verzenden&#39;](quality-patches-tool/patches-available-in-qpt/v1-1-16/mdva-42509-csv-could-not-be-uploaded-for-quick-order-resulting-in-unable-to-send-the-cookie-error.md)
         - [MDVA-43167: De massahandeling van beheerdersorders is niet van toepassing op meerdere pagina&#39;s](quality-patches-tool/patches-available-in-qpt/v1-1-16/mdva-43167-admin-order-grid-mass-doesnt-apply-multipage.md)
         ...
         - [MDVA-44562: De opslag-id voor aanhalingstekens wordt standaard overschreven door de opslag-id](quality-patches-tool/patches-available-in-qpt/v1-1-16/mdva-44562-store-id-quote-items-overridden-by-default-store-id.md)
         - [MDVA-44703: De totalen van orders in het rapport Orders zijn onjuist berekend](quality-patches-tool/patches-available-in-qpt/v1-1-16/mdva-44703-order-totals-in-order-report-miscalculated.md)
      ...
      - v1.1.19 {#v1-1-19}
         ...
         - [ACSD-46192: probleem met het eindpunt async/bulk/V1/configureerbare-products/bySku/options](quality-patches-tool/patches-available-in-qpt/v1-1-19/acsd-46192-async-bulk-v1-configurable-products-bysku-options-endpoint-issue.md)
      - v1.1.20 {#v1-1-20}
      ...
      - v1.1.21 {#v1-1-21}
         ...
         - [ACSD-46809: de gebruiker krijgt een fout wanneer hij een groot aantal productbronnen toewijst](quality-patches-tool/patches-available-in-qpt/v1-1-21/acsd-46809-the-user-gets-an-error-when-assigning-a-large-number-of-product-sources.md)
      ...
      - Versie 1.1.22 {#v1-1-22}
         - [Overzicht: Het gereedschap Kwaliteitspatches (QPT) v1.1.22](quality-patches-tool/patches-available-in-qpt/v1-1-22/overview.md)
         ...
         - [ACSD-47444: [!UICONTROL Trying to access array offset on value of type bool] fout bij toegang tot bepaalde niet-bestaande categoriepaden voor bekende producten op PHP 7.4](quality-patches-tool/patches-available-in-qpt/v1-1-22/acsd-47444-trying-access-array-offset-value-type-bool-error.md)
      ...
      - v1.1.30 {#v1-1-30}
         ...
         - [ACSD-50367: het exporteren van klantadressen werkt niet](quality-patches-tool/patches-available-in-qpt/v1-1-30/acsd-50367-customer-address-export-does-not-work.md)
         - [BB2B-2598: Voegt caching capaciteit toe om Config, currency, country, countries, availableStores GraphQl vragen op te slaan](quality-patches-tool/patches-available-in-qpt/v1-1-30/bb2b-2598-add-caching-capability.md)
         ...
         - [ACSD-50116: een beheerder kan geen URL-rewrite maken](quality-patches-tool/patches-available-in-qpt/v1-1-30/acsd-50116-admin-user-cannot-create-a-url-rewrite.md)
         - [ACSD-50276: registratieformulier voor klanten werkt niet op storefront als attribuut voor meervoudige selectie van klanten wordt gemaakt](quality-patches-tool/patches-available-in-qpt/v1-1-30/acsd-50276-customer-registration-form-does-not-work-on-the-storefront.md)
      ...
      - v1.1.34 {#v1-1-34}
         ...
         - [ACSD-51853: gekopieerde tekststijlen worden niet toegepast met de Page Builder](quality-patches-tool/patches-available-in-qpt/v1-1-34/acsd-51853-copied-text-styles-are-not-applied-when-page-builder-is-used.md)
         - [ACSD-51630: talloze systeemberichten vertragen het downloaden van beheerpagina&#39;s](quality-patches-tool/patches-available-in-qpt/v1-1-34/acsd-51630-large-amount-of-system-messages-slows-the-downloading-of-admin-pages.md)
         ...
         - [ACSD-51857: langzame afbouwtaak van aggregaat_sales_report_bestsellers_data beïnvloedt de prestaties](quality-patches-tool/patches-available-in-qpt/v1-1-34/acsd-51857-slow-cron-job-of-aggregate-sales-report-bestsellers-data-affects-performance.md)
      ...
      - v1.1.38 {#v1-1-38}
         ...
         - [ACSD-53098: Producten in gedeelde catalogus worden niet weerspiegeld op front-end](quality-patches-tool/patches-available-in-qpt/v1-1-38/acsd-53098-products-assigned-to-shared-catalog-not-reflecting-on-frontend-after-partial-index.md)
         - [ACSD-53347: Prijsindexerende prestaties verminderen geleidelijk](quality-patches-tool/patches-available-in-qpt/v1-1-38/acsd-53347-price-indexing-performance-gradually-degrades.md)
      ...
      - v1.1.40 {#v1-1-40}
         ...
         - [ACSD-53378: verbeterde betaalervaring voor klanten met uitgebreide adresboeken](quality-patches-tool/patches-available-in-qpt/v1-1-40/acsd-53378-swift-checkout-for-users-with-extensive-address-books.md)
      - Versie 1.1.41 {#v1-1-41}
      ...
      - v1.1.42 {#v1-1-42}
         ...
         - [ACSD-54060: Beperkte beheerders kunnen het product niet opslaan als het onderliggende is van een ander product](quality-patches-tool/patches-available-in-qpt/v1-1-42/acsd-54060-restricted-admin-cant-save-a-product.md)
         - [ACSD-54418: vaste korting die onjuist wordt toegevoegd aan het onderliggende product van dynamisch geprijsde bundel](quality-patches-tool/patches-available-in-qpt/v1-1-42/acsd-54418-fixed-discount-amount-incorrectly-added-to-child-product-of-dynamically-priced-bundle.md)
         - [ACSD-55238: de lege beschrijving van de productmeta opslaan](quality-patches-tool/patches-available-in-qpt/v1-1-42/acsd-55238-saving-empty-product-meta-description.md)
      ...
      - v1.1.44 {#v1-1-44}
         ...
         - [ACSD-56246: tijdens het plannen van productupdates worden meervoudige kenmerkwaarden gewist](quality-patches-tool/patches-available-in-qpt/v1-1-44/acsd-56246-scheduling-product-updates-clears-multiselect-attributes-values.md)
         - [ACSD-56790: De optie voor het verplaatsen van producten van de categorie &#39;van de voorraad naar de onderkant&#39; werkt niet tijdens het sorteren van producten in de Visual Merchandiser](quality-patches-tool/patches-available-in-qpt/v1-1-44/acsd-56790-move-out-of-stock-to-bottom-option-does-not-work.md)
      - v1.1.45 {#v1-1-45}
         - [Overzicht: [!DNL Quality Patches Tool]  (QPT) v1.1.45](quality-patches-tool/patches-available-in-qpt/v1-1-45/overview.md)
         - [ACSD-56447: het toevoegen van hetzelfde product aan winkelwagen via parallelle REST API-verzoeken resulteert in twee afzonderlijke items in winkelwagentje](quality-patches-tool/patches-available-in-qpt/v1-1-45/acsd-56447-adding-same-product-to-cart-via-parallel-web-api.md)
         ...
         - [ACSD-56886: Configureerbaar product is niet meer op voorraad wanneer onderliggende producten zijn uitgeschakeld](quality-patches-tool/patches-available-in-qpt/v1-1-45/acsd-56886-configurable-product-becomes-out-of-stock-when-child-products-are-disabled.md)
         - [ACSD-56515: Beheerders met machtigingen kunnen niet bewerken [!UICONTROL Dynamic Block]](quality-patches-tool/patches-available-in-qpt/v1-1-45/acsd-56515-admin-with-permissions-cannot-edit-dynamic-block.md)
         - [ACSD-56616: Etalage van gebundelde producten bij eenvoudig tekort aan voorraad](quality-patches-tool/patches-available-in-qpt/v1-1-45/acsd-56616-out-of-stock-simple-products-trigger-bundle-display.md)
         ...
         - [ACSD-56415: de prestaties van [!UICONTROL Partial Price Indexing] de query worden vertraagd vanwege de verwijderingsquery](quality-patches-tool/patches-available-in-qpt/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      - Versie 1.1.46 {#v1-1-46}
      ...
      - v1.1.47 {#v1-1-47}
         ...
         - [ACSD-55241: Gebruikte en Times Gebruikte kenmerken geven onjuiste waarden weer voor gegenereerde coupons](quality-patches-tool/patches-available-in-qpt/v1-1-47/acsd-55241-used-and-times-used-attributes-display-incorrect-values-for-generated-coupons.md)
         - [ACSD-56858: discrepantie bij rolmachtigingen in B2B-bedrijfsbeheerder](quality-patches-tool/patches-available-in-qpt/v1-1-47/acsd-56858-role-permissions-display-issue-in-b2b-company-admin-panel.md)
      - v1.1.48 {#v1-1-48}
         ...
         - [ACSD-56546: configureerbare en bundelproducten worden weergegeven als producten die niet op voorraad zijn in de winkel](quality-patches-tool/patches-available-in-qpt/v1-1-48/acsd-56546-configurable-and-bundle-products-display-as-out-of-stock-on-the-storefront.md)
      ...
      - v1.1.50 {#v1-1-50}
         ...
         - [ACSD-59229: Verkeerde toewijzing van klantgroepgegevens vanwege een verouderde X-Magento-Vary waarde](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-59229-customer-group-segmentation-fix.md)
         ...
         - [ACSD-58790: hiermee wordt de zoomfunctie met knijpbeweging gecorrigeerd voor de afbeeldingen van productdetailpagina&#39;s in de mobiele weergave op  [!DNL Chrome]](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-58790-fixes-pinch-to-zoom-functionality-on-the-product-detail-page.md)
         - [ACSD-58442: Het probleem is opgelost waarbij apparaten met een breedte van 768 px als mobiel worden behandeld, waardoor menu&#39;s en kopteksten in de mobiele weergave niet als desktop worden geladen](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-58442-fixes-issue-devices-768px-mobile-view-instead-desktop.md)
         - [ACSD-48210: Algemene waarden worden overschreven door specifieke bereikkenmerken van de storeweergave](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-48210-store-view-specific-scope-attribute-overrides-global-values.md)
         - [ACSD-59280: ReflectionUnionType::getName() fout in 2.4.4-pX-installaties](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-59280-fix-for-reflection-union-type-error.md)
         - [ACSD-60303: Probleem met plaatsing van beheerdersorders opgelost als HTML-minification is ingeschakeld](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-60303-admin-order-placement-fix.md)
      - Versie 1.1.51 {#v1-1-51}
         ...
         - [ACSD-61195: Aanvraag voor cart graphQL retourneert items niet op de laatste pagina](quality-patches-tool/patches-available-in-qpt/v1-1-51/acsd-61195-empty-cart-on-final-graphql-page.md)
         ...
         - [ACSD-60631: GraphQL retourneert een fout wanneer hetzelfde product wordt toegewezen aan meerdere configureerbare producten](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-51/acsd-60631-graphql-returns-an-error-when-same-product-is-assigned-to-multiple-configurable-products.md)
      ...
      - v1.1.52 {#v1-1-52}
         ...
         - [ACSD-59865: [!UICONTROL Cart Price Rule] annuleert vorige regels niet wegens onvoldoende hoeveelheid](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-52/acsd-59865-cart-price-rule-fix-for-insufficient-quantity-issue.md)
...
- Verwijzing naar opdrachtregelprogramma&#39;s {#cli-reference}
   ...
   - [Compatibiliteitstool bijwerken](reference/uct.md)
...
- Gereedschap Gegevensmigratie {#data-migration}
   ...
   - Algemeen {#basics}
      - [Een lidmaatschap maken](data-migration-tool/create-plan.md)
   ...
   - Gegevens migreren {#migrate-data}
      ...
      - [Veranderingen](data-migration-tool/migrate-data/delta.md)
      - [Nabehandeling](data-migration-tool/migrate-data/follow-up.md)
