...
- Gereedschap Kwaliteitspatches {#quality-patches-tool}
   ...
   - Patches beschikbaar in het gereedschap Kwaliteitspatches {#patches-available-in-qpt}
      ...
      - v1.1.67 {#v1-1-67}
         ...
         - [ACSD-66084: row_total_incl_tax retourneert een restwaarde van bijna nul in plaats van 0,00 voor items met volledige korting in de API-reactie voor bestelling](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66084-fix-row-total-incl-tax-residual-value-for-discounted-items-in-order-api.md)
