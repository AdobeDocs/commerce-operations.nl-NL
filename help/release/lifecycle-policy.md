...
>[!IMPORTANT]
>
>De naleving PCI kan niet voor handelaren worden gewaarborgd die versie 2.4.6 in werking stellen die PHP 8.1 blijven gebruiken, die [&#x200B; eind van steun in 2025 &#x200B;](https://www.php.net/eol.php) bereikte. Op dezelfde manier bereikt PHP 8.2 [&#x200B; eind van leven aan het eind van 2026 &#x200B;](https://www.php.net/supported-versions.php), die het zelfde PCI nalevingsrisico voor handelaren creëren die het in 2027 blijven gebruiken.
