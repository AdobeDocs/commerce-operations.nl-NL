...
[&#x200B; Opslag van het Gegevensbestand voor App Builder &#x200B;](https://developer.adobe.com/app-builder/docs/guides/app_builder_guides/storage/database) is een nieuwe beheerde, document-stijl datastore die in Adobe Developer App Builder wordt gebouwd die uw Commerce apps blijvende, queryable opslag voor gestructureerde JSON gegevens geeft. Alle klanten met een App Builder-licentie kunnen deze functie aanbieden.
