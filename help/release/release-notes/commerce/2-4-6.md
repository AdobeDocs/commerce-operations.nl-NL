...
## 2.4.6-bèta2-testomgeving

Adobe Commerce 2.4.6-bèta2 is getest op basis van de volgende componentversies:
...
Adobe Commerce 2.4.6-bèta2 introduceert ondersteuning voor PHP 8.2. PHP 8.1 blijft volledig ondersteund.  <!-- AC-6598 -->

PHP 7.4 ondersteuning is verwijderd uit deze release. Je kunt Adobe Commerce niet uitvoeren op PHP 7.4.

Adobe Commerce 2.4.6-bèta2 biedt nu ondersteuning voor:
...
In de kerncode van Adobe Commerce 2.4.6 worden honderden problemen opgelost. Hieronder wordt een subset van de opgeloste problemen in Adobe Commerce 2.4.6-bèta2 beschreven.
...
* GraphQL-queryantwoorden bevatten nu informatie over onderliggende producten van bundelproducten in de `product` van de `options` blokkeren.
...
* De klant `order` De vraag keert nu orden van alle gespecificeerde websites, opslag terug, en opslagmeningen zoals verwacht. Deze correctie omvat het maken van een nieuw aanvraagargument.
