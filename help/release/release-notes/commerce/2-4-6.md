...
Zie [ Bulletin van de Veiligheid van de Adobe ](https://helpx.adobe.com/security/products/magento/apsb23-17.html) voor de recentste bespreking van deze vaste kwesties.
...
* Elasticsearch 8.x. Zie [ Elasticsearch van de Verbetering ](../../../upgrade/prepare/prerequisites.md#upgrade-elasticsearch). <!-- AC-6597 -->
...
* Zend framework (ZF1) componenten die het einde van hun levensduur hebben bereikt, zijn uit de codebase verwijderd. Zie [ Achteruit-onverenigbaar veranderingen hoogtepunten ](https://developer-stage.adobe.com/commerce/php/development/backward-incompatible-changes/highlights/).<!-- AC-1512 -->
...
* [ Snel Afhandeling van de Bout ](https://experienceleague.adobe.com/docs/commerce-merchant-services/quick-checkout/overview.html)
* [ Adobe I/O Gebeurtenissen voor Adobe Commerce ](https://developer.adobe.com/commerce/events/get-started/)
...
* Uitchecken met betalingsmethode voor Braintree wordt nu voltooid wanneer Braintree van PayPal is ingeschakeld en **[!UICONTROL Enable Card Payments]** is uitgeschakeld. Eerder werd de voortgangsbalk nooit opgelost en gaf Adobe Commerce de volgende consolefout weer: `adapter.js:66 Uncaught TypeError: Cannot read properties of undefined (reading 'clientToken')at Object.getClientToken (adapter.js:66:66)` . [ GitHub-35961 ](https://github.com/magento/magento2/issues/35961)
...
* Klanten kunnen nu de betalingsmethode voor Braintreeën gebruiken in winkels waar **[!UICONTROL Enable Card Payments]** is uitgeschakeld. Eerder heeft Adobe Commerce de volgende JavaScript-fout gegenereerd: `_adapter.js:66 Uncaught TypeError: Cannot read properties of undefined (reading 'clientToken')at Object.getClientToken (adapter.js:66:66).`
