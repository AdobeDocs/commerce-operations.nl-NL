...
**met deze versie, zijn Authorize.Net, eWay, CyberSource, en de integratie van de betalingsmethode van Worldpay verwijderd uit kerncode. De handelaren zouden aan de officiële uitbreidingen moeten migreren die op Commerce Marketplace** beschikbaar zijn.

>[!NOTE]
>
>**de betaalintegratie van Braintree**: Vóór 2.4.0 werd aanbevolen dat verkopers de officiële uitbreiding van de Braintree-integratie voor betalingen van de Commerce Marketplace installeren en configureren om de kernintegratie te vervangen. Met deze release (2.4.0) is de extensie nu opgenomen in de release. Handelaars moeten extra stappen volgen om ervoor te zorgen dat Braintree behoorlijk in een 2.4.0 plaatsing werkt. Zie [&#x200B; Braintree &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-admin/stores-sales/payments/braintree) voor meer informatie over hoe te aan 2.4.0 migreren.
...
Voor algemene informatie over veiligheidspatches, zie {de flardversie van 0} Veiligheid [&#128279;](../security/overview.md). Voor instructies bij het downloaden en het toepassen van veiligheidspatches (met inbegrip van flard 2.3.5-p2), zie [&#x200B; Snelle begin op-gebouw installatie &#x200B;](../../../installation/composer.md). Beveiligingspatches bevatten alleen oplossingen voor beveiligingsfouten, niet de extra beveiligingsverbeteringen die in de volledige patch zijn opgenomen.

## Overige releasegegevens

Hoewel de code voor deze eigenschappen met driemaandelijkse versies wordt gebundeld, worden verscheidene van deze projecten (bijvoorbeeld, B2B, de Bouwer van de Pagina, Inventory management, en de Progressieve Toepassingen van het Web (PWA) Studio) ook vrijgegeven onafhankelijk. De fixes van de insect voor deze projecten worden gedocumenteerd in de afzonderlijke, project-specifieke versieinformatie die in de documentatie voor elk project beschikbaar is.
...
Er zijn tot op heden geen bevestigde aanvallen met betrekking tot deze problemen geweest. Bepaalde kwetsbaarheden kunnen echter potentieel worden benut om toegang te krijgen tot klantgegevens of om beheerderssessies over te nemen. De meeste van deze problemen vereisen dat een aanvaller eerst toegang verkrijgt tot de beheerder. Daarom herinneren we u eraan alle noodzakelijke stappen te nemen om uw beheerder te beschermen, inclusief maar niet beperkt tot deze inspanningen: IP voegend op lijst van gewenste personen, [&#x200B; twee-factor authentificatie &#x200B;](https://developer.adobe.com/commerce/testing/functional-testing-framework/two-factor-authentication), gebruik van VPN, het gebruik van een unieke plaats eerder dan `/admin`, en goede wachtwoordhygiëne. Zie [&#x200B; Updates van de Veiligheid Beschikbaar voor Magento &#x200B;](https://helpx.adobe.com/nl/security/products/magento/apsb20-47.html) voor een bespreking van deze vaste kwesties.
...
* Insight-gegevens van winkelwagentje worden nu verzonden voor alle actieve aanhalingstekens, zelfs als deze geen objecten bevatten. Dit staat verkopers toe om contacten uit een programma weg te gaan als zij hun kar leegmaken.
...
Deze gebundelde extensie vervangt onze belangrijkste Braintree-integratie, die in deze release is verwijderd. Zie [&#x200B; Betalingen van Braintree &#x200B;](https://commercemarketplace.adobe.com//paypal-module-braintree.html).
...
* De toepassing werpt niet meer een fout wanneer u een beeld van een pagina schrapt terwijl het creëren van het van **Admin** > **Inhoud** > **Pagina&#39;s** > **voegt Nieuwe Pagina** toe. Eerder heeft de toepassing deze fout in de ontwikkelaarsconsole gegenereerd: `500 (Internal Server Error)`. _Reparatie die door Eden Duong in trekkingsverzoek [&#x200B; wordt voorgelegd 25924 &#x200B;](https://github.com/magento/magento2/pull/25924)_. [&#x200B; GitHub-25893 &#x200B;](https://github.com/magento/magento2/issues/25893)
...
* De toepassing genereert niet langer een fout wanneer u een CMS-pagina opslaat die aan meerdere winkels is toegewezen. Eerder heeft de toepassing de pagina opgeslagen, maar deze fout is ook opgetreden toen u een CMS-pagina maakte of bewerkte: `Item (Magento\VersionsCms\Model\Hierarchy\Node) with the same ID "PAGE_ID" already exists`.
...
* Niet-cachebare blokken die in de instructies voor verwijzingen naar niet-bestaande (niet-gedeclareerde) componenten op de pagina aan de standaardlayout zijn toegevoegd, hebben niet langer invloed op het in cache plaatsen van pagina&#39;s. Als u niet-cachebare blokken toevoegt aan standaardlayouthandlers, worden alle pagina&#39;s niet-cachebaar weergegeven. Dit is het resultaat van het genereren van de layout: Tijdens het genereren van de layout verzamelt de toepassing alle beschikbare layouthandgrepen voor een bepaalde pagina en voegt instructies van deze handgrepen samen in de uiteindelijke lay-outstructuur van de pagina. De standaardhandgreep voor de layout wordt voor elke pagina als een standaardhandgreep gebruikt. Dientengevolge, lay-outupdates die voor de standaardmanager worden verklaard verschijnen op elke pagina. [&#x200B; GitHub-9041 &#x200B;](https://github.com/magento/magento2/issues/9041)
...
* De GET `V1/orders/:orderId` -aanroep retourneert naar behoren codes voor cadeaukaarten.
...
* Admin leidt tot de pagina van de Orde nu correct laadt wanneer **Cadeausberichten op het Niveau van de Orde** plaatsen en malplaatjeminificatie wordt toegelaten. Eerder, toen u probeerde deze pagina te openen toen deze montages werden toegelaten, veroorzaakte de toepassing deze fout: `Warning: require(content.phtml): failed to open stream: No such file or directory`.
...
* Deze fout treedt niet meer op tijdens het uitvoeren van integratietests: `Error: Call to a member function findFile() on array (/var/www/html/lib/internal/Magento/Framework/Code/Generator/DefinedClasses.php:59)`. Eerder leidde een probleem met `AutoloaderRegistry::getAutoloader` ertoe dat integratietests willekeurig mislukten. _Reparatie die door Lukasz Bajsarowicz in trekkrachtverzoek [&#x200B; wordt voorgelegd 26480 &#x200B;](https://github.com/magento/magento2/pull/26480)_. [&#x200B; GitHub-26479 &#x200B;](https://github.com/magento/magento2/issues/26479)
...
* De toepassing geeft nu het **ja/neen** attribuut op de pagina van de Categorie terug wanneer **Gebruik in Gelaagde Navigatie: Filterbaar (met resultaten)** voor storefront eigenschappen wordt toegelaten.
...
* Wijzigingen in CMS-pagina&#39;s worden nu geregistreerd zoals wordt verwacht in het actielogboek. MFK behandelt nu deze eigenschap.  _Reparatie die door Lukasz Bajsarowicz in trekkrachtverzoek [&#x200B; wordt voorgelegd 27597 &#x200B;](https://github.com/magento/magento2/pull/27597)_. [&#x200B; GitHub-171 &#x200B;](https://github.com/magento/magento2/issues/171)
...
* De de baannamen van Adobe Commerce `cron` zijn nu inbegrepen zoals verwacht binnen de Sporen van de Transactie in de Controle NewRelic APM - Transacties. Dit omvat `cron` banen die van de bevellijn evenals banen worden uitgevoerd die door de standaardplanner worden uitgevoerd.  _Reparatie die door Lukasz Bajsarowicz in trekkrachtverzoek [&#x200B; wordt voorgelegd 25957 &#x200B;](https://github.com/magento/magento2/pull/25957)_. [&#x200B; GitHub-22047 &#x200B;](https://github.com/magento/magento2/issues/22047)
...
* De validatielogica voor de sectie met klantgegevens is verbeterd. Deze release introduceert een nieuwe manier om alle gegevens van klantsecties ongeldig te maken, waardoor een bekend probleem met lokale opslag wordt voorkomen wanneer aangepaste `sections.xml` -validaties actief zijn. (Eerder, de privé inhoud (lokale opslag) werd niet correct bevolkt wanneer u een douane *etc/frontend/sections.xml* met actiedetecties had.) Zie [&#x200B; Privé inhoud &#x200B;](https://developer.adobe.com/commerce/php/development/cache/page/private-content/#invalidate-private-content).
...
* U kunt nu met succes een product aan het karretje van Admin toevoegen wanneer de voorraad 1 is. Eerder werd het product niet aan de winkelwagentje toegevoegd en werd dit bericht weergegeven: `The requested qty is not available`. _Reparatie die door Serhii Petrychenko in trekkrachtverzoek [&#x200B; wordt voorgelegd 26650 &#x200B;](https://github.com/magento/magento2/pull/26650)._ [&#x200B; GitHub-25675 &#x200B;](https://github.com/magento/magento2/issues/25675)
...
* Elasticsearch 7.6.x is nu de standaardzoekengine voor catalogi voor Adobe Commerce en Adobe Commerce. U kunt niet installeren of upgraden naar versie 2.4.0 zonder ook Elasticsearch 7.6.x te installeren. Elasticsearch versie 2.x-code is verwijderd. Elasticsearch versies 5.x en 6.x zijn vervangen en worden niet meer ondersteund. Zie [&#x200B; de motoreerste vereisten van het Onderzoek &#x200B;](../../../installation/prerequisites/search-engine/overview.md).
...
* Adobe Commerce `cron` wordt nu gebruikt om na het maken van testgegevens opnieuw te indexeren en `cache:flush config` vervangt `cache:flush` (indien van toepassing). _Reparatie die door Lukasz Bajsarowicz in trekkrachtverzoek [&#x200B; wordt voorgelegd 26990 &#x200B;](https://github.com/magento/magento2/pull/26990)_. [&#x200B; GitHub-26989 &#x200B;](https://github.com/magento/magento2/issues/26989)
...
* We hebben een fout opgelost in `JsFooterPlugin.php` die invloed had op de weergave van dynamische blokken. Eerder werd deze fout in de toepassing weergegeven wanneer u rechtstreeks toegang had tot `/banner/ajax/load/url` : `Uncaught TypeError: strpos() expects parameter 1 to be string, null given in` .
...
**Uitgave**: Anomalies in storefront foutberichten treden op in implementaties waar PHP 7.4.2 is geïnstalleerd. Als 2.4.0 wordt geïmplementeerd met PHP 7.4.2, worden de spatiesymbolen in storefront foutberichten vervangen door plusteken (+). Deze fout treedt op in PHP 7.4.2 en kan niet worden gecorrigeerd door Adobe Commerce. **Oplossing**: We raden u aan andere versies van PHP 7.4.x te gebruiken. Zie {de vertoning van 0} Ruwe berichtgegevens op storefront &rbrack;(https://support.magento.com/hc/en-us/articles/360045804332) artikel van de Kennisbank. <!-- MC-34170-->&lbrack;

**Uitgave**: Handelaars kunnen geordende producten niet via de pagina Pakket maken voor beheerders aan een pakket toevoegen en het pakket opslaan. Zie [&#x200B; Verschepende etiketten creatie &#x200B;](https://support.magento.com/hc/en-us/articles/360046750171) artikel van de Kennisbank. **mc-35514-2.4.0-cc-composer.patch** hotfix voor deze kwestie is nu beschikbaar bij [&#x200B; Versies &#x200B;](https://magento.com/tech-resources/download). <!-- MC-35514-->

**Uitgave**: De toepassing geeft dit foutbericht weer tijdens de installatie met externe extensies die afhankelijk zijn van API&#39;s voor de module `Store` in CLI-opdrachten: `The default website isn't defined. Set the website and try again` . **Oplossing**: Verwijder afhankelijkheden van extensies van derden uit Composer, installeer Magento en installeer vervolgens extensies van derden.

**Uitgave**: **voegt selecties aan mijn wortel** knoop op de bodem van het het winkelwagentje toe werkt niet. **Oplossing**: Gebruik **toevoegt selecties aan mijn wortel** knoop op de bovenkant van de pagina. Zie [&#x200B; selecties aan mijn wortelknoop toevoegen &#x200B;](https://support.magento.com/hc/en-us/articles/360045838312) artikel van de Kennisbank niet werkt. <!-- MC-35313-->

**Uitgave**: Merchants kunnen niet met om het even welke paginaelementen op de pagina van Terugkeren communiceren na het creëren van een verschepend etiket voor een Vergunning van de Terugkeer Merchandise (RMA). Zie [&#x200B; Keert Edit paginageinden terug werkend wanneer het creëren van het verschepen artikel van de etiket &#x200B;](https://support.magento.com/hc/en-us/articles/360046441312) Kennisbank. **mc-35984-2.4.0-composer.patch** hotfix voor deze kwestie is nu beschikbaar van [&#x200B; Versies &#x200B;](https://magento.com/tech-resources/download). <!-- MC-35984-->

**Uitgave**: Beheerders kunnen een configureerbaar product door SKU niet aan een aanhalingsteken toevoegen. Wanneer een beheerder op **klikt voeg aan Citaat** knoop toe, geeft het Citaat pagina in een ladingsstaat uit, en de beheerder kon hun veranderingen niet bewaren. **Oplossing**:  Er is geen oplossing voor het bewerken van B2B-offertes.  Nochtans, kunt u tot producten nog opdracht geven door de producten van de productlijst te selecteren in plaats van hen toe te voegen door SKU. Zie [&#x200B; B2B Admin kan geen configureerbaar product aan een citaat &#x200B;](https://support.magento.com/hc/en-us/articles/360046801971) artikel van de Kennisbank toevoegen. <!-- MC-35513-->

**Uitgave**: De handelaren kunnen geen nieuwe orde van Admin tot stand brengen omdat **Producten door SKU** toevoegt en **toevoegt de knopen van Producten** van de de ordeverwezenlijking pagina mist wanneer de bundeling van JavaScript wordt toegelaten.  **Oplossing**: Schakel het JavaScript-pakket voor uw implementatie uit. <!-- MC-36044-->

**Uitgave**: De toepassing een `404 not found` -fout wanneer een klant beloningspunten probeert te verwijderen bij het uitchecken van een bestelling die naar meerdere adressen wordt verzonden. <!-- MC-35955-->

**Uitgave**: Als u een configureerbaar product bewerkt op basis van de verlanglijst van een klant, treedt het volgende onverwachte gedrag op: Een onverwacht gebied verschijnt op de Configure pagina van het Product, en vormt de pagina van het Product niet verdwijnt nadat u **O.K.** klikt. Dit bericht wordt ook weergegeven in de toepassing: `Please load Wish List item`. **Oplossing**: Laad de pagina Configure Product opnieuw. <!-- MC-35617-->

**Uitgave**:  Klanten kunnen het aantal orders dat per pagina wordt weergegeven, niet wijzigen wanneer de lijst met bestellingen meerdere pagina&#39;s beslaat. Momenteel wordt dit bericht weergegeven wanneer u naar de laatste pagina met bestellingen navigeert en probeert het aantal bestellingen dat per pagina wordt weergegeven te wijzigen: `You have placed no orders`. Zie [&#x200B; de vertoningsfout van orden &#x200B;](https://support.magento.com/hc/en-us/articles/360046802271) artikel van de Kennisbank.  **Oplossing**: Als u de pagina Mijn bestellingen opnieuw opent, wordt de lijst met bestellingen weergegeven. <!-- MC-34153-->

**Uitgave**: Direct het klikken op de **knoop van de Tarieven van de Uitvoer** van de Add Nieuwe pagina van de Regel van de Belasting ( **Opslag** > **de Regels van de Belasting**) downloadt niet het `tax_rates.csv` dossier zoals verwacht. **Oplossing**: Klik de rand van de **knoop van de Tarieven van de Uitvoer**.  Zie [&#x200B; de Tarieven van de Belasting van de Uitvoer &#x200B;](https://support.magento.com/hc/en-us/articles/360045850032) artikel van de Kennisbank niet werken. <!-- MC-35345-->

**Uitgave**: **verfrist** knopen op de Laatste Bestelde Punten, Producten in Vergelijkingslijst, en onlangs Vergelijkte secties van Producten van de pagina van de Activiteiten van de Klant Admin werken niet zoals verwacht. Momenteel, scrolt de toepassing de pagina telkens als **verfrist** knoop wordt geklikt en toont niet de productnaam. Zie [&#x200B; zich op de Activiteiten van de Klant verfrissen &#x200B;](https://magento.zendesk.com/hc/en-us/articles/360046091332) artikel van de Kennisbank niet werkt. <!-- MC-35296-->

### B2B

**Uitgave**: Als een kortingscode vervalt voordat een inkooporder (PO) wordt goedgekeurd, blijft de inkooporder het gedisconteerde bedrag weergeven, maar als de inkooporder eenmaal is goedgekeurd, wordt de order geplaatst op het niet-gedisconteerde totaal. **Oplossing**: Installeer **B2B-709 de flardoplossing van de Korting van de Inkooporder** voor deze kwestie, die nu van **Mijn Rekening** > **sectie van de Downloads** van `magento.com` beschikbaar is.

**Uitgave**: De toepassing vormt een uitzondering tijdens de upgrade naar B2B 1.2.0 in een implementatie op meerdere websites. Wanneer `setup:upgrade` wordt uitgevoerd, treedt deze fout op in de module `PurchaseOrder` : `Module Magento_PurchaseOrder: Unable to apply data patch Magento\PurchaseOrder\Setup\Patch\Data\InitPurchaseOrderSalesSequence for moduleMagento_PurchaseOrder` . **Oplossing**: Installeer **B2B-716 toevoegen interface NonTransactionableInterface aan het gegevenspatroon InitPurchaseOrderSalesSequence** hotfix, die nu van **Mijn Rekening** > **Downloads** sectie van `magento.com` beschikbaar is.

## Bekende problemen — VBE

### Amazon Pay

* **Uitgave**: De methodes van de betaling missen van het controlewerkschema wanneer een klant **Terugkeer aan standaardcontrole** tijdens controle met het Betalen van Amazon klikt.  **Oplossing**: Vernieuw de checkout pagina om de ontbrekende methodes te tonen.  <!-- BUNDLE-2661-->

* **Uitgave**: De toepassing geeft twee identieke Amazon Pay-methoden weer in de vervolgkeuzelijst Betalingsmethode die beschikbaar is bij het maken van een nieuwe regel voor winkelwagenprijzen.  <!-- BUNDLE-2685-->

### Braintree

* **Uitgave**: De toepassing toont een fout wanneer een beheerder probeert om tot de pagina van het Rapport van de Regeling van Braintree toegang te hebben (**Admin** > **Rapporten**). Momenteel wordt dit bericht weergegeven: `An error has happened during application run. See exception log for details`. Zie [&#x200B; het Rapport van de Afwikkeling van Braintree ontbreekt om &#x200B;](https://support.magento.com/hc/en-us/articles/360046798251) artikel van de Kennisbank te laden. **BUNDLE-2683_SettlementReport.patch** hotfix voor deze kwestie is nu beschikbaar bij [&#x200B; Versies &#x200B;](https://magento.com/tech-resources/download). <!-- BUNDLE-2683-->

* **Uitgave**: Merchants kunnen geen gedeeltelijke facturen voor orden in plaatsingen tot stand brengen waar Venmo wordt toegelaten en **laat vault voor Kaartbetalingen** plaatsen toe wordt onbruikbaar gemaakt. Momenteel wordt deze fout weergegeven: `The "vault_capture" command doesn't exist. Verify the command and try again`.  <!-- BUNDLE-2647-->

* **Uitgave**: De toepassing geeft twee identieke PayPal-methoden weer in de vervolgkeuzelijst Betalingsmethode die beschikbaar is bij het maken van een nieuwe regel voor de winkelwagenprijs.   <!-- BUNDLE-2686-->

* **Uitgave**: De toepassing en fout wanneer het openen van **Verkoop** > **Virtuele Terminal van Braintree**. Hoewel het formulier beschadigde UI-elementen bevat, accepteert het formulier nog steeds betalingen. **Oplossing**: Sla de juiste Braintree-referenties op, zodat de samengevouwen invoervelden worden gecorrigeerd. Zie [&#x200B; de Virtuele Eindpagina van Braintree wordt bedorven &#x200B;](https://support.magento.com/hc/en-us/articles/360046800071) artikel van de Kennisbank. **BUNDLE-2670_VirtualTerminal.patch** hotfix voor deze kwestie is nu beschikbaar bij [&#x200B; Versies &#x200B;](https://magento.com/tech-resources/download). <!-- BUNDLE-2670-->

* **Uitgave**: De toepassing geeft een foutbericht weer in de volgende landen wanneer een klant een lokale betalingsmethode selecteert tijdens het uitchecken: België, Nederland, Italië, Spanje en Polen.  **Oplossing**: Negeer het foutbericht en ga verder met de betaling.

### dotdigital

* **Uitgave**: Integratietests mislukken met deze fout: `PHP Fatal error: Declaration of Dotdigitalgroup\Email\Test\Integration\Model\Sync\Importer\ImporterFailedTest::setUp() must be compatible with PHPUnit\Framework\TestCase::setUp(): void in /var/www/vendor/dotmailer/dotmailer-magento2-extension/Test/Integration/Model/Sync/Importer/ImporterFailedTest.php on line 36` . **Oplossing**: De **BUNDLE-2684 Dotdigital Integration Tests flarden** hotfix voor deze kwestie is nu beschikbaar bij [&#x200B; Versies &#x200B;](https://magento.com/tech-resources/download). <!-- BUNDLE-2684-->

### Klarna

* **Uitgave**:  Het verlaten van het **thema van het Ontwerp** gebied leeg in het Overseinen van Klarna On-Site (**Admin** > **Opslag** > **Configuratie** > **Klarna montages**) resulteert in een lege pagina.  **Oplossing**: Selecteer een ontwerpthema en sla het op.  <!-- BUNDLE-2623-->

### Vertex

* **Uitgave**:  de toepassing toont een **de controleknoop van het Adres** op de verschepende sectie van het controlewerkschema zelfs wanneer de adresbevestiging gehandicapt is. De adresvalidator controleert het bijgewerkte adres niet opnieuw en blijft een bericht tonen dat erop wijst dat het adres ongeldig is wanneer een klant een correct adres na eerste ingaat een onjuist adres ingaat zelfs wanneer de adresbevestiging wordt toegelaten. **Oplossing**: Schakel hoekpuntadresvalidatie uit. <!-- BUNDLE-2604-->
