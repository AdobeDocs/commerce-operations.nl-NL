...
* [ two-factor authentificatie ](https://devdocs.magento.com/guides/v2.4/security/two-factor-authentication.html)
* Gebruik van VPN
* Gebruik van een unieke locatie in plaats van `/admin`
* Goede wachtwoordhygiëne

Zie [ Bulletin van de Veiligheid van de Adobe ](https://helpx.adobe.com/security/products/magento/apsb22-38.html) voor de recentste bespreking van deze vaste kwesties.
...
* **Adobe Commerce op-gebouw plaatsingen**: Adobe Commerce 2.4.5 is getest en bevestigd om met Elasticsearch 7.17 (~7.17.0 met beperking) compatibel te zijn. Handelaren die Adobe Commerce in het bedrijf hosten, kunnen Elasticsearch of OpenSearch 1.2 gebruiken. <!-- AC-2425-->
