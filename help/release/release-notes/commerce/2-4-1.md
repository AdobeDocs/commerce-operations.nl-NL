...
* **Steun voor verlanglijsten in Magento Open Source**.  U kunt [ punten ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-wishlist.html) aan toevoegen, [ punten ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html) binnen bijwerken, en [ punten ](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-wishlist.html) uit een verlanglijst verwijderen.

* **Verbeterd beheer van klantenrekeningen**. We hebben de mutaties [`createCustomerV2` ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-customer-v2.html) en [`updateCustomerV2` ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-customer-v2.html) toegevoegd om klantenaccounts te beheren. Deze nieuwe mutaties vereisen andere invoerobjecten dan de `createCustomer` - en `updateCustomer` -mutaties. Om het e-mailadres van een klant te veranderen, gebruik de nieuwe [`updateCustomerEmail` ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-customer-email.html) mutatie.

* **Steun voor Payflow ProVault**. Toegevoegde de Vault van GraphQL steun voor de [ betaalwijze ProVault ](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/payflow-pro-vault.html) van de Payflow. _Reparatie die door Oleh Usik in trekkingsverzoek [ wordt voorgelegd 28821 ](https://github.com/magento/magento2/pull/28821)_. [ GitHub-28520 ](https://github.com/magento/magento2/issues/28520)
...
* Klanten kunnen tijdens het afrekenen cadeauberichten en opties voor het inpakken selecteren. GraphQL bespreekt nu geschenkberichtopties voor verschillende typen winkelwagentjes. Zie [`setGiftOptionsOnCart` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/set-gift-options.html) en [`updateCartItems` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-cart-items.html). _Reparatie die door Oleh Usik in trekkingsverzoeken [ wordt voorgelegd 28519 ](https://github.com/magento/magento2/pull/28105), [ 27956 ](https://github.com/magento/magento2/pull/27956), [ 28072 ](https://github.com/magento/magento2/pull/28072), [ 28072 ](https://github.com/magento/magento2/pull/28072), en 246 in privé repo partners-magento2ee_. [ GitHub-253 ](https://github.com/magento/magento2/issues/28519)
...
* U kunt de mutatie `subscribeEmailToNewsletter` gebruiken om klanten aan een nieuwsbrief in te schrijven. Zie [`subscribeEmailToNewsletter` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/subscribe-email-to-newsletter.html) . _Reparatie die door Alexander Taranovsky in trekkrachtverzoek [ wordt voorgelegd 27586 ](https://github.com/magento/magento2/pull/27586)_. [ GitHub-27337 ](https://github.com/magento/magento2/issues/27337)
...
* De [`resetPassword` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/reset-password.html) is toegevoegd. _Reparatie die door Oleh Usik in trekkingsverzoek [ wordt voorgelegd 27876 ](https://github.com/magento/magento2/pull/27876)_. [ GitHub-28521 ](https://github.com/magento/magento2/issues/28521)

* De [`requestPasswordResetEmail` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-password-reset-email.html) is toegevoegd, die de e-mail voor het opnieuw instellen van het wachtwoord voor het opgegeven e-mailadres activeert. _Reparatie die door Oleh Usik in trekkingsverzoek [ wordt voorgelegd 27876 ](https://github.com/magento/magento2/pull/27876)_. [ GitHub-28521 ](https://github.com/magento/magento2/issues/28521)

* Toegevoegde bespreking over Klarna GraphQL in [ de betalingsmethode van Klarna ](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html) en [`createKlarnaPaymentsSession` ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html)
