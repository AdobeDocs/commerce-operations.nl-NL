...
* [ Adobe I/O Gebeurtenissen voor Adobe Commerce ](https://developer.adobe.com/commerce/extensibility/events/)
...
>[!NOTE]
>
>De release van 2.4.7 is compatibel met B2B 1.4.2. Adobe raadt klanten echter aan om te wachten op de aanstaande B2B 1.5.0 GA-release voordat ze een upgrade uitvoeren, inclusief ondersteuning voor PHP 8.3. Zie [ B2B versienota&#39;s ](https://experienceleague.adobe.com/docs/commerce-admin/b2b/release-notes.html).
...
* **3DS steun voor[!DNL Google Pay]** - Inbegrepen 3DS controlesteun voor [!DNL Google Pay] niet-aan elkaar geplaatste kaarten. Zie de [ documentatie van de Braintree ](https://developer.paypal.com/braintree/docs/guides/3d-secure/client-side/android/v3#using-3d-secure-with-google-pay) voor meer informatie.
...
* **[!DNL Braintree]de versienota&#39;s en de verbindingen van de Steun binnen de Configuratie Admin** - de verkopers kunnen nu van de Admin van Commerce aan de steun van de Braintree direct verbinden en online nota&#39;s vrijgeven.
...
* **Geschil webhooks** - wanneer een klant een transactie in Braintree betwist, wordt de geschillenstatus nu overgegaan op Commerce. U kunt de zoekopdracht uitvoeren in het raster **[!UICONTROL Sales]** > **[!UICONTROL Order]** en de opdracht vervolgens koppelen aan elke bestelling.
...
[ de Opties van de Betaling ](https://experienceleague.adobe.com/docs/commerce-merchant-services/payment-services/payments-checkout/payments-options.html) introduceert gesteunde betalingsmethodes.
...
* `price` - en `quantity` -waarden in de gegevenslaag van Google-tagbeheer worden nu verzonden als numerieke waarden die naar verwachting aan Googles Analytics worden doorgegeven. Eerder werden deze waarden als tekenreeksen verzonden.
...
* Commerce voegt geen productbeschrijvingstekst meer in het veld productdetailpagina **[!UICONTROL Meta Description]** in als dit veld leeg is gelaten. Eerder, toen een productbeschrijving HTML code bevatte die door de Bouwer van de Pagina of een andere redacteur van de HTML werd geproduceerd, werd de HTML getoond in het Meta **[!UICONTROL Description]** gebied, en u kon dit gebied niet leeg verlaten.
...
* Aangepaste stijlindelingen die zijn gemaakt door de TinyMCE-editor in Adobe Commerce uit te breiden en door eerdere versies van de Magento Open Source dan versie 2.4.6 te gebruiken, zijn nu beschikbaar zoals u had verwacht in het inhoudssoort van de Page Builder `text` . Eerder werd de aangepaste stijlindeling genegeerd en werden alleen de standaardindelingen geladen na de upgrade naar Adobe Commerce 2.4.6-p1. [ GitHub-36950 ](https://github.com/magento/magento2/issues/36950)
...
* Het CMS-hiërarchiefilter werkt zoals u had verwacht nadat u een winkelweergave filtert en vervolgens op **[!UICONTROL Save]** Beheer **[!UICONTROL Content]** > **[!UICONTROL Hierarchy]** klikt. Als u voorheen op **[!UICONTROL Save]** klikte, werd de pagina vernieuwd, maar de context is verloren gegaan en de geselecteerde winkelweergave werd niet meer weergegeven.

<!-- ACP2E-1631 -->

* Als u op de knop **[!UICONTROL Send invitation]** klikt (Beheer **[!UICONTROL Marketing]** > **[!UICONTROL Private sales]** > **[!UICONTROL Invitation]** ), wordt nu een aanvraag voor een POST samen met de formuliersleutel verzonden en wordt de uitnodiging verzonden. Eerder, toen u deze knoop klikte, waren noch de methode van de POST van HTTP noch de vormsleutel aanwezig.
...
* Op de pagina voor de CMS-blokeditor wordt nu de juiste widget `block_id` -waarde weergegeven. [ GitHub-29644 ](https://github.com/magento/magento2/issues/29644)
...
* Adobe Commerce genereert niet langer een fout bij het maken van een tweede gedeeltelijke factuur voor een bestelling die door de Braintree wordt betaald als **[!UICONTROL Enable Vault for Card Payments]** is ingeschakeld. Eerder, toen een handelaar probeerde om een tweede factuur te creëren, gaf Adobe Commerce deze fout: `Your payment could not be taken. Please try again or use a different payment method. Payment method token is invalid`.
...
* De veelvoudige klikken in de **Verkoop** > **ordent** drop-down menu van de de massageactie van de pagina produceren niet meer veelvoudige verzoeken van de POST.  [ GitHub-37997 ](https://github.com/magento/magento2/issues/37997)
...
* Er treden geen JavaScript-fouten meer op wanneer u geplande updates voor categorieën toevoegt of bewerkt wanneer Inhoud Googles Analytics-experimenten zijn ingeschakeld.
...
* Verbeterde berichten over fouten die optreden tijdens het renderen van sjablonen. Commerce geeft nu een informatief bericht weer. Eerder liet Commerce HTML-lekken zien toen een PHP-fout optrad.
