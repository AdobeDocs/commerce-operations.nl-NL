...
Met uitzondering van [ Braintree ](https://experienceleague.adobe.com/nl/docs/commerce-admin/stores-sales/payments/braintree), zijn alle verkoper-gebundelde uitbreidingen verwijderd uit Adobe Commerce 2.4.4 codebasis. De handelaren zouden aan de officiële uitbreidingen moeten migreren, die op [ Commerce Marketplace ](https://marketplace.magento.com/extensions.html) beschikbaar zijn. <!-- AC-1165-->
