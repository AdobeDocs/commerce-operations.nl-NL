...
* **Wens lijsten**. De [ addWishlistItemsToCart mutatie ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-wishlist-items-to-cart.html) beweegt punten van de gespecificeerde wenslijst aan de wagentje van de klant. <!-- magento/partners-magento2ee#449-->

* **Cadeauregisters**. Bedekte taken zijn: <!-- PWA-1290-->

   * Gebruik de [ giftRegistry vraag ](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry.html) om de inhoud van de het cadeauregisters van de klant terug te keren.

   * Onderzoek naar geschenkregisters door [ type ](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-type-search.html), [ e-mail ](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-email-search.html), of [ identiteitskaart ](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-id-search.html).

   * [ creeer ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-gift-registry.html), [ update ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry.html), of [ schrap ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry.html) geschenkingsregisters.

   * [ Update ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-items.html) of [ verwijdert ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-items.html) punten uit een geschenkregister.

   * [ beweging alle punten ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-cart-items-to-gift-registry.html) van de wagentje aan de giftenregistratie. <!-- ENGCOM-9082 9087-->

   * [ voeg ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-gift-registry-registrants.html) toe, [ update ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-registrants.html), of [ verwijder ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-registrants.html) registranten uit een geschenkregister.

   * [ Deel ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/share-gift-registry.html) een geschenkregister met invitees.

* **Negotiable citaten**. Zie [`negotiableQuote` ](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quote.html) en [`negotiableQuotes` ](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quotes.html) vragen. <!-- PWA-1292-->
...
* **Gedeelde routes**. De [ routevraag ](https://devdocs.magento.com/guides/v2.4/graphql/queries/route.html) en [ RoutableInterface ](https://devdocs.magento.com/guides/v2.4/graphql/interfaces/routable-interface.html) steun die verzoeken op product, categorie, en CMS pagina&#39;s verplettert. De query `urlResolver` is afgekeurd en de functionaliteit ervan is vervangen door de query `route` .
...
* De [`dynamicBlocks` vraag ](https://devdocs.magento.com/guides/v2.4/graphql/queries/dynamic-blocks.html) keert de inhoud van dynamische blokken terug die de gespecificeerde filters aanpassen.
...
* De REST-aanroep `/V1/customers/search` retourneert nu de juiste informatie voor klanten die zijn geabonneerd op meerdere nieuwsbrieven. [ GitHub-31168 ](https://github.com/magento/magento2/issues/31168)
