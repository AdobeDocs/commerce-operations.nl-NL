...
* Een **nieuwe Composer-plug-in** helpt afhankelijkheidsverwarring te voorkomen en identificeert kwaadaardige pakketten met dezelfde namen als interne pakketten in de openbare pakketrepository. Zie de [Adobe Releases New Composer Plugin met 2.4.3 Release](https://magento.com/blog/best-practices/adobe-releases-new-composer-plugin-magento-243-release) blogpost.

* **Snelheidsbeperking is nu ingebouwd in API&#39;s** om denial-of-service (DoS)-aanvallen te voorkomen. Web-API&#39;s leggen nu beperkingen op aan de grootte of het aantal resources (het standaardmaximum is ingesteld op 20 en kan worden geconfigureerd voor een andere waarde op basis van de zakelijke behoefte) die door een client kunnen worden aangevraagd. Zie [ het Beperken van het Tarief ](https://developer.adobe.com/commerce/webapi/get-started/api-security/) voor informatie over het vormen van deze beperkingen. <!-- MC-35358-->
...
* **Verlanglijstjes**. De [ addWishlistItemsToCart mutatie ](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/add-items-to-cart/) beweegt punten van de gespecificeerde wenslijst aan de wagentje van de klant. <!-- magento/partners-magento2ee#449-->
...
* **Cadeauregisters**. Bedekte taken zijn: <!-- PWA-1290-->
   ...
   * [Werk items bij](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update-items/) of [verwijder](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove-items/) ze uit een cadeaulijst.
...
Het werkingsgebied van het [ Hulpmiddel van de Verenigbaarheid van de Verbetering ](https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/upgrade-compatibility-tool/overview.html) is uitgebreid gebaseerd op terugkoppelen van de gemeenschap. Sluit me aan bij ons [ #upgrade-verenigbaarheid-hulpmiddel ](https://magentocommeng.slack.com/archives/C019Y143U9F) Slack kanaal om steun van het het productteam van Adobe en de gemeenschap te krijgen, evenals helpen de toekomstige richting van het hulpmiddel begeleiden.
...
We hebben honderden problemen opgelost in de 2.4.3 core code.
...
* Koppelingen naar cadeauregisters blijven nu behouden zoals u had verwacht wanneer u een product bewerkt in het winkelwagentje. Voorheen verdwenen deze links wanneer u op de **knop Winkelwagen** bijwerken klikte.
...
* Je kunt nu POST `/V1/carts/mine/items` gebruiken om een aangepaste hoeveelheid gegroepeerde producten aan een winkelwagen toe te voegen. [ GitHub-26909 ](https://github.com/magento/magento2/issues/26909)
...
* Updatebestanden voor aangepaste categorielay-outs zijn nu naar behoren van toepassing op producten. Voorheen kwam de handle van het updatebestand (`catalog_category_view_*`) niet overeen met de producthandle. [ GitHub-27285 ](https://github.com/magento/magento2/issues/27285)

<!-- MC-40679-->

* Sorteren is uitgeschakeld voor de kolom Fixed Product Tax (FPT) van de lijst met beheerdersproducten. Voorheen kon de pagina Producten niet opnieuw worden geladen nadat de FPT-kolom was gesorteerd.
...
* De toepassing geeft nu slechts één fout in het winkelwagentje weer wanneer het product uit voorraad is. Voorheen gaf de applicatie overbodige berichten weer. [ GitHub-27469 ](https://github.com/magento/magento2/issues/27469)

<!-- MC-35717  magento/partners-magento2ee#427-->

* Beheerders kunnen nu een product met een aanpasbare optie `(File)` toevoegen aan een bestelling per SKU. [ GitHub-30285 ](https://github.com/magento/magento2/issues/30285)

<!-- MC-30625-->

* U kunt nu een product en prijs opslaan zonder .`type_id` [ GitHub-13639 ](https://github.com/magento/magento2/issues/13639)

<!-- MC-39024-->

* Groepsproducten zijn nu beschikbaar in de winkel, zoals verwacht wanneer een REST-aanvraag `PUT /V1/products/:sku/links` wordt gebruikt om een nieuw onderliggend product te koppelen aan een nieuw groepsproduct. Voorheen werden producten niet correct geïndexeerd na het uitvoeren van `bin/magento cron:run`.

<!-- ENGCOM-9010 8947-->

* U kunt niet langer een product met een `NULL` SKU-waarde maken. Voorheen kon u een product zonder SKU-waarde maken via een aangepaste importeur of rechtstreeks in de database, maar toen u het probeerde te bewerken vanuit de beheerder, genereerde de toepassing een fout. [ GitHub-27411 ](https://github.com/magento/magento2/issues/27411), [ GitHub-32525 ](https://github.com/magento/magento2/issues/32525)

<!-- ENGCOM-8902-->

* Als u de vereiste aangepaste opties aan een eenvoudig product toevoegt, wordt het niet langer zonder waarschuwing verwijderd uit bovenliggende samengestelde producten. De applicatie geeft nu een informatieve waarschuwing weer en slaat het product niet op.  Eerder heeft de toepassing de productwijzigingen opgeslagen en geen waarschuwing weergegeven. [ GitHub-30492 ](https://github.com/magento/magento2/issues/30492)

### Catalogusregel

<!-- MC-39896-->

* De `products` query retourneert nu de huidige waarden wanneer een catalogusprijsregel van toepassing is op een artikel. [ GitHub-26738 ](https://github.com/magento/magento2/issues/26738)

<!-- ENGCOM-8367-->

* Tijdelijke tabellen die beginnen met `catalogrule_product__temp` , worden nu zoals verwacht verwijderd wanneer het opnieuw indexeren mislukt nadat een winkelwagen- of catalogusregel is verlopen, is uitgeschakeld of inactief is geworden. [ GitHub-22273 ](https://github.com/magento/magento2/issues/22273)
...
* De foutafhandeling voor de CMS-controller voor het opslaan van pagina&#39;s is opgelost. Voorheen, wanneer een `Error` object op de `cms_page_prepare_save` gebeurtenis werd gegooid, gaf de applicatie dit object door aan de `addExceptionMessage` functie, waardoor het contract werd verbroken omdat deze functie een `Exception`. Dit werd opgelost door een foutmelding toe te voegen met behulp van de `addErrorMessage` functie. [ GitHub-30149 ](https://github.com/magento/magento2/issues/30149)

<!-- MC-33490 magento/partners-magento2ee#435 -->

* U kunt nu een nieuwe pagina toewijzen aan meerdere knooppunten via het tabblad Paginahiërarchie bewerken in CMS. Voorheen trad er een unieke beperkingsschending op wanneer u probeerde de pagina toe te wijzen aan een knooppunt. [ GitHub-363 ](https://github.com/magento/partners-magento2ee/issues/363)
...
* De toepassing verzendt nu e-mail zoals verwacht in implementaties op meerdere locaties waarbij niet alle websites asynchrone e-mailverzending hebben ingeschakeld. Als deze instelling was uitgeschakeld voor ten minste één website, werd e-mail niet verzonden van een website, zelfs niet als deze was ingeschakeld. E-mails met facturen, verzendingen en creditnota&#39;s hadden vergelijkbare problemen. De e-mails met Orderopmerkingen, Factuuropmerkingen, Verzendopmerkingen en Creditnota&#39;s zijn echter met succes verzonden. [ GitHub-31950 ](https://github.com/magento/magento2/issues/31950)

<!-- MC-34323 magento/partners-magento2ee#505-->

* Het e-mailbericht dat de toepassing verzendt wanneer u een cadeaulijst deelt vanuit de beheerder, bevat nu een geldige koppeling naar de registerlocatie. Voorheen resulteerde het nemen van deze link in een 404-fout. [ GitHub-504 ](https://github.com/magento/partners-magento2ee/issues/504)

<!-- MC-30127 magento/magento2#31455-->

* Facturen en factuur-PDF&#39;s bevatten nu dezelfde prijzen voor bundelproducten als verwacht. Eerder waren in PDF&#39;s op de factuur de onjuiste prijs voor bundelproducten opgenomen. [ GitHub-12856 ](https://github.com/magento/magento2/issues/12856)
...
* De toepassing houdt nu de **exclusief media omslag van steun** het plaatsen wanneer de steun met `bin/magento config:set system/backup/functionality_enabled 1` wordt toegelaten. Voorheen werd er ondanks deze instelling een back-up gemaakt van de mediamap omdat het pad naar `/magento` onjuist was gevormd met een dubbele //.
...
* De toepassing geeft nu het juiste aantal sterren weer op de pagina Mijn productbeoordelingen en op de pagina Mijn account die onlangs is gecontroleerd. Voorheen paste de applicatie alleen beoordelingssterren toe op de eerste recensie en liet de andere recensies op de pagina zonder ster.

<!-- MC-40653-->

* Accountlinks in headers volgen nu de WCAG-standaarden. Voorheen bevatten accountlinks in headers dubbele ID&#39;s, waardoor WCAG-validatie mislukte.

<!-- MC-40528-->

* De applicatie slaat nu de datums van catalogusgebeurtenissen op in UTC-tijdzones. Voorheen sloeg de applicatie datums van catalogusgebeurtenissen op in de tijdzone van de gebruiker.

<!-- MC-39765-->

* De applicatie genereert niet langer door systeemlogboeken gegenereerde fouten wanneer een gastshopper een ongeldig adres gebruikt. Voorheen gaf de toepassing deze fout af en toe weer in plaats van de pagina weer te geven: `No such entity with addressId`. [ GitHub-15115 ](https://github.com/magento/magento2/issues/15115)

<!-- MC-39747-->

* Tijdens het wijzigen van de afbeeldingsgrootte worden afbeeldingen in niet-ondersteunde indeling niet meer gestopt. Eerder, wanneer `catalog:images:resize` een niet-ondersteund afbeeldingsformaat werd aangetroffen, stopte het proces en gaf de toepassing deze fout weer: `bin/magento catalog:images:resize Unsupported image format`.

<!-- ENGCOM-8925-->

* WEBP- en AVIF-ondersteuning voor logo-afbeeldingen is toegevoegd aan de beheerder. [ GitHub-32495 ](https://github.com/magento/magento2/issues/32495)

<!-- MC-38156-->

* U kunt het bereik van het kenmerk `media_gallery` niet meer wijzigen. Voorheen, toen u het bereik van het `media_gallery` kenmerk weer veranderde in `global`, genereerde de toepassing een fout.
...
* De applicatie genereert niet langer een foutmelding wanneer een beheerder een pagina in de etalage probeert te laden wanneer Google Analytics is ingeschakeld. Er is een CSP-vermelding voor `connect-src` toegevoegd om AJAX-verzoeken in staat te stellen te www.google-analytics.com. [ GitHub-30880 ](https://github.com/magento/magento2/issues/30880)

### Google-tagbeheer

<!-- MC-39072-->

* De UI-component voor het factuuradres op de betaalpagina van de afrekenworkflow gebruikt nu het offerteadres correct wanneer Google Tag Manager is ingeschakeld. Eerder trad er een JavaScript-fout op op de betaalpagina.
...
* De toepassing genereert geen typefouten meer tijdens GraphQL-query&#39;s wanneer product- en categorie-URL-achtervoegsels null-waarden bevatten. [ GitHub-30909 ](https://github.com/magento/magento2/issues/30909)

<!-- magento/magento2#31164-->

* Het `CustomizableDateValue` object bevat nu het `type` attribuut. De waarde is een opsomming die kan worden ingesteld op DATE, DATE_TIME of TIME.

<!--  magento/partners-magento2ee#421-->

* De [`dynamicBlocks` query](https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/dynamic-blocks/) retourneert de inhoud van dynamische blokken die overeenkomen met de opgegeven filters.
...
* U kunt nu de kenmerken required_options en has_options bundel instellen zoals verwacht tijdens het maken of bijwerken van een bundelproduct met behulp van het POST-eindpunt `/V1/product/:sku` . Eerder werden deze aangepaste kenmerken ingesteld op 0 (nul), ondanks pogingen om deze in te stellen op 1 (één).
...
* Bij het exportproces wordt nu rekening gehouden met het bereik van de gebruikersrol bij het exporteren van producten, voorraadbronnen en klantentiteiten. Voorheen werd in het exportproces het bereik van de gebruikersrol genegeerd, waardoor de export van exportentiteiten voor privégebruikersrollen mogelijk was.

<!-- MC-40943-->

* De toepassing stelt de productbelastingklasse nu in op `None` als een product wordt geïmporteerd met `tax_class_name` waarden `None` of `0`. Voorheen `product tax_class_name` maakte `None` de toepassing in het CSV-bestand een nieuwe belastingklasse `None`, die de bestaande belastingklasse dupliceerde. Als `product tax_class_name` `0` in het CSV-bestand aanwezig was, negeerde de toepassing die waarde en veranderde de productbelastingklasse niet na het importeren.
...
* Het `composer.lock` bestand is bijgewerkt naar de nieuwste versie van de coderingsstandaard. [ GitHub-31152 ](https://github.com/magento/magento2/issues/31152)
...
* `bin/magento media-gallery:sync` mislukt nu zoals verwacht bij het verwerken van PNG-afbeeldingen die geen XMP-informatie bevatten.

<!-- ENGCOM-8814-->

* Vermeldingen in de `catalog_product_entity_media_gallery` tabel worden zoals verwacht verwijderd wanneer gerelateerde producten worden verwijderd. [ GitHub-17727 ](https://github.com/magento/magento2/issues/17727)

<!-- ENGCOM-8945-->

* Afbeeldingsdetails kunnen nu worden bijgewerkt in de mediagalerij wanneer JavaScript-minificatie is ingeschakeld. Voorheen werden afbeeldingsdetails niet opgeslagen en gaf de toepassing deze fout weer: `TypeError: Cannot read property 'call' of undefined in jquery.validate`. [ GitHub-31633 ](https://github.com/magento/magento2/issues/31633)
...
`AssertAdminProductIsAssignedToCategoryActionGroup`  (vervangt het filteren van het productraster op SKU en het klikken op de eerste rij (om de uitvoeringstijd van de test te verkorten) <!-- ENGCOM-8535 8534-->
...
* De applicatie berekent nu op de juiste manier een gefactureerd klantsaldo bij het terugstorten van winkeltegoed naar een klantaccount voor een gedeeltelijk gefactureerde bestelling.
...
* De lijst met betaalmethoden wordt nu zoals verwacht bijgewerkt wanneer een gastshopper het verzendadres van een bestelling wijzigt in een ander land tijdens het afrekenen. Voorheen leidde het wijzigen van het factuuradres niet tot een actualisering van de mogelijke betalingsmethoden.
...
* Kopers worden nu weer omgeleid naar de succespagina voor bestellingen nadat ze met PayPal zijn betaald. Voorheen werden shoppers omgeleid naar een lege pagina omdat sessiegegevens verloren waren gegaan.
...
* De toepassing maakt niet langer dubbele adresvermeldingen voor een klantenaccount wanneer een nieuwe bestelling van de beheerder voor een bestaande klant wordt gemaakt. Het **selectievakje Opslaan in Adresboek** heeft de naam gewijzigd in **Toevoegen aan Adresboek** en is nu standaard uitgeschakeld in de beheerder.
...
* De applicatie geeft nu de juiste aangepaste verzendprijs weer wanneer sommige artikelen in de winkelwagen in aanmerking komen voor gratis verzending. Eerder, toen een subset van objecten in de winkelwagen in aanmerking kwam voor gratis verzending, paste de toepassing de verzendprijs niet aan en gaf de volledige verzendprijs aan de klant weer.
...
* De kwesties van de groepering met de lusjes op de Admin uitnodigingspagina (Admin **Marketing** > **Privé Verkoop** > **Uitnodigingen**) zijn opgelost. Voorheen was de tabbladweergave voor uitnodigingen die door een klant waren geaccepteerd, niet goed uitgelijnd. [ GitHub-333 ](https://github.com/magento/partners-magento2ee/issues/333)

<!-- MC-38226 magento/magento2#32008-->

* De pagina voor het beoordelen van bestellingen die tijdens het afrekenen wordt weergegeven met PayPal Express Checkout, wordt nu succesvol geladen. Voorheen bevatte de sjabloon de ongebruikte **knop Aflevermethode** bijwerken, die tijdens het weergeven van pagina&#39;s slechts gedeeltelijk door het script werd verborgen. [ GitHub-32006 ](https://github.com/magento/magento2/issues/32006)

<!-- MC-37941 magento/magento2#31892-->

* Beoordelingssterren en beoordelingstekst in het gedeelte Klantbeoordelingen van de productpagina zijn nu op de juiste afstand geplaatst wanneer lange beoordelingsnamen aanwezig zijn. [ GitHub-31890 ](https://github.com/magento/magento2/issues/31890)

<!-- MC-37688-->

* Opties worden nu weergegeven zoals verwacht in de vervolgkeuzelijst Acties op de pagina&#39;s Facturen, Verzendingen en Creditnota&#39;s archiveren.

<!-- MC-23729  magento/magento2#31549-->

* De applicatie geeft nu een juiste tijdwaarde weer wanneer de `datetime` componentoptie `timeOnly` is ingesteld op **ja**. [ GitHub-23157 ](https://github.com/magento/magento2/issues/23157)

<!-- ENGCOM-8514 -->

* U kunt nu een lay-outupdate verwijderen nadat u een nieuwe widget hebt gemaakt op Admin **Content** > **Widgets**.  [ GitHub-29936 ](https://github.com/magento/magento2/issues/29936)

<!-- ENGCOM-8502 MC-35716-->

* De **knop Lay-outupdate** verwijderen werkt nu zoals verwacht op elke lay-out die u hebt toegevoegd via Admin-inhoud **&#x200B;**&#x200B;> **Widgets**. Voorheen werkte deze knop niet op een andere lay-out dan de eerste die was geselecteerd bij het toevoegen van meerdere lay-outs. [ GitHub-30286 ](https://github.com/magento/magento2/issues/30286)

<!-- ENGCOM-8524 -->

* De toepassing gebruikt nu de paginatitel die is ingesteld in het lay-outbestand als de paginatitel van de browser voor het bewerkingsbestand van de klantaccount. Voorheen dwong de `Magento\Customer\Controller\Account\Edit` controlleractie de waarde van de paginatitel af op `Account Information`. [ GitHub-30724 ](https://github.com/magento/magento2/issues/30724)

<!-- ENGCOM-8896 8826-->

* Selectievakjes waarmee verkopers kunnen schakelen tussen het weergeven en verbergen van wachtwoorden zijn aan deze pagina&#39;s toegevoegd:
   * Klant Login
   * Klant Registratie
   * Klant bewerken (sectie Wachtwoord wijzigen)
   * Klant stelt nieuw wachtwoord [in GitHub-31557](https://github.com/magento/magento2/issues/31557)
...
* De toepassing geeft nu een `DateRange` filter weer in het gedeelte Ingelogd van de **&#x200B;**&#x200B;pagina Klant > **Inloggen**. Voorheen gaf de applicatie een `Text` filter weer. [ GitHub-30328 ](https://github.com/magento/magento2/issues/30328)

<!-- ENGCOM-9009 -->

* JavaScript is verwijderd uit sjabloonbestanden en verplaatst naar afzonderlijke bestanden om weergaveproblemen op beheerderspagina&#39;s te verminderen. Eerder werden Admin-pagina&#39;s niet correct weergegeven in implementaties waarin minificatie van HTML was ingeschakeld. De toepassing heeft deze fout weergegeven: `An error has happened during application run. See exception log for details`. [ GitHub-32454 ](https://github.com/magento/magento2/issues/32454)
...
We zijn de bredere Magento Open Source-community dankbaar en willen graag hun bijdragen aan deze release erkennen.

Het Community Engineering-team [Magento Contributors](https://magento.biterg.io/app/kibana) houdt een lijst bij van de meest bijdragende personen en partners per maand, kwartaal en jaar. Vanaf die pagina Contributors kun je links volgen naar hun samengevoegde PR&#39;s op GitHub.

### Bijdragen van partners

De volgende tabel geeft een overzicht van de bijdragen van de partners. Deze tabel bevat de partner die de pull-aanvraag heeft bijgedragen, de externe pull-aanvraag en het GitHub-probleemnummer dat eraan is gekoppeld (indien beschikbaar).
