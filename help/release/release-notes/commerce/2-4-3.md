...
* **Onderhandelbare aanhalingstekens**. Zie de [`negotiableQuote`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quote.html) en [`negotiableQuotes`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quotes.html) vragen. <!-- PWA-1292-->
...
* [Amazon Pay](https://marketplace.magento.com/amzn-amazon-pay-magento-2-module.html). Amazon Pay is vervangen en wordt in een latere release van 2.4.x verwijderd. Versie 2.4.3 en hoger bevat alleen updates voor compatibiliteit en oplossingen voor belangrijke fouten.
...
* De toepassing genereert niet langer een fout wanneer een beheerder een pagina probeert te laden in de opslagruimte wanneer Googles Analytics zijn ingeschakeld. Een CSP-item voor `connect-src` is toegevoegd om AJAX aanvragen toe te staan to www.google-analytics.com. [GitHub-30880](https://github.com/magento/magento2/issues/30880)
