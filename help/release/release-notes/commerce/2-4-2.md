...
Deze release bevat meer dan 280 nieuwe oplossingen voor kerncode en 35 beveiligingsverbeteringen. Het omvat de oplossing van bijna 290 GitHub kwesties door onze communautaire leden. Deze bijdragen van de gemeenschap variëren van kleine schoonmaak van de kerncode tot significante verbeteringen in GraphQL.
...
* Toegevoegde ondersteuning voor meerdere wenslijsten. U kunt GraphQL gebruiken voor [maken](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-wishlist.html), [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-wishlist.html), en [naam wijzigen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-wishlist.html) zowel [move](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-products-between-wishlists.html) of [kopiëren](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-products-between-wishlists.html) objecten daartussen. <!-- MC-32356-->

* Toegevoegde steun voor teruggekeerde handelsvergunningen (RMA). Klanten kunnen [om terugkeer verzoeken](https://devdocs.magento.com/guides/v2.4/graphql/mutations/request-return.html). Als de handelaar het verzoek goedkeurt, kan de verkoopster taken uitvoeren zoals [toevoegen, opmerking](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-comment.html) en [trackinggegevens toevoegen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

* Extra ondersteuning voor de volgende B2B-functies:
   * Bedrijven. U kunt een bedrijf toevoegen [beheerders](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company.html), [gebruikers](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-user.html), [rollen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-role.html), en [teams](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   * Bedrijfskrediet. De [bedrijfsquery](https://devdocs.magento.com/guides/v2.4/graphql/queries/company.html) bevat nadere gegevens over de kredietgeschiedenis van de onderneming. <!-- MC-33862-->
   * Aanvraaglijsten. U kunt [maken](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-requisition-list.html), [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list.html), en [update](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-requisition-list.html) aanvraaglijsten. De ondersteuning omvat ook de mogelijkheid om [toevoegen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-requisition-list.html), [update](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-products-in-wishlist.html), [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list-items.html), [kopiëren](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-items-between-requisition-lists.html), en [move](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-items-between-requisition-lists.html) items in een aanvraaglijst en items in een aanvraaglijst toevoegen [in de wagen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

* Toegevoegde steun voor unies in GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->
...
* Het schema GraphQL is verbeterd om de terugwinning van productgegevens voor configureerbare producten met vele varianten te optimaliseren. <!-- MC-36138-->
...
**Aankooporders kunnen nu worden voltooid met behulp van online betalingsmethoden**. B2B-kopers worden gevraagd hun voorkeursbetalingsmethode voor elke [inkooporder](https://docs.magento.com/user-guide/stores/b2b-purchase-order-flow.html) tijdens de eerste afhandeling. Nadat de kooporder is goedgekeurd, wordt kopers gevraagd betalingsgegevens in te voeren om de kooporder om te zetten in een uiteindelijke bestelling.
...
* De Bouwer van de pagina vereist niet meer alle inhoudstypes om binnen een rij worden geplaatst. De [Stage van Page Builder](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#stage) is nu in eerste instantie leeg en biedt ondersteuning voor het rechtstreeks toevoegen van de volgende inhoudstypen aan het werkgebied: Rijen, kolommen, tabs, HTML-code, blokken, dynamische blokken.

* Vooraf gedefinieerde marges en opvullingen zijn niet meer vereist voor inhoudssoorten.

* De nieuwe mobiele telefoon [viewport switch](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#viewports) en viewportbereik voor formulierveldwaarden stelt gebruikers en ontwikkelaars in staat de volgende handelingen uit te voeren:

   * De inhoud van de mening op verschillende meningshavens wanneer creatie.

   * Optimaliseer de parameter van het minimumhoogtegebied op verschillende inhoudstypes voor elke viewport. (Er wordt slechts één parameter (minimumhoogte) uit het vak ondersteund. Aangepaste ontwikkeling vereist om mobiele optimalisatie voor andere inhoudsparameters mogelijk te maken.)

   * Veldbereik toevoegen aan aangepaste velden en veldsets (ontwikkelaars).

### Interactieve productrichtlijnen

De interactieve Begeleiding In-Product van verkopers voorziet gebruiksuiteinden en informatie van binnen Admin over nieuwe eigenschapmededelingen, loopthrough gidsen, op-boarding informatie, en hulpmiddeluiteinden.  **Beheerders moeten zich aanmelden bij de beheerder om hulp in producten te ontvangen als deze functie niet is ingeschakeld**. Zie [Gegevensverzameling gebruiken](https://docs.magento.com/user-guide/stores/admin.html) en [Beheerdersgebruik](https://docs.magento.com/user-guide/configuration/advanced/admin.html#admin-usage).
...
De steun voor AWS S3 is toegevoegd aan alle modules met inbegrip van B2B, PageBuilder, en de Integratie van Adobe Stock.
...
* [Amazon Pay](https://docs.magento.com/user-guide/payment/amazon-pay.html). Amazon Pay is vervangen in deze release en wordt verwijderd in Magento 2.5.0. Versie 2.4.3 en hoger bevat alleen updates voor compatibiliteit en oplossingen voor belangrijke fouten.
...
* Beheerders van wie de machtigingen uitsluiten `Magento_Catalog::edit_product_design` (Productontwerp bewerken) kunt u nu een nieuw product maken door een bestaand product met een nieuwe naam op te slaan in de geselecteerde winkelweergave. Eerder werd deze fout door de toepassing weergegeven:  `Not allowed to edit the product's design attributes`. [GitHub-28106 ](https://github.com/magento/magento2/issues/28106)
...
* De toepassing genereert niet langer een fout wanneer u probeert te wijzigen `backend-frontname` met de `ssh` -container na installatie van Adobe Commerce. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Het toepassen van een prijsregel met een coupon met behulp van GraphQL werkt nu zoals u had verwacht **Korting op een vast bedrag voor het hele winkelwagentje** actie wordt gebruikt.
...
* Productopslagplaats gebruikt nu `store_id` indien beschikbaar om kenmerkwaarden voor een bestaand product op te slaan.  Eerder werd de product repository-klasse de product store-id overschreven en altijd de standaard winkel-id toegewezen. [GitHub-29933](https://github.com/magento/magento2/issues/29933)
...
* De toepassing leidt klanten niet meer naar de homepage wanneer het veranderen van archiefmening. De `\Magento\VersionsCmsUrlRewrite\Model\StoreSwitcher::switch()` de methode leidt nu winkels naar de homepage alleen als `$urlPath` niet gevonden voor de weergave van de tweede winkel.
...
* `MessageValidator` mislukt niet meer op hash-arrays die geen `0` element. [GitHub-30563](https://github.com/magento/magento2/issues/30563)
...
* GraphQL responstijd voor toevoegen aan winkelwagentjes is verbeterd.
...
* GraphQL voldoet nu aan catalogusmachtigingen. De toepassing beperkt welke items worden geretourneerd voor een `products` query op basis van de klantgroep van de klant.
...
* Bij een gepland productimportproces worden nu producten bijgewerkt met juiste gegevensvelden als het CSV-bestand ook onjuiste items bevat. Eerder werden geen items bijgewerkt als het CSV-bestand onjuiste items bevatte toen **Bij fout: Doorgaan met verwerking** is ingeschakeld.
...
* Er zijn betekenisvolle titels en beschrijvingen toegevoegd aan MFK-tests voor de `Company`, `CompanyCredit`, `CompanyPayment`, `CompanyShipping`, en `ConfigurableSharedCatalog` modules. [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* Klanten van gasten kunnen nu PayPal-orders plaatsen wanneer **Automatische toewijzing aan Klantengroep** is ingeschakeld. De betaling wordt verwerkt op de PayPal-gateway, de bestelling wordt gemaakt in Magento en de winkelier ziet de pagina voor bedankt voor de bestelling. Eerder is de bestelling verwerkt via de PayPal-gateway, maar de bestelling is niet gemaakt in Adobe Commerce. De verkoopster werd in plaats daarvan omgeleid naar de pagina van het ordeoverzicht, waar de toepassing deze fout toonde: `Failed address validation: %1" error`. [GitHub-25399](https://github.com/magento/magento2/issues/25399)
...
* Het aantal classificaties dat wordt weergegeven op **Winkels** > **Kenmerk** > **Classificatie** komt nu overeen met het aantal beoordelingen in een implementatie voor meerdere sites. [GitHub-30258](https://github.com/magento/magento2/issues/30258)
...
* Correctie van problemen met GraphQL `testRequestCacheTagsForCategoryListOnMultipleIds` test. [GitHub-29372](https://github.com/magento/magento2/issues/29372)
...
* Koptekstwaarden met URL&#39;s worden nu op de juiste wijze geparseerd in `ApiFunctional TestFramewor`k. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
**Probleem**: Merchants moeten de functie TLS snel forceren activeren van de beheerder om de algemene omleiding van HTTP naar HTTPS voor alle winkelpagina&#39;s mogelijk te maken. Zie de [HTTP omleiden naar HTTPS voor alle pagina&#39;s in de cloud (TLS afdwingen)](https://support.magento.com/hc/en-us/articles/360006296953) Kennisbank, artikel. <!-- MC-39988-->

**Probleem**: U kunt de `addConfigurableProductToCart` GraphQL-mutatie om een configureerbaar product aan een winkelwagentje toe te voegen in een niet-standaard winkelweergave in een implementatie in meerdere opslagruimten die Inventaris uitvoert. (Dit heeft geen invloed op de bibliotheekpatronen.) de toepassing geeft deze fout weer: `Could not add item to cart. Please check required options and try again`. **Workaround**: Gebruik de `addProductsToCart` mutatie. [GitHub-31660](https://github.com/magento/magento2/issues/31660)<!-- PWA-1298-->
...
**Probleem**: Kopers worden omgeleid naar het winkelwagentje wanneer ze via PayPal Express Checkout een bestelling proberen te plaatsen bij een inkooporder wanneer **Contextmodus** is uitgeschakeld. <!-- B2B-1604-->

**Probleem**: De toepassing geeft soms een fout van 404 weer wanneer een koper een inkooporder maakt en vervolgens naar de afhandelingspagina navigeert. Deze fout treedt op wanneer een koper eerder een andere inkooporder met een online betalingsmethode heeft gemaakt voordat hij naar de betalingspagina navigeert zonder de vorige aankoop te voltooien. De koper kan de kooporder nog steeds plaatsen. **Workaround**: Geen. <!-- B2B-1605-->

**Probleem**: Kortingen voor een specifieke betalingsmethode blijven bestaan tijdens afhandeling voor een inkooporder, zelfs als de koper zijn betalingsmethode wijzigt tijdens de laatste afhandeling. Als gevolg hiervan kunnen klanten een korting ontvangen waarop ze geen recht hebben. Dit gebeurt omdat de oorspronkelijke betalingsmethode ondanks de wijziging van de betalingsmethode nog steeds wordt toegepast op een kaartregel. **Workaround**: Geen. Zie de [2.4.2 Bekende kwestie B2B: Er blijft korting over voor online inkooporders nadat de betalingsmethode is gewijzigd](https://support.magento.com/hc/en-us/articles/360054667312) Kennisbank, artikel. <!-- B2B-1012 -->

**Probleem**: De `deleteRequisitionListOutput` De vraag keert details over de geschrapte vraaglijst in plaats van de resterende vraaglijsten terug. <!-- MC-39894-->
...
U kunt Adobe Commerce 2.4.2 installeren met [Composer](../../../installation/composer.md).
