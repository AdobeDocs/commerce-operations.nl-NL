...
* Toegevoegde ondersteuning voor meerdere wenslijsten. U kunt GraphQL gebruiken om ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html) tot stand te brengen [ schrappen ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html), en [ anders noemen ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) vorstenlijsten evenals [ beweging ](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) of [ exemplaar ](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) punten tussen hen. <!-- MC-32356-->[

* Toegevoegde steun voor teruggekeerde handelsvergunningen (RMA). De kopers kunnen [ om een terugkeer ](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html) verzoeken. Als de handelaar het verzoek goedkeurt, kan de verkoopster taken uitvoeren zoals [ toevoegend een commentaar ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) en [ het volgen informatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html) toevoegen. <!-- MC-34596-->

* Extra ondersteuning voor de volgende B2B-functies:
   * Bedrijven. U kunt bedrijf [ beheerders ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html) toevoegen, [ gebruikers ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html), [ rollen ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html), en [ teams ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   * Bedrijfskrediet De [ bedrijfvraag ](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) omvat details over de kredietgeschiedenis van het bedrijf. <!-- MC-33862-->
   * Aanvraaglijsten. U kunt ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html) tot stand brengen [, [ schrapping ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html), en [ update ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html) verzoeklijsten. De steun omvat ook de capaciteit om ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html) toe te voegen, [ update ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html), [ schrapt ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html), [ exemplaar ](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html), en [ bewegen ](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) punten binnen een verzoeklijst evenals toevoegt de punten van de verzoeklijst [ in het karretje ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->[

* Steun voor vakbonden in GraphQL toegevoegd. [ GitHub-29425 ](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Toegevoegde steun voor [ vergelijkingslijsten ](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html). De kopers kunnen ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html) creëren en [ ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html) vergelijkingslijsten schrappen, en [ ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html) toevoegen en [ verwijderen ](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html) punten aan de vergelijkingslijsten. [ Bovendien kunnen de kopers die een vergelijkingslijst als gast tot stand brengen login als klant en [ ](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html) behouden hun vergelijkingslijsten.

* De mutatie [`generateCustomerTokenAsAdmin` ](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) is toegevoegd en het `Customer` -object is bijgewerkt ter ondersteuning van externe aankoophulp.
...
* Toegevoegd `staging` attribuut aan [`ProductInterface` ](https://developer.adobe.com/commerce/webapi/graphql/interfaces/product-interface.html) en [`CategoryInterface` ](https://developer.adobe.com/commerce/webapi/graphql/interfaces/category-interface.html) om te bepalen als een product gefaseerd is en zijn bijbehorende campagneinformatie te bekijken. <!-- MC-33897-->
