...
* Toegevoegde ondersteuning voor meerdere wenslijsten. U kunt GraphQL gebruiken om ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-wishlist.html) tot stand te brengen [ schrappen ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-wishlist.html), en [ anders noemen ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-wishlist.html) vorstenlijsten evenals [ beweging ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-products-between-wishlists.html) of [ exemplaar ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-products-between-wishlists.html) punten tussen hen. <!-- MC-32356-->[

* Toegevoegde steun voor teruggekeerde handelsvergunningen (RMA). De kopers kunnen [ om een terugkeer ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/request-return.html) verzoeken. Als de handelaar het verzoek goedkeurt, kan de verkoopster taken uitvoeren zoals [ toevoegend een commentaar ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-comment.html) en [ het volgen informatie ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-tracking.html) toevoegen. <!-- MC-34596-->

* Extra ondersteuning voor de volgende B2B-functies:
   * Bedrijven. U kunt bedrijf [ beheerders ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company.html) toevoegen, [ gebruikers ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-user.html), [ rollen ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-role.html), en [ teams ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   * Bedrijfskrediet De [ bedrijfvraag ](https://devdocs.magento.com/guides/v2.4/graphql/queries/company.html) omvat details over de kredietgeschiedenis van het bedrijf. <!-- MC-33862-->
   * Aanvraaglijsten. U kunt ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-requisition-list.html) tot stand brengen [, [ schrapping ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list.html), en [ update ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-requisition-list.html) verzoeklijsten. De steun omvat ook de capaciteit om ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-requisition-list.html) toe te voegen, [ update ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-products-in-wishlist.html), [ schrapt ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list-items.html), [ exemplaar ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-items-between-requisition-lists.html), en [ bewegen ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-items-between-requisition-lists.html) punten binnen een verzoeklijst evenals toevoegt de punten van de verzoeklijst [ in het karretje ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->[

* Steun voor vakbonden in GraphQL toegevoegd. [ GitHub-29425 ](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Toegevoegde steun voor [ vergelijkingslijsten ](https://devdocs.magento.com/guides/v2.4/graphql/queries/compare-list.html). De kopers kunnen ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-compare-list.html) creëren en [ ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-compare-list.html) vergelijkingslijsten schrappen, en [ ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-compare-list.html) toevoegen en [ verwijderen ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-products-from-compare-list.html) punten aan de vergelijkingslijsten. [ Bovendien kunnen de kopers die een vergelijkingslijst als gast tot stand brengen login als klant en [ ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/assign-compare-list-to-customer.html) behouden hun vergelijkingslijsten.

* De mutatie [`generateCustomerTokenAsAdmin` ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/generate-customer-token-as-admin.html) is toegevoegd en het `Customer` -object is bijgewerkt ter ondersteuning van externe aankoophulp.
...
* Toegevoegd `staging` attribuut aan [`ProductInterface` ](https://devdocs.magento.com/guides/v2.4/graphql/interfaces/product-interface.html) en [`CategoryInterface` ](https://devdocs.magento.com/guides/v2.4/graphql/interfaces/category-interface.html) om te bepalen als een product gefaseerd is en zijn bijbehorende campagneinformatie te bekijken. <!-- MC-33897-->
...
**de orden van de Aankoop kunnen nu worden voltooid gebruikend online betalingsmethodes**. B2B de kopers worden ertoe aangezet om hun aangewezen betalingsmethode voor elke [ kooporder ](https://docs.magento.com/user-guide/stores/b2b-purchase-order-flow.html) tijdens de aanvankelijke controle te selecteren. Nadat de kooporder is goedgekeurd, wordt kopers gevraagd betalingsgegevens in te voeren om de kooporder om te zetten in een uiteindelijke bestelling.
...
* De Bouwer van de pagina vereist niet meer alle inhoudstypes om binnen een rij worden geplaatst. Het [ stadium van de Bouwer van de Pagina ](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#stage) is nu aanvankelijk leeg en steunt het toevoegen van de volgende inhoudstypes rechtstreeks aan het stadium: Rijen, Kolommen, Lusjes, Code van de HTML, Blokken, Dynamische Blokken.

* Vooraf gedefinieerde marges en opvullingen zijn niet meer vereist voor inhoudssoorten.

* De nieuwe mobiele [ viewport schakelaar ](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#viewports) en viewport werkingsgebied voor de waarden van het vormgebied laten gebruikers en ontwikkelaars deze acties uitvoeren:
...
De interactieve Begeleiding In-Product van verkopers voorziet gebruiksuiteinden en informatie van binnen Admin over nieuwe eigenschapmededelingen, loopthrough gidsen, op-boarding informatie, en hulpmiddeluiteinden.  **de Beheerders moeten opt-in van Admin om binnen-productbegeleiding te ontvangen als deze eigenschap niet** wordt toegelaten. Zie {de Verzameling van de Gegevens van het 0} Gebruik ](https://docs.magento.com/user-guide/stores/admin.html) en [ Gebruik Admin ](https://docs.magento.com/user-guide/configuration/advanced/admin.html#admin-usage).[
...
**Web-geoptimaliseerde beelden in inhoud**. De handelaren kunnen [ Web-geoptimaliseerde beeldvertoning ](https://docs.magento.com/user-guide/cms/media-gallery-image-optimization.html) in inhoud in plaats van hoge resolutiebeelden nu gebruiken. De oorspronkelijke afbeelding blijft ongewijzigd in de Medialerie en de afbeeldingsuitvoering wordt dynamisch gegenereerd wanneer de afbeelding in de inhoud wordt ingevoegd.
...
* De logica is verwijderd uit de WYSIWYG OnInsert-controller (`Magento\Cms\Controller\Adminhtml\Wysiwyg\Images\OnInsert::execute()`) en toegevoegd aan het `Model\Wysiwyg\Images\PrepareImage::execute()` -model. [ GitHub-1504 ](https://github.com/magento/adobe-stock-integration/issues/1504)
...
* De query `urlResolver` retourneert niet langer NULL wanneer een aangepast CMS-knooppunt en een aangepaste pagina worden opgegeven als invoer. [ GitHub-30474 ](https://github.com/magento/magento2/issues/30474)
