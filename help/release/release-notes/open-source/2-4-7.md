---
title: Opmerkingen bij de release van Magento Open Source 2.4.7 bèta3
description: Meer informatie over nieuwe functies, verbeteringen, foutoplossingen en bekende problemen vindt u in de 2.4.7-bèta3-release van de Magento Open Source.
...
# Opmerkingen bij de release van Magento Open Source 2.4.7 bèta3
...
Magento Open Source 2.4.7-bèta3 introduceert ondersteuning voor PHP 8.3. De klasse bevat meer dan 150 correcties en verbeteringen voor kwaliteit. De afhankelijkheden van Core Composer en bibliotheken van derden zijn bijgewerkt naar de nieuwste beschikbare versies.
...
## Magento Open Source 2.4.7-bèta3

Magento Open Source 2.4.7-bèta3 is getest op basis van de volgende componentversies:
...
## Magento Open Source 2.4.7 bèta3-hooglichten
...
Magento Open Source 2.4.7-bèta3 bevat de volgende platformupgrades:
...
Magento Open Source 2.4.7-bèta3 is nog steeds alleen voor upgradedoeleinden compatibel met PHP 8.1. PHP 8.1 wordt niet ondersteund en wordt niet aanbevolen. Magento Open Source 2.4.7-bèta3-kerncode, alle gebundelde extensies en alle Adobe-gerelateerde extensies en SaaS-services zijn compatibel met PHP 8.3. <!-- AC-9668 -->

* **RabbitMQ 3.11-ondersteuning**. Deze release is compatibel met de nieuwste versie van RabbitMQ 3.11. De compatibiliteit blijft behouden met RabbitMQ 3.9, dat tot augustus 2023 wordt ondersteund, maar we raden u aan om Magento Open Source 2.4.7-bèta3 alleen te gebruiken met RabbitMQ 3.11.

* **Composer 2.6.x**. Compatibiliteit met Composer 2.2.x blijft behouden. <!-- AC-9663 -->

* **Ondersteuning voor Varnish cache 7.4**. Deze release is compatibel met de nieuwste versie van Varnish Cache 7.4. De compatibiliteit blijft behouden met de 6.0.x- en 7.2.x-versies, maar we raden u aan Magento Open Source 2.4.7-bèta3 alleen te gebruiken met Varnish Cache versie 7.4 of versie 6.0 LTS. <!-- AC-9662 -->
...
* De integratie van de Magento Open Source met FedEx is gemigreerd van de erfenis van de Diensten van het Web van FedEx WSDL aan de recentste RESTful APIs FedEx. FedEx Web Services Tracking, de Bevestiging van het Adres, en bevestigt WSDLS van de PostCodes zullen in Mei 2024 worden gepensioneerd. <!-- AC-1470 -->
...
Magento Open Source 2.4.7 bevat verbeterde mogelijkheden voor GraphQL in cache plaatsen, ondersteuning voor het GraphQL-schema voor aangepaste kenmerken, ondersteuning voor annulering van koploze bestellingen en verbeterde mogelijkheden voor het in cache plaatsen van oplosmiddelen.
...
Deze release bevat het metapakket voor extensie van Magento Open Source v1.0.0-beta2, dat automatisch Magento Open Source-extensies bundelt met deze kernrelease. De versie van deze extensie die in dit pakket is opgenomen, wordt geïnstalleerd wanneer `composer update` wordt uitgevoerd, waardoor het upgraden van de extensie naar de nieuwste kernversie eenvoudiger wordt. Deze extensie onderhoudt een onafhankelijk releaseschema.

Het metapakket voor extensie Magento Open Sourcen voor Magento Open Source 2.4.7-bèta3 bevat de volgende extensies:
...
* Magento Open Source voegt geen productbeschrijvingstekst meer in op de pagina met productdetails **[!UICONTROL Meta Description]** veld als dit veld leeg is gelaten. Eerder, toen een productbeschrijving HTML code bevatte die door PageBuilder of een andere HTML redacteur werd geproduceerd, werd de HTML getoond in Meta **[!UICONTROL Description]** en u kunt dit veld niet leeg laten.
...
U kunt Magento Open Source 2.4.7 bèta3 installeren gebruikend [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
