...
Magento Open Source 2.4.2 introduceert prestatieverbeteringen en betere beveiliging, plus belangrijke platformverbeteringen. Beveiligingsverbeteringen zijn onder andere uitbreiding van de ondersteuning voor het kenmerk `SameSite` voor alle cookies. Elasticsearch 7.9.x en Redis 6.x worden nu ondersteund.
...
* De toepassing genereert niet langer een fout wanneer u `backend-frontname` probeert te wijzigen met de `ssh` -container nadat u de Magento Open Source hebt geïnstalleerd. [ GitHub-26762 ](https://github.com/magento/magento2/issues/26762)
...
* De bezoekers van de gast kunnen PAL- orden nu plaatsen wanneer **Automatische Toewijzing aan de Groep van de Klant** wordt toegelaten. De betaling wordt verwerkt op de PayPal-gateway, de bestelling wordt in Magento gemaakt en de verkoper ziet de pagina &quot;Bedankt voor uw bestelling&quot;. Eerder is de bestelling verwerkt via de Paypal-gateway, maar de bestelling is niet in Magento Open Source gemaakt. De winkelier werd in plaats daarvan omgeleid naar de pagina van het ordeoverzicht, waar de toepassing deze fout: `Failed address validation: %1" error` toonde. [ GitHub-25399 ](https://github.com/magento/magento2/issues/25399)
...
**Uitgave**: De toepassing leidt tot een orde in Braintree zoals verwacht wanneer een verkoopster **met Venmo** betaalt, maar leidt niet tot de orde in Admin. Zie [ 2.4.2 gekende kwestie: De betaling van Venmo van de Braintree werkt ](https://support.magento.com/hc/en-us/articles/360054662652/) artikel van de Kennisbank niet.  <!-- BUNDLE-2894-->
