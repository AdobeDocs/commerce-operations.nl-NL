---
title: Opmerkingen bij de release van Magento Open Source 2.4.2
...
# Opmerkingen bij de release van Magento Open Source 2.4.2

Magento Open Source 2.4.2 introduceert prestatieverbeteringen en betere beveiliging, plus belangrijke platformverbeteringen. De verhogingen van de veiligheid omvatten uitbreiding van steun voor `SameSite` voor alle cookies. Elasticsearch 7.9.x en Redis 6.x worden nu ondersteund.
...
* De Magento Open Source heeft betere cacheprestaties door het spoelen van markeringen veelvoudige tijden per indexeerinstantie te elimineren. [GitHub-29890](https://github.com/magento/magento2/issues/29890)
...
* Klanten van gasten kunnen nu PayPal-orders plaatsen wanneer **Automatische toewijzing aan Klantengroep** is ingeschakeld. De betaling wordt verwerkt op de PayPal-gateway, de bestelling wordt in Magento gemaakt en de verkoper ziet de pagina &quot;Bedankt voor uw bestelling&quot;. Eerder is de bestelling verwerkt via de Paypal-gateway, maar de bestelling is niet in Magento Open Source gemaakt. De verkoopster werd in plaats daarvan omgeleid naar de pagina van het ordeoverzicht, waar de toepassing deze fout toonde: `Failed address validation: %1" error`. [GitHub-25399](https://github.com/magento/magento2/issues/25399)
