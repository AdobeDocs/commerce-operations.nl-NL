...
Voor algemene informatie over veiligheidspatches, zie [&#x200B; de flardversies van de Veiligheid &#x200B;](../security/overview.md). Voor instructies bij het downloaden en het toepassen van veiligheidspatches (met inbegrip van flard 2.4.1-p1), zie [&#x200B; Snelle begin op-gebouw installatie &#x200B;](../../../installation/composer.md). Beveiligingspatches bevatten alleen oplossingen voor beveiligingsfouten, niet de extra beveiligingsverbeteringen die in de volledige patch zijn opgenomen.
...
Deze release bevat verbeteringen aan de kernkwaliteit, die de kwaliteit van het framework en de volgende functionele gebieden verbeteren: Klantenaccount, Catalogus, CMS, OMS, Importeren/exporteren, Promoties en Targeting, en Afhandeling en Afhandeling.
...
* De capaciteit om een installatie te vormen om een gespleten gegevensbestand te gebruiken is verouderd in deze versie. Zie [&#x200B; terugkeren van een gespleten gegevensbestand aan één enkel gegevensbestand &#x200B;](../../../configuration/storage/revert-split-database.md) voor migratieinstructies.
...
**Uitgave**: Het bestand `[magento_root]/index.php` is verwijderd en de toepassing wordt nu standaard uitgevoerd vanaf `/pub` voor Apache-configuraties. De opslag die van subfolders wordt gediend zal niet zoals verwacht werken en kan 404 fouten tonen. **Oplossing**: Gebruik symlinks om de installatie te emuleren naar een submap. In het volgende voorbeeld wordt `https://shop01.com/shop/` gebruikt om te illustreren hoe u een symlink gebruikt om een installatie in een submap te emuleren.
...
**Uitgave**: De toepassing leidt tot een orde in Braintree zoals verwacht wanneer een verkoopster **met Venmo** betaalt, maar leidt niet tot de orde in Admin. Zie [&#x200B; 2.4.2 gekende kwestie: Braintree Venmo-betaling werkt &#x200B;](https://support.magento.com/hc/en-us/articles/360054662652/) Knowledge Base-artikel niet.  <!-- BUNDLE-2894-->
