...
* Klanten kunnen tijdens het afrekenen berichtopties voor cadeautjes selecteren. GraphQL bespreekt nu geschenkberichtopties voor verschillende typen winkelwagentjes. Zie [`setGiftOptionsOnCart` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/set-gift-options.html) en [`updateCartItems` mutatie ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-cart-items.html). _Fix die door Oleh Usik in trekkingsverzoeken [ wordt voorgelegd 28519 ](https://github.com/magento/magento2/pull/28105), [ 27956 ](https://github.com/magento/magento2/pull/27956), [ 28072 ](https://github.com/magento/magento2/pull/28072), [ 28072 ](https://github.com/magento/magento2/pull/28072). [ GitHub-28519 ](https://github.com/magento/magento2/issues/28519)
...
* Toegevoegde of bijgewerkte onderwerpen op Klarna GraphQL in [ de betalingsmethode van Klarna ](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html) en [`createKlarnaPaymentsSession` ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html)
