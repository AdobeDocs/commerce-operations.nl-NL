...
* De `dropdownDialog` widget laadt nu alleen de sleepbare en aanpasbare `jquery-ui` dat het nodig heeft. Eerder werd er veel onnodige code geladen, waardoor de laadtijd werd opgevoerd en de prestaties werden verminderd. [GitHub-32810](https://github.com/magento/magento2/issues/32810)
