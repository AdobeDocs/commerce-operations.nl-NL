...
* De `Magento\Framework\MessageQueue\TopologyTest` De test is nu compatibel met de AWS MQ for RabbitMQ-service. Eerder is deze test mislukt met dit bericht: `Invalid exchange configuration: magento-topic-based-exchange1 Failed asserting that two arrays are equal`. <!-- AC-1248-->
