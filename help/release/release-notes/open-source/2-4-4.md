---
title: Opmerkingen bij de release van Magento Open Source 2.4.4
description: Leer over nieuwe eigenschappen, verhogingen, insectenmoeilijke situaties en bekende kwesties in de versie van de Magento Open Source 2.4.4.
...
* De wagen is nu standaard uitgeschakeld wanneer de Magento Open Source in de productiemodus staat. <!-- AC-1450-->
...
* De handelaren kunnen nu met succes van een plaatsing van de Magento Open Source 2.4.2 met Klarna aan Magento Open Source 2.4.3 upgraden. [GitHub-33760](https://github.com/magento/magento2/issues/33760)
...
* Magento Open Source genereert niet langer een fout wanneer een gebruiker klikt **Winkel bijwerken** nadat een producthoeveelheid in de minikart is gewijzigd. Eerder werd deze fout weergegeven door de applicationOpen Source:  `The quote item isn't found. Verify the item and try again`.
...
* Deze fout treedt niet meer op bij een Magento Open Source die een factuuradres toevoegt dat een straatveld mist: `Uncaught TypeError: Unable to process binding "text: function(){return currentBillingAddress().street.join(', ') }"`. [GitHub-33826](https://github.com/magento/magento2/issues/33826)
...
* Er treedt niet langer een fout op nadat u de Magento Open Source `addConfigurableProductsToCart` mutatie om een configureerbaar product direct aan een winkelwagentje toe te voegen na het veranderen van de winkelmening.

<!-- ACP2E-176-->

* Magento Open Source genereert niet langer een fout wanneer u de opdracht `addConfigurableProductsToCart` mutatie om een gehandicapt kind van een configureerbaar product aan de kar toe te voegen. Eerder heeft de applicationOpen Source een schending van een integriteitsbeperking gegenereerd.
...
* Als u op de voorvertoning van een e-mailsjabloon klikt, wordt de voorvertoning van de sjabloon nu in een apart venster geopend, zoals u had verwacht.  Eerder heeft de toepassingOpen Source de sjabloonvoorvertoning gelijktijdig geopend vanuit het raster E-mailsjablonen en in een pop-upvenster.
...
* De helper `Magento\Payment\Helper\Data` maakt niet langer nieuwe lay-outs in constructors. Eerder, toen deze hulp in douanebevelen werd gebruikt zonder een gebiedscode te specificeren, veroorzaakte de Magento Open Source een fout. [GitHub-33908](https://github.com/magento/magento2/issues/33908)
...
* De Magento Open Source keert nu een 500 reactiecode terug wanneer een uitzondering in het laarzentrekkerdossier voorkomt. Eerder gaf applicationOpen Source 200 OK-statuscode. [GitHub-22196](https://github.com/magento/magento2/issues/22196)
...
* Bij het dupliceren van een product worden nu alle productvelden gekopieerd volgens het gedefinieerde bereik. Eerder **name** en **beschrijving** velden zijn opnieuw ingesteld op `global` bereik.
...
* Bij Magento Open Source wordt niet langer een fout weergegeven tijdens het afrekenen met de PayPal Express-betalingsmethode. Eerder werd deze fout weergegeven in de toepassing Open Source, hoewel het uitchecken is voltooid: `Something went wrong`.
...
* De nieuwe `product_alert` de consument verbetert het verzenden van klantenalarm door rijberichten te creëren, de consument in werking te stellen, en uitvoeringstijd te verbeteren. Eerder, wierp applicationOpen Source een uit-van-geheugenuitzondering wanneer het verzenden van meer dan 100.000 productalarm. De open bron van de toepassing duurde ook meer dan 20 uren om alle alarm te verzenden.

<!-- ACP2E-87-->

* Er treedt niet langer een fout op als het prijsfilter op de pagina Categorie geen tweede waarde bevat. Eerder, gooide applicationOpen Bron een uitzondering in het logboekdossier.
...
* Met Magento Open Source worden nu de HTML-tags verwijderd zoals u had verwacht van de winkel **Account** > **Mijn bestellingen** > **Volgorde weergeven** pagina. Eerder werden door de toepassingOpen Source HTML-tags weergegeven in de commentaarsectie voor de order van de winkel.
...
* Dit bericht wordt niet meer weergegeven na een upgrade wanneer de modus Cookie-beperking is uitgeschakeld: `The store will not work correctly in the case when cookies are disabled`. [GitHub-33811](https://github.com/magento/magento2/issues/33811)
...
* Magento Open Source geeft niet langer dubbele adressen weer wanneer een winkelier klikt **Adres wijzigen** op de pagina Review and Payments in een implementatie waarin **Zoeken in adres** configuratie-instelling is ingeschakeld.
...
* U kunt nu objecten maken met de onderliggende klassen van `\Magento\Framework\Api\AbstractSimpleObjectBuilder` op PHP 7.3. Eerder `preg_match` Deze waarschuwing gaf toen Magento Open Source werd gehost op Redhat met PHP 7.3: `Warning: preg_match(): Compilation failed: unrecognized character follows...`.
...
* Magento Open Source geeft niet langer een verlanglijst weer in de categoriedijbalk wanneer de optie **Tonen in zijbalk** Optie voor verlanglijst is uitgeschakeld. Eerder werd deze optie genegeerd door de applicationOpen Source.
