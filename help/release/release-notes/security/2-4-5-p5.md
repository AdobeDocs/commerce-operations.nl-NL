---
title: Opmerkingen bij de release Adobe Commerce 2.4.5-p5
description: Meer informatie over oplossingen voor beveiligingsproblemen vindt u in de Adobe Commerce-release 2.4.5-p5.
...
# Opmerkingen bij de release Adobe Commerce 2.4.5-p5

Adobe Commerce 2.4.5-p5 is een beveiligingsrelease met tien beveiligingsoplossingen die uw implementatie van Adobe Commerce 2.4.5 of Magento Open Source 2.4.5 verbeteren. Het verstrekt moeilijke situaties voor kwetsbaarheid die in vorige versies zijn geïdentificeerd.
