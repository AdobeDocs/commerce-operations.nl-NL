...
- **Geïsoleerde veiligheidsmoeilijke situaties** - Individuele, niet-cumulatieve [&#x200B; veiligheidsmoeilijke situaties &#x200B;](versioning-policy.md#isolated-patch) worden vrijgegeven zoals nodig en omvatten veiligheidsmoeilijke situaties voor alle [&#x200B; gesteunde &#x200B;](lifecycle-policy.md) versielijnen (omvat regelmatige en uitgebreide steun).

- **de flarden van de Veiligheid** - bij minimium, [&#x200B; veiligheidspatches &#x200B;](versioning-policy.md#security-patch-release) worden vrijgegeven jaarlijks voor alle [&#x200B; gesteunde &#x200B;](lifecycle-policy.md) versielijnen. Deze flarden omvatten alle eerder vrijgegeven geïsoleerde veiligheidsmoeilijke situaties. Adobe kan indien nodig extra beveiligingspatches vrijgeven, maar dit is niet gegarandeerd.
...
- **de flarden van Beta** - Twee [&#x200B; bètaflarden &#x200B;](versioning-policy.md#beta-patch-release) voor Adobe Commerce 2.4.x LTS worden de versielijn tweemaal per jaar vrijgegeven.
...
- [&#x200B; Bulletins en Advisories van de Veiligheid van Adobe &#x200B;](https://helpx.adobe.com/nl/security/security-bulletin.html#magento)
- E-mail
- Waarschuwingen in producten

>[!NOTE]
>
> Voor versiedata voor elke minder belangrijke, flard, en veiligheidsversie en data voor het eind van regelmatige steun, zie [&#x200B; Vrijgegeven versies &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-operations/release/versions).
